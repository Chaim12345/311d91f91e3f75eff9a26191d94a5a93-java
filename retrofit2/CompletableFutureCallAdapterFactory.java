...
public final class CompletableFutureCallAdapterFactory extends CallAdapter.Factory {
    ...
    static final CallAdapter.Factory f15311a = new CompletableFutureCallAdapterFactory();
    ...
    public CallAdapter<?, ?> get(Type type, Annotation[] annotationArr, Retrofit retrofit) {
        if (CallAdapter.Factory.b(type) != CompletableFuture.class) {
            return null;
        }
        if (type instanceof ParameterizedType) {
            ...
            if (a2 instanceof ParameterizedType) {
                return new ResponseCallAdapter(CallAdapter.Factory.a(0, (ParameterizedType) a2));
            }
