...
public final class CurrentSpanUtils {
        ...
        public V call() {
            ...
            try {
                try {
                    ...
                    CurrentSpanUtils.setErrorStatus(this.span, e2);
                    throw e2;
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Scope c(Span span, boolean z) {
        return new ScopeInSpan(span, z);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Runnable d(Span span, boolean z, Runnable runnable) {
        return new RunnableInSpan(span, runnable, z);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static Callable e(Span span, boolean z, Callable callable) {
