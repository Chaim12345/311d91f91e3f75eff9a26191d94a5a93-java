...
public abstract class DerivedDoubleCumulative {
    ...
    private static final class NoopDerivedDoubleCumulative extends DerivedDoubleCumulative {
        ...
        NoopDerivedDoubleCumulative(String str, String str2, String str3, List list) {
        ...
        static NoopDerivedDoubleCumulative b(String str, String str2, String str3, List list) {
    ...
    public static DerivedDoubleCumulative a(String str, String str2, String str3, List list) {
