...
public abstract class DerivedLongCumulative {
    ...
    private static final class NoopDerivedLongCumulative extends DerivedLongCumulative {
        ...
        NoopDerivedLongCumulative(String str, String str2, String str3, List list) {
        ...
        static NoopDerivedLongCumulative b(String str, String str2, String str3, List list) {
    ...
    public static DerivedLongCumulative a(String str, String str2, String str3, List list) {
