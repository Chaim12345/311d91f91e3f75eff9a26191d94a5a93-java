...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f4237b.setFocusable(true);
        this.f4237b.setOnClickListener(new View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ViewPager viewPager = PagerTabStrip.this.f4236a;
                viewPager.setCurrentItem(viewPager.getCurrentItem() - 1);
            }
        });
        this.f4239d.setFocusable(true);
        this.f4239d.setOnClickListener(new View.OnClickListener() { // from class: androidx.viewpager.widget.PagerTabStrip.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                ViewPager viewPager = PagerTabStrip.this.f4236a;
                viewPager.setCurrentItem(viewPager.getCurrentItem() + 1);
    ...
    public void c(int i2, float f2, boolean z) {
        ...
        int left = this.f4238c.getLeft() - this.mTabPadding;
        int right = this.f4238c.getRight() + this.mTabPadding;
        int i3 = height - this.mIndicatorHeight;
        rect.set(left, i3, right, height);
        super.c(i2, f2, z);
        this.mTabAlpha = (int) (Math.abs(f2 - 0.5f) * 2.0f * 255.0f);
        rect.union(this.f4238c.getLeft() - this.mTabPadding, i3, this.f4238c.getRight() + this.mTabPadding, height);
        invalidate(rect);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0 || !this.mIgnoreTap) {
            ...
            if (action == 0) {
                ...
                if (x < this.f4238c.getLeft() - this.mTabPadding) {
                    viewPager = this.f4236a;
                    currentItem = viewPager.getCurrentItem() - 1;
                } else if (x > this.f4238c.getRight() + this.mTabPadding) {
                    viewPager = this.f4236a;
                    currentItem = viewPager.getCurrentItem() + 1;
                }
