...
public class PagerSnapHelper extends SnapHelper {
    ...
    private OrientationHelper getHorizontalHelper(@NonNull RecyclerView.LayoutManager layoutManager) {
        ...
        if (orientationHelper == null || orientationHelper.f3686a != layoutManager) {
    ...
    protected RecyclerView.SmoothScroller a(@NonNull RecyclerView.LayoutManager layoutManager) {
        if (layoutManager instanceof RecyclerView.SmoothScroller.ScrollVectorProvider) {
            return new LinearSmoothScroller(this.f3766a.getContext()) { // from class: androidx.recyclerview.widget.PagerSnapHelper.1
                ...
                protected void g(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
                    ...
                    int[] calculateDistanceToFinalSnap = pagerSnapHelper.calculateDistanceToFinalSnap(pagerSnapHelper.f3766a.getLayoutManager(), view);
