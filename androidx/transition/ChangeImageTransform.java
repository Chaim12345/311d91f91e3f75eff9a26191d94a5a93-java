...
public class ChangeImageTransform extends Transition {
    ...
    public static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            try {
                f4069a[ImageView.ScaleType.CENTER_CROP.ordinal()] = 2;
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            int i2 = AnonymousClass3.f4069a[imageView.getScaleType().ordinal()];
            if (i2 == 1) {
    ...
    private ObjectAnimator createNullAnimator(@NonNull ImageView imageView) {
        ...
        Matrix matrix = MatrixUtils.f4102a;
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (matrix == null) {
            matrix = MatrixUtils.f4102a;
        }
        if (matrix2 == null) {
            matrix2 = MatrixUtils.f4102a;
        }
