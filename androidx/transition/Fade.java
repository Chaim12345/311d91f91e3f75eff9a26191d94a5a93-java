...
public class Fade extends Visibility {
    ...
    public Fade(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, Styleable.f4108f);
    ...
    private Animator createAnimation(final View view, float f2, float f3) {
        ...
        ViewUtils.h(view, f2);
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(view, ViewUtils.f4151a, f3);
