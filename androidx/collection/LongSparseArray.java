...
public class LongSparseArray<E> implements Cloneable {
    ...
    public LongSparseArray(int i2) {
        this.mGarbage = false;
        if (i2 == 0) {
            this.mKeys = ContainerHelpers.f1586b;
            this.mValues = ContainerHelpers.f1587c;
            return;
        }
    ...
    public E get(long j2, E e2) {
        int b2 = ContainerHelpers.b(this.mKeys, this.mSize, j2);
        if (b2 >= 0) {
            Object[] objArr = this.mValues;
    ...
    public int indexOfKey(long j2) {
        ...
        return ContainerHelpers.b(this.mKeys, this.mSize, j2);
    }
    ...
    public void put(long j2, E e2) {
        ...
        if (this.mGarbage && i3 >= this.mKeys.length) {
            gc();
            i2 = ~ContainerHelpers.b(this.mKeys, this.mSize, j2);
        }
        int i4 = this.mSize;
