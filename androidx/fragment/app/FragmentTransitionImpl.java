...
public abstract class FragmentTransitionImpl {
    ...
    public void b(ArrayList arrayList, View view) {
            ...
            if (z) {
                ...
                if (!isTransitionGroup) {
                    ...
                    for (int i2 = 0; i2 < childCount; i2++) {
                        b(arrayList, viewGroup2.getChildAt(i2));
                    }
                    return;
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void d(Map map, @NonNull View view) {
        if (view.getVisibility() == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void h(ViewGroup viewGroup, final ArrayList arrayList, final Map map) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void i(View view, final ArrayList arrayList, final Map map) {
        OneShotPreDrawListener.add(view, new Runnable(this) { // from class: androidx.fragment.app.FragmentTransitionImpl.2
            ...
            public void run() {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (transitionName != null) {
                        ViewCompat.setTransitionName(view2, FragmentTransitionImpl.c(map, transitionName));
                    }
                }
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void j(View view, final ArrayList arrayList, final ArrayList arrayList2, final ArrayList arrayList3, Map map) {
