...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    private static boolean hasSimpleTarget(Transition transition) {
        return (FragmentTransitionImpl.f(transition.getTargetIds()) && FragmentTransitionImpl.f(transition.getTargetNames()) && FragmentTransitionImpl.f(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        } else if (hasSimpleTarget(transition) || !FragmentTransitionImpl.f(transition.getTargets())) {
        } else {
