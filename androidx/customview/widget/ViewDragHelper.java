                    ...
                    while (i3 < pointerCount) {
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            if (this.mDragState != 1) {
                                ...
                                if (checkTouchSlop(findTopChildUnder2, f2, f3) && b(findTopChildUnder2, pointerId2)) {
                                    break;
                                }
                            } else {
                                break;
                ...
                if (actionMasked == 5) {
                    ...
                    if (this.mDragState != 0) {
                        if (isCapturedViewUnder((int) x4, (int) y4)) {
                            b(this.mCapturedView, pointerId3);
                            return;
                        }
                        return;
                    }
                    b(findTopChildUnder((int) x4, (int) y4), pointerId3);
                    ...
                    if (this.mDragState == 1 && pointerId4 == this.mActivePointerId) {
                        ...
                        while (true) {
                            ...
                            if (pointerId5 != this.mActivePointerId) {
                                ...
                                if (findTopChildUnder3 == view && b(view, pointerId5)) {
    ...
    public boolean shouldInterceptTouchEvent(@NonNull MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
                ...
                if (actionMasked != 2) {
                    ...
                    for (int i5 = 0; i5 < pointerCount; i5++) {
                        ...
                        if (isValidPointerForActionMove(pointerId2)) {
                            ...
                            reportNewEdgeDrags(f2, f3, pointerId2);
                            if (this.mDragState != 1) {
                                if (z2 && b(findTopChildUnder2, pointerId2)) {
                                    break;
                                }
                            } else {
                                break;
            ...
            if (findTopChildUnder3 == this.mCapturedView && this.mDragState == 2) {
                b(findTopChildUnder3, pointerId3);
            }
