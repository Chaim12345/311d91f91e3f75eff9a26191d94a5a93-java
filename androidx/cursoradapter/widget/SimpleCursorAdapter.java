...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
    ...
    protected int[] f2761j;
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})

    /* renamed from: k  reason: collision with root package name */
    protected int[] f2762k;
    ...
    private void findColumns(Cursor cursor, String[] strArr) {
        ...
        int[] iArr = this.f2761j;
        if (iArr == null || iArr.length != length) {
            this.f2761j = new int[length];
        }
        for (int i2 = 0; i2 < length; i2++) {
            this.f2761j[i2] = cursor.getColumnIndexOrThrow(strArr[i2]);
        }
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int[] iArr = this.f2762k;
        int length = iArr.length;
        int[] iArr2 = this.f2761j;
        for (int i2 = 0; i2 < length; i2++) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        findColumns(cursor, this.f2763l);
