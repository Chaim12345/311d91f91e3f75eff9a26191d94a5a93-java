...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    boolean b(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, boolean z) {
        boolean z2;
        boolean z3;
    ...
    public void computeScroll() {
        ...
        if (i3 != 0) {
            int scrollY = getScrollY();
            b(0, i3, getScrollX(), scrollY, 0, scrollRange, 0, 0, false);
            int scrollY2 = getScrollY() - scrollY;
            int i4 = i3 - scrollY2;
            ...
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (b(0, i6, 0, getScrollY(), 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(0)) {
                        ...
                        if (z) {
                            int i8 = i6 - this.mScrollConsumed[1];
                            ensureGlows();
                            int i9 = scrollY + i8;
                            if (i9 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, i8 / getHeight(), motionEvent.getX(findPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    edgeEffect = this.mEdgeGlowBottom;
                                    edgeEffect.onRelease();
                                }
                                ...
                                if (i9 > scrollRange) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, i8 / getHeight(), 1.0f - (motionEvent.getX(findPointerIndex) / getWidth()));
                                    if (!this.mEdgeGlowTop.isFinished()) {
                                        edgeEffect = this.mEdgeGlowTop;
                                        edgeEffect.onRelease();
                                    }
