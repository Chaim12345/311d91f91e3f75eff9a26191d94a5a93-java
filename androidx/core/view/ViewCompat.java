...
public class ViewCompat {
    ...
    public static abstract class AccessibilityViewProperty<T> {
        ...
        void e(View view, Object obj) {
            if (frameworkAvailable()) {
                c(view, obj);
            } else if (extrasAvailable() && f(d(view), obj)) {
                ViewCompat.c(view);
                view.setTag(this.mTagKey, obj);
                ViewCompat.d(view, this.mContentChangeType);
            }
        }
    ...
    private static class Api21Impl {
        ...
        static void c(@NonNull final View view, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            ...
            if (onApplyWindowInsetsListener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.Api21Impl.1
                    ...
                    WindowInsetsCompat f2657a = null;
                    ...
                    public WindowInsets onApplyWindowInsets(View view2, WindowInsets windowInsets) {
                        ...
                        if (i2 < 30) {
                            ...
                            if (windowInsetsCompat.equals(this.f2657a)) {
    ...
    public static AccessibilityDelegateCompat getAccessibilityDelegate(@NonNull View view) {
        ...
        return accessibilityDelegateInternal instanceof AccessibilityDelegateCompat.AccessibilityDelegateAdapter ? ((AccessibilityDelegateCompat.AccessibilityDelegateAdapter) accessibilityDelegateInternal).f2634a : new AccessibilityDelegateCompat(accessibilityDelegateInternal);
    }
    ...
    public static void setAccessibilityHeading(View view, boolean z) {
        accessibilityHeadingProperty().e(view, Boolean.valueOf(z));
    }
    ...
    public static void setScreenReaderFocusable(View view, boolean z) {
        screenReaderFocusableProperty().e(view, Boolean.valueOf(z));
    }
