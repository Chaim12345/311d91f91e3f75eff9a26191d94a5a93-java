...
public final class ViewPropertyAnimatorCompat {
    ...
    Runnable f2681a = null;

    /* renamed from: b  reason: collision with root package name */
    Runnable f2682b = null;
    ...
    static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        /* renamed from: a  reason: collision with root package name */
        ViewPropertyAnimatorCompat f2688a;

        /* renamed from: b  reason: collision with root package name */
        boolean f2689b;

        ViewPropertyAnimatorListenerApi14(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.f2688a = viewPropertyAnimatorCompat;
        }
        ...
        public void onAnimationEnd(View view) {
            int i2 = this.f2688a.f2683c;
            if (i2 > -1) {
                view.setLayerType(i2, null);
                this.f2688a.f2683c = -1;
            }
            if (Build.VERSION.SDK_INT >= 16 || !this.f2689b) {
                ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = this.f2688a;
                Runnable runnable = viewPropertyAnimatorCompat.f2682b;
                if (runnable != null) {
                    viewPropertyAnimatorCompat.f2682b = null;
                    runnable.run();
                }
                Object tag = view.getTag(2113929216);
                ViewPropertyAnimatorListener viewPropertyAnimatorListener = tag instanceof ViewPropertyAnimatorListener ? (ViewPropertyAnimatorListener) tag : null;
        ...
        public void onAnimationStart(View view) {
            this.f2689b = false;
            if (this.f2688a.f2683c > -1) {
                view.setLayerType(2, null);
            }
            ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = this.f2688a;
            Runnable runnable = viewPropertyAnimatorCompat.f2681a;
            if (runnable != null) {
                viewPropertyAnimatorCompat.f2681a = null;
                runnable.run();
            }
            Object tag = view.getTag(2113929216);
            ViewPropertyAnimatorListener viewPropertyAnimatorListener = tag instanceof ViewPropertyAnimatorListener ? (ViewPropertyAnimatorListener) tag : null;
