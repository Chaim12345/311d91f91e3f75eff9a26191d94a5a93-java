...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        protected final AccessibilityViewCommand f2720b;
        ...
        AccessibilityActionCompat(Object obj, int i2, CharSequence charSequence, AccessibilityViewCommand accessibilityViewCommand, Class cls) {
            this.mId = i2;
            this.f2720b = accessibilityViewCommand;
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj != null && (obj instanceof AccessibilityActionCompat)) {
                Object obj2 = this.f2719a;
                Object obj3 = ((AccessibilityActionCompat) obj).f2719a;
        ...
        public int getId() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ((AccessibilityNodeInfo.AccessibilityAction) this.f2719a).getId();
            }
            return 0;
        }
        ...
        public CharSequence getLabel() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ((AccessibilityNodeInfo.AccessibilityAction) this.f2719a).getLabel();
            }
            return null;
        }
            ...
            if (this.f2720b != null) {
                ...
                if (cls != null) {
                    ...
                    try {
                        ...
                        return this.f2720b.perform(view, commandArguments);
                    }
                }
                return this.f2720b.perform(view, commandArguments);
            }
    ...
    public static class CollectionInfoCompat {
        ...
        public int getColumnCount() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionInfo) this.f2721a).getColumnCount();
            }
            return -1;
        }
        ...
        public int getRowCount() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionInfo) this.f2721a).getRowCount();
            }
            return -1;
        }
        ...
        public int getSelectionMode() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ((AccessibilityNodeInfo.CollectionInfo) this.f2721a).getSelectionMode();
            }
            return 0;
        }
        ...
        public boolean isHierarchical() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionInfo) this.f2721a).isHierarchical();
            }
            return false;
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public int getColumnIndex() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).getColumnIndex();
            }
            return 0;
        }
        ...
        public int getColumnSpan() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).getColumnSpan();
            }
            return 0;
        }
        ...
        public int getRowIndex() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).getRowIndex();
            }
            return 0;
        }
        ...
        public int getRowSpan() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).getRowSpan();
            }
            return 0;
        }
        ...
        public boolean isHeading() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).isHeading();
            }
            return false;
        }
        ...
        public boolean isSelected() {
            if (Build.VERSION.SDK_INT >= 21) {
                return ((AccessibilityNodeInfo.CollectionItemInfo) this.f2722a).isSelected();
            }
            return false;
        }
    }
    ...
    public static class RangeInfoCompat {
        ...
        public float getCurrent() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.RangeInfo) this.f2723a).getCurrent();
            }
            return 0.0f;
        }
        ...
        public float getMax() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.RangeInfo) this.f2723a).getMax();
            }
            return 0.0f;
        }
        ...
        public float getMin() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.RangeInfo) this.f2723a).getMin();
            }
            return 0.0f;
        }
        ...
        public int getType() {
            if (Build.VERSION.SDK_INT >= 19) {
                return ((AccessibilityNodeInfo.RangeInfo) this.f2723a).getType();
            }
            return 0;
        }
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public Region getRegionAt(@IntRange(from = 0) int i2) {
            if (Build.VERSION.SDK_INT >= 29) {
                return this.f2724a.getRegionAt(i2);
            }
            return null;
        }
        ...
        public int getRegionCount() {
            if (Build.VERSION.SDK_INT >= 29) {
                return this.f2724a.getRegionCount();
            }
            return 0;
        }
        ...
        public AccessibilityNodeInfoCompat getTargetForRegion(@NonNull Region region) {
            ...
            if (Build.VERSION.SDK_INT < 29 || (targetForRegion = this.f2724a.getTargetForRegion(region)) == null) {
                return null;
            }
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i2) {
        if (Build.VERSION.SDK_INT >= 16) {
            return a(AccessibilityNodeInfo.obtain(view, i2));
        }
        return null;
    }
    ...
    public void addAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            this.mInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) accessibilityActionCompat.f2719a);
        }
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i2) {
        if (Build.VERSION.SDK_INT >= 16) {
            return a(this.mInfo.findFocus(i2));
        }
        return null;
    }
    ...
    public AccessibilityNodeInfoCompat focusSearch(int i2) {
        if (Build.VERSION.SDK_INT >= 16) {
            return a(this.mInfo.focusSearch(i2));
        }
        return null;
    }
    ...
    public boolean removeAction(AccessibilityActionCompat accessibilityActionCompat) {
        if (Build.VERSION.SDK_INT >= 21) {
            return this.mInfo.removeAction((AccessibilityNodeInfo.AccessibilityAction) accessibilityActionCompat.f2719a);
        }
        return false;
    }
    ...
    public void setCollectionInfo(Object obj) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionInfo(obj == null ? null : (AccessibilityNodeInfo.CollectionInfo) ((CollectionInfoCompat) obj).f2721a);
        }
    }

    public void setCollectionItemInfo(Object obj) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setCollectionItemInfo(obj == null ? null : (AccessibilityNodeInfo.CollectionItemInfo) ((CollectionItemInfoCompat) obj).f2722a);
        }
    }
    ...
    public void setRangeInfo(RangeInfoCompat rangeInfoCompat) {
        if (Build.VERSION.SDK_INT >= 19) {
            this.mInfo.setRangeInfo((AccessibilityNodeInfo.RangeInfo) rangeInfoCompat.f2723a);
        }
    }
    ...
    public void setTouchDelegateInfo(@NonNull TouchDelegateInfoCompat touchDelegateInfoCompat) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.mInfo.setTouchDelegateInfo(touchDelegateInfoCompat.f2724a);
        }
    }
