...
public final class BidiFormatter {
    ...
    static final TextDirectionHeuristicCompat f2595a;

    /* renamed from: b  reason: collision with root package name */
    static final BidiFormatter f2596b;

    /* renamed from: c  reason: collision with root package name */
    static final BidiFormatter f2597c;
    ...
    public static final class Builder {
        ...
        private static BidiFormatter getDefaultInstanceFromContext(boolean z) {
            return z ? BidiFormatter.f2597c : BidiFormatter.f2596b;
        }

        private void initialize(boolean z) {
            this.mIsRtlContext = z;
            this.mTextDirectionHeuristicCompat = BidiFormatter.f2595a;
            this.mFlags = 2;
        }

        public BidiFormatter build() {
            return (this.mFlags == 2 && this.mTextDirectionHeuristicCompat == BidiFormatter.f2595a) ? getDefaultInstanceFromContext(this.mIsRtlContext) : new BidiFormatter(this.mIsRtlContext, this.mFlags, this.mTextDirectionHeuristicCompat);
        }
    ...
    static {
        ...
        f2595a = textDirectionHeuristicCompat;
        LRM_STRING = Character.toString(LRM);
        RLM_STRING = Character.toString(RLM);
        f2596b = new BidiFormatter(false, 2, textDirectionHeuristicCompat);
        f2597c = new BidiFormatter(true, 2, textDirectionHeuristicCompat);
    }
