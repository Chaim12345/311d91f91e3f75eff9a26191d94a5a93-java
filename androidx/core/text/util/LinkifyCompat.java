...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Comparator<LinkSpec>() { // from class: androidx.core.text.util.LinkifyCompat.1
        ...
        public int compare(LinkSpec linkSpec, LinkSpec linkSpec2) {
            int i2;
            int i3;
            int i4 = linkSpec.f2608c;
            int i5 = linkSpec2.f2608c;
            if (i4 < i5) {
                return -1;
            }
            if (i4 <= i5 && (i2 = linkSpec.f2609d) >= (i3 = linkSpec2.f2609d)) {
                return i2 > i3 ? -1 : 0;
            }
            return 1;
        }
    ...
    public static boolean addLinks(@NonNull Spannable spannable, int i2) {
        ...
        while (it.hasNext()) {
            ...
            if (linkSpec.f2606a == null) {
                applyLink(linkSpec.f2607b, linkSpec.f2608c, linkSpec.f2609d, spannable);
            }
        }
        return true;
    }
    ...
    private static void gatherLinks(ArrayList<LinkSpec> arrayList, Spannable spannable, Pattern pattern, String[] strArr, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
        ...
        while (matcher.find()) {
            ...
            if (matchFilter == null || matchFilter.acceptMatch(spannable, start, end)) {
                ...
                linkSpec.f2607b = makeUrl(matcher.group(0), strArr, matcher, transformFilter);
                linkSpec.f2608c = start;
                linkSpec.f2609d = end;
        ...
        while (true) {
            try {
                ...
                if (findAddress != null && (indexOf = obj.indexOf(findAddress)) >= 0) {
                    ...
                    linkSpec.f2608c = indexOf + i2;
                    i2 += length;
                    linkSpec.f2609d = i2;
                    obj = obj.substring(length);
                    try {
                        String encode = URLEncoder.encode(findAddress, "UTF-8");
                        linkSpec.f2607b = "geo:0,0?q=" + encode;
                        arrayList.add(linkSpec);
    ...
    private static void pruneOverlaps(ArrayList<LinkSpec> arrayList, Spannable spannable) {
        ...
        for (int i4 = 0; i4 < objArr.length; i4++) {
            LinkSpec linkSpec = new LinkSpec();
            linkSpec.f2606a = objArr[i4];
            linkSpec.f2608c = spannable.getSpanStart(objArr[i4]);
            linkSpec.f2609d = spannable.getSpanEnd(objArr[i4]);
            arrayList.add(linkSpec);
        }
        ...
        while (i3 < size - 1) {
            ...
            int i6 = linkSpec2.f2608c;
            int i7 = linkSpec3.f2608c;
            if (i6 <= i7 && (i2 = linkSpec2.f2609d) > i7) {
                int i8 = linkSpec3.f2609d;
                int i9 = (i8 > i2 && i2 - i6 <= i8 - i7) ? i2 - i6 < i8 - i7 ? i3 : -1 : i5;
                if (i9 != -1) {
                    Object obj = arrayList.get(i9).f2606a;
                    if (obj != null) {
