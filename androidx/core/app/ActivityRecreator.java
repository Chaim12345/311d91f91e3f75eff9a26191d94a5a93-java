...
final class ActivityRecreator {
    ...
    protected static final Class f2368a;

    /* renamed from: b  reason: collision with root package name */
    protected static final Field f2369b;

    /* renamed from: c  reason: collision with root package name */
    protected static final Field f2370c;

    /* renamed from: d  reason: collision with root package name */
    protected static final Method f2371d;

    /* renamed from: e  reason: collision with root package name */
    protected static final Method f2372e;

    /* renamed from: f  reason: collision with root package name */
    protected static final Method f2373f;
    ...
    private static final class LifecycleCheckCallbacks implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityPaused(Activity activity) {
            if (!this.mDestroyed || this.mStopQueued || this.mStarted || !ActivityRecreator.a(this.f2380a, this.mRecreatingHashCode, activity)) {
                return;
            }
    ...
    static {
        ...
        f2368a = activityThreadClass;
        f2369b = getMainThreadField();
        f2370c = getTokenField();
        f2371d = getPerformStopActivity3Params(activityThreadClass);
        f2372e = getPerformStopActivity2Params(activityThreadClass);
        f2373f = getRequestRelaunchActivityMethod(activityThreadClass);
    }
    ...
    public static boolean b(@NonNull Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            activity.recreate();
            return true;
        } else if (needsRelaunchCall() && f2373f == null) {
            return false;
        } else {
            if (f2372e == null && f2371d == null) {
                return false;
            }
            try {
                final Object obj2 = f2370c.get(activity);
                if (obj2 == null || (obj = f2369b.get(activity)) == null) {
                    return false;
                }
                ...
                handler.post(new Runnable() { // from class: androidx.core.app.ActivityRecreator.1
                    @Override // java.lang.Runnable
                    public void run() {
                        LifecycleCheckCallbacks.this.f2380a = obj2;
                    }
                });
                if (needsRelaunchCall()) {
                    Method method = f2373f;
