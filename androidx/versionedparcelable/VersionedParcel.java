...
public abstract class VersionedParcel {
    ...
    protected final ArrayMap f4226a;

    /* renamed from: b  reason: collision with root package name */
    protected final ArrayMap f4227b;

    /* renamed from: c  reason: collision with root package name */
    protected final ArrayMap f4228c;
    ...
    public VersionedParcel(ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
        this.f4226a = arrayMap;
        this.f4227b = arrayMap2;
        this.f4228c = arrayMap3;
    }
    ...
    private Class findParcelClass(Class<? extends VersionedParcelable> cls) {
        Class cls2 = (Class) this.f4228c.get(cls.getName());
        if (cls2 == null) {
            Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
            this.f4228c.put(cls.getName(), cls3);
            return cls3;
        }
        return cls2;
    }
    ...
    private Method getReadMethod(String str) {
        Method method = (Method) this.f4226a.get(str);
        if (method == null) {
            System.currentTimeMillis();
            Method declaredMethod = Class.forName(str, true, VersionedParcel.class.getClassLoader()).getDeclaredMethod("read", VersionedParcel.class);
            this.f4226a.put(str, declaredMethod);
    ...
    private Method getWriteMethod(Class cls) {
        Method method = (Method) this.f4227b.get(cls.getName());
        if (method == null) {
            ...
            this.f4227b.put(cls.getName(), declaredMethod);
            return declaredMethod;
        }
        return method;
    }
    ...
    protected void t(VersionedParcelable versionedParcelable, VersionedParcel versionedParcel) {
        try {
