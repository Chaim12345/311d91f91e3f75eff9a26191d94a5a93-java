...
public final class Target {
    ...
    Target(@NonNull Target target) {
        ...
        this.f3440c = fArr3;
        this.f3441d = true;
        System.arraycopy(target.f3438a, 0, fArr, 0, fArr.length);
        System.arraycopy(target.f3439b, 0, fArr2, 0, fArr2.length);
        System.arraycopy(target.f3440c, 0, fArr3, 0, fArr3.length);
    }

    private static void setDefaultDarkLightnessValues(Target target) {
        float[] fArr = target.f3439b;
        fArr[1] = 0.26f;
        fArr[2] = 0.45f;
    }
    ...
    public void a() {
        int length = this.f3440c.length;
        float f2 = 0.0f;
        for (int i2 = 0; i2 < length; i2++) {
            float f3 = this.f3440c[i2];
            if (f3 > 0.0f) {
                f2 += f3;
            }
        }
        if (f2 != 0.0f) {
            int length2 = this.f3440c.length;
    ...
    public float getMaximumLightness() {
        return this.f3439b[2];
    }

    @FloatRange(from = 0.0d, to = 1.0d)
    public float getMaximumSaturation() {
        return this.f3438a[2];
    }

    @FloatRange(from = 0.0d, to = 1.0d)
    public float getMinimumLightness() {
        return this.f3439b[0];
    }
