...
class RoundRectDrawable extends Drawable {
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            float b2 = RoundRectDrawableWithShadow.b(this.mPadding, this.mRadius, this.mInsetForRadius);
            this.mBoundsI.inset((int) Math.ceil(RoundRectDrawableWithShadow.a(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil(b2));
