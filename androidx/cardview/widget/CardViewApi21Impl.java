...
public class CardViewApi21Impl implements CardViewImpl {
    ...
    public void setMaxElevation(CardViewDelegate cardViewDelegate, float f2) {
        getCardBackground(cardViewDelegate).b(f2, cardViewDelegate.getUseCompatPadding(), cardViewDelegate.getPreventCornerOverlap());
        updatePadding(cardViewDelegate);
    }

    @Override // androidx.cardview.widget.CardViewImpl
    public void setRadius(CardViewDelegate cardViewDelegate, float f2) {
        getCardBackground(cardViewDelegate).c(f2);
    }
