...
public class TableInfo {
    ...
    public static class ForeignKeyWithSequence implements Comparable<ForeignKeyWithSequence> {
        ...
        public int compareTo(@NonNull ForeignKeyWithSequence foreignKeyWithSequence) {
            int i2 = this.f3958a - foreignKeyWithSequence.f3958a;
            return i2 == 0 ? this.f3959b - foreignKeyWithSequence.f3959b : i2;
        }
    }
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                if (query.getInt(columnIndex2) == 0) {
                    ...
                    for (ForeignKeyWithSequence foreignKeyWithSequence : readForeignKeyFieldMappings) {
                        if (foreignKeyWithSequence.f3958a == i3) {
                            arrayList.add(foreignKeyWithSequence.f3960c);
                            arrayList2.add(foreignKeyWithSequence.f3961d);
                        }
                    }
