...
public final class LifecycleKt {
    ...
    public static final LifecycleCoroutineScope getCoroutineScope(@NotNull Lifecycle coroutineScope) {
        ...
        do {
            LifecycleCoroutineScopeImpl lifecycleCoroutineScopeImpl2 = (LifecycleCoroutineScopeImpl) coroutineScope.f3205a.get();
        ...
        } while (!coroutineScope.f3205a.compareAndSet(null, lifecycleCoroutineScopeImpl));
