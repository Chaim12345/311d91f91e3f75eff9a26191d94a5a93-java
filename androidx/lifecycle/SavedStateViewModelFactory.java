...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(@NonNull String str, @NonNull Class<T> cls) {
        ...
        SavedStateHandleController c2 = SavedStateHandleController.c(this.mSavedStateRegistry, this.mLifecycle, str, this.mDefaultArgs);
        if (isAssignableFrom) {
            try {
                Application application = this.mApplication;
                if (application != null) {
                    newInstance = findMatchingConstructor.newInstance(application, c2.d());
                    T t2 = (T) newInstance;
        ...
        newInstance = findMatchingConstructor.newInstance(c2.d());
        T t22 = (T) newInstance;
        t22.setTagIfAbsent("androidx.lifecycle.savedstate.vm.tag", c2);
        return t22;
    }
}
