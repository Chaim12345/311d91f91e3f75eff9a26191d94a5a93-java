...
final class LifecycleCoroutineScope$launchWhenStarted$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ LifecycleCoroutineScope f3217b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ Function2 f3218c;
    ...
    public LifecycleCoroutineScope$launchWhenStarted$1(LifecycleCoroutineScope lifecycleCoroutineScope, Function2 function2, Continuation continuation) {
        ...
        this.f3217b = lifecycleCoroutineScope;
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new LifecycleCoroutineScope$launchWhenStarted$1(this.f3217b, this.f3218c, completion);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            Lifecycle lifecycle$lifecycle_runtime_ktx_release = this.f3217b.getLifecycle$lifecycle_runtime_ktx_release();
            Function2 function2 = this.f3218c;
            this.f3216a = 1;
