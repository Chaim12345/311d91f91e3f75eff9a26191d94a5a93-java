...
public class AlertDialog extends AppCompatDialog {
    ...
    public static class Builder {
        ...
        public AlertDialog create() {
            ...
            this.P.apply(alertDialog.f244a);
    ...
    protected AlertDialog(@NonNull Context context, @StyleRes int i2) {
        ...
        this.f244a = new AlertController(getContext(), this, getWindow());
    }

    static int b(@NonNull Context context, @StyleRes int i2) {
        if (((i2 >>> 24) & 255) >= 1) {
            return i2;
        }
        TypedValue typedValue = new TypedValue();
    ...
    public Button getButton(int i2) {
        return this.f244a.getButton(i2);
    }

    public ListView getListView() {
        return this.f244a.getListView();
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f244a.installContent();
    }

    @Override // android.app.Dialog, android.view.KeyEvent.Callback
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        if (this.f244a.onKeyDown(i2, keyEvent)) {
            return true;
        }
    ...
    public boolean onKeyUp(int i2, KeyEvent keyEvent) {
        if (this.f244a.onKeyUp(i2, keyEvent)) {
            return true;
        }
    ...
    public void setButton(int i2, CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
        this.f244a.setButton(i2, charSequence, onClickListener, null, null);
    }

    public void setButton(int i2, CharSequence charSequence, Drawable drawable, DialogInterface.OnClickListener onClickListener) {
        this.f244a.setButton(i2, charSequence, onClickListener, null, drawable);
    }

    public void setButton(int i2, CharSequence charSequence, Message message) {
        this.f244a.setButton(i2, charSequence, null, message, null);
    }

    public void setCustomTitle(View view) {
        this.f244a.setCustomTitle(view);
    }

    public void setIcon(int i2) {
        this.f244a.setIcon(i2);
    }

    public void setIcon(Drawable drawable) {
        this.f244a.setIcon(drawable);
    }

    public void setIconAttribute(int i2) {
        TypedValue typedValue = new TypedValue();
        getContext().getTheme().resolveAttribute(i2, typedValue, true);
        this.f244a.setIcon(typedValue.resourceId);
    }

    public void setMessage(CharSequence charSequence) {
        this.f244a.setMessage(charSequence);
    }
    ...
    public void setView(View view) {
        this.f244a.setView(view);
    }

    public void setView(View view, int i2, int i3, int i4, int i5) {
        this.f244a.setView(view, i2, i3, i4, i5);
    }
}
