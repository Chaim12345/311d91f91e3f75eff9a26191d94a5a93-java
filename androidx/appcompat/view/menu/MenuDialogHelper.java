...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void onClick(DialogInterface dialogInterface, int i2) {
        this.mMenu.performItemAction((MenuItemImpl) this.f417a.getAdapter().getItem(i2), 0);
    }
    ...
    public void onDismiss(DialogInterface dialogInterface) {
        this.f417a.onCloseMenu(this.mMenu, true);
    }
    ...
    public void show(IBinder iBinder) {
        ...
        this.f417a = listMenuPresenter;
        listMenuPresenter.setCallback(this);
        this.mMenu.addMenuPresenter(this.f417a);
        builder.setAdapter(this.f417a.getAdapter(), this);
