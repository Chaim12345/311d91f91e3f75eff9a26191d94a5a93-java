...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    private class ActionProviderWrapper extends ActionProvider {
        ...
        final android.view.ActionProvider f420a;

        ActionProviderWrapper(Context context, android.view.ActionProvider actionProvider) {
            super(context);
            this.f420a = actionProvider;
        }

        @Override // androidx.core.view.ActionProvider
        public boolean hasSubMenu() {
            return this.f420a.hasSubMenu();
        }

        @Override // androidx.core.view.ActionProvider
        public View onCreateActionView() {
            return this.f420a.onCreateActionView();
        }

        @Override // androidx.core.view.ActionProvider
        public boolean onPerformDefaultAction() {
            return this.f420a.onPerformDefaultAction();
        }

        @Override // androidx.core.view.ActionProvider
        public void onPrepareSubMenu(SubMenu subMenu) {
            this.f420a.onPrepareSubMenu(MenuItemWrapperICS.this.b(subMenu));
        }
    }
    ...
    private class ActionProviderWrapperJB extends ActionProviderWrapper implements ActionProvider.VisibilityListener {
        ...
        public View onCreateActionView(MenuItem menuItem) {
            return this.f420a.onCreateActionView(menuItem);
        }

        @Override // androidx.core.view.ActionProvider
        public boolean overridesItemVisibility() {
            return this.f420a.overridesItemVisibility();
        }

        @Override // androidx.core.view.ActionProvider
        public void refreshVisibility() {
            this.f420a.refreshVisibility();
        }

        @Override // androidx.core.view.ActionProvider
        public void setVisibilityListener(ActionProvider.VisibilityListener visibilityListener) {
            this.mListener = visibilityListener;
            this.f420a.setVisibilityListener(visibilityListener != null ? this : null);
        }
    }
    ...
    static class CollapsibleActionViewWrapper extends FrameLayout implements CollapsibleActionView {
        ...
        /* renamed from: a  reason: collision with root package name */
        final android.view.CollapsibleActionView f422a;

        CollapsibleActionViewWrapper(View view) {
            super(view.getContext());
            this.f422a = (android.view.CollapsibleActionView) view;
            addView(view);
        }

        View a() {
            return (View) this.f422a;
        }

        @Override // androidx.appcompat.view.CollapsibleActionView
        public void onActionViewCollapsed() {
            this.f422a.onActionViewCollapsed();
        }

        @Override // androidx.appcompat.view.CollapsibleActionView
        public void onActionViewExpanded() {
            this.f422a.onActionViewExpanded();
        }
    }
    ...
    public android.view.ActionProvider getActionProvider() {
        ...
        if (supportActionProvider instanceof ActionProviderWrapper) {
            return ((ActionProviderWrapper) supportActionProvider).f420a;
        }
        return null;
    }
    ...
    public MenuItem setActionProvider(android.view.ActionProvider actionProvider) {
        androidx.core.view.ActionProvider actionProviderWrapperJB = Build.VERSION.SDK_INT >= 16 ? new ActionProviderWrapperJB(this, this.f390a, actionProvider) : new ActionProviderWrapper(this.f390a, actionProvider);
