...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public char a() {
        return this.f418a.isQwertyMode() ? this.mShortcutAlphabeticChar : this.mShortcutNumericChar;
    }
    ...
    public String b() {
        ...
        Resources resources = this.f418a.getContext().getResources();
        StringBuilder sb = new StringBuilder();
        if (ViewConfiguration.get(this.f418a.getContext()).hasPermanentMenuKey()) {
            sb.append(resources.getString(R.string.abc_prepend_shortcut_label));
        }
        int i3 = this.f418a.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
    ...
    public boolean collapseActionView() {
        ...
        if (onActionExpandListener == null || onActionExpandListener.onMenuItemActionCollapse(this)) {
            return this.f418a.collapseItemActionView(this);
        }
        return false;
    }
    ...
    public void d(boolean z) {
        ...
        this.mFlags = i3;
        if (i2 != i3) {
            this.f418a.onItemsChanged(false);
        }
    }
    ...
    public boolean expandActionView() {
        if (hasCollapsibleActionView()) {
            ...
            if (onActionExpandListener == null || onActionExpandListener.onMenuItemActionExpand(this)) {
                return this.f418a.expandItemActionView(this);
            }
            return false;
        }
        return false;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean g() {
        return this.f418a.isShortcutsVisible() && a() != 0;
    }
    ...
    public Drawable getIcon() {
        ...
        if (this.mIconResId != 0) {
            Drawable drawable2 = AppCompatResources.getDrawable(this.f418a.getContext(), this.mIconResId);
            this.mIconResId = 0;
    ...
    public boolean invoke() {
        ...
        if (onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(this)) {
            MenuBuilder menuBuilder = this.f418a;
            ...
            if (this.mIntent != null) {
                try {
                    this.f418a.getContext().startActivity(this.mIntent);
                    return true;
    ...
    public SupportMenuItem setSupportActionProvider(ActionProvider actionProvider) {
        ...
        this.f418a.onItemsChanged(true);
        ...
        if (actionProvider3 != null) {
            actionProvider3.setVisibilityListener(new ActionProvider.VisibilityListener() { // from class: androidx.appcompat.view.menu.MenuItemImpl.1
                ...
                public void onActionProviderVisibilityChanged(boolean z) {
                    ...
                    menuItemImpl.f418a.h(menuItemImpl);
                }
            });
        }
        return this;
    ...
    public MenuItem setTitle(int i2) {
        return setTitle(this.f418a.getContext().getString(i2));
    }
