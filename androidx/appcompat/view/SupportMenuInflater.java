...
public class SupportMenuInflater extends MenuInflater {
    ...
    static final Class[] f370d;

    /* renamed from: e  reason: collision with root package name */
    static final Class[] f371e;
    ...
    public class MenuState {
        ...
        private <T> T newInstance(String str, Class<?>[] clsArr, Object[] objArr) {
            try {
                Constructor<?> constructor = Class.forName(str, false, SupportMenuInflater.this.f374c.getClassLoader()).getConstructor(clsArr);
        ...
        private void setItem(MenuItem menuItem) {
            ...
            if (this.itemListenerMethodName != null) {
                if (SupportMenuInflater.this.f374c.isRestricted()) {
            ...
            if (str != null) {
                menuItem.setActionView((View) newInstance(str, SupportMenuInflater.f370d, SupportMenuInflater.this.f372a));
                z = true;
            }
        ...
        public void readGroup(AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = SupportMenuInflater.this.f374c.obtainStyledAttributes(attributeSet, R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attributeSet) {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(SupportMenuInflater.this.f374c, attributeSet, R.styleable.MenuItem);
            ...
            this.itemCheckable = obtainStyledAttributes.hasValue(i2) ? obtainStyledAttributes.getBoolean(i2, false) : this.groupCheckable;
            ...
            if ((string != null) && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                this.f375a = (ActionProvider) newInstance(string, SupportMenuInflater.f371e, SupportMenuInflater.this.f373b);
            } else {
                this.f375a = null;
            }
    ...
    */
    ...
    Object a() {
        if (this.mRealOwner == null) {
            this.mRealOwner = findRealOwner(this.f374c);
        }
    ...
    public void inflate(@LayoutRes int i2, Menu menu) {
        ...
        try {
            try {
                try {
                    xmlResourceParser = this.f374c.getResources().getLayout(i2);
