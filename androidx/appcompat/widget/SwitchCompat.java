...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property<SwitchCompat, Float> THUMB_POS = new Property<SwitchCompat, Float>(Float.class, "thumbPos") { // from class: androidx.appcompat.widget.SwitchCompat.1
        ...
        public Float get(SwitchCompat switchCompat) {
            return Float.valueOf(switchCompat.f580a);
        }
    ...
    private void cancelPositionAnimator() {
        ObjectAnimator objectAnimator = this.f581b;
    ...
    private boolean getTargetCheckedState() {
        return this.f580a > 0.5f;
    }

    private int getThumbOffset() {
        return (int) (((ViewUtils.isLayoutRtl(this) ? 1.0f - this.f580a : this.f580a) * getThumbScrollRange()) + 0.5f);
    }
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (i2 == 1) {
                        ...
                        float constrain = constrain(this.f580a + f3, 0.0f, 1.0f);
                        if (constrain != this.f580a) {
                            this.mTouchX = x2;
