...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] f448e = {R.attr.actionBarSize, 16842841};

    /* renamed from: a  reason: collision with root package name */
    ActionBarContainer f449a;

    /* renamed from: b  reason: collision with root package name */
    boolean f450b;

    /* renamed from: c  reason: collision with root package name */
    ViewPropertyAnimator f451c;

    /* renamed from: d  reason: collision with root package name */
    final AnimatorListenerAdapter f452d;
    ...
    public ActionBarOverlayLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f452d = new AnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ActionBarOverlayLayout.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationCancel(Animator animator) {
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.f451c = null;
                actionBarOverlayLayout.f450b = false;
            }
        ...
        this.mRemoveActionBarHideOffset = new Runnable() { // from class: androidx.appcompat.widget.ActionBarOverlayLayout.2
            ...
            public void run() {
                ...
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.f451c = actionBarOverlayLayout.f449a.animate().translationY(0.0f).setListener(ActionBarOverlayLayout.this.f452d);
            }
        };
        this.mAddActionBarHideOffset = new Runnable() { // from class: androidx.appcompat.widget.ActionBarOverlayLayout.3
            ...
            public void run() {
                ActionBarOverlayLayout.this.b();
                ActionBarOverlayLayout actionBarOverlayLayout = ActionBarOverlayLayout.this;
                actionBarOverlayLayout.f451c = actionBarOverlayLayout.f449a.animate().translationY(-ActionBarOverlayLayout.this.f449a.getHeight()).setListener(ActionBarOverlayLayout.this.f452d);
            }
        };
        init(context);
    ...
    */
    ...
    private void init(Context context) {
        TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(f448e);
    ...
    private boolean shouldHideActionBarOnFling(float f2) {
        ...
        return this.mFlingEstimator.getFinalY() > this.f449a.getHeight();
    }
    ...
    void b() {
        ...
        ViewPropertyAnimator viewPropertyAnimator = this.f451c;
    ...
    void c() {
        if (this.mContent == null) {
            ...
            this.f449a = (ActionBarContainer) findViewById(R.id.action_bar_container);
    ...
    public void draw(Canvas canvas) {
        ...
        int bottom = this.f449a.getVisibility() == 0 ? (int) (this.f449a.getBottom() + this.f449a.getTranslationY() + 0.5f) : 0;
    ...
    protected boolean fitSystemWindows(Rect rect) {
        ...
        c();
        boolean applyInsets = applyInsets(this.f449a, rect, true, true, false, true);
    ...
    public WindowInsets onApplyWindowInsets(@NonNull WindowInsets windowInsets) {
        ...
        boolean applyInsets = applyInsets(this.f449a, new Rect(windowInsetsCompat.getSystemWindowInsetLeft(), windowInsetsCompat.getSystemWindowInsetTop(), windowInsetsCompat.getSystemWindowInsetRight(), windowInsetsCompat.getSystemWindowInsetBottom()), true, true, false, true);
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        c();
        measureChildWithMargins(this.f449a, i2, 0, i3, 0);
        LayoutParams layoutParams = (LayoutParams) this.f449a.getLayoutParams();
        int max = Math.max(0, this.f449a.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
        int max2 = Math.max(0, this.f449a.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
        int combineMeasuredStates = View.combineMeasuredStates(0, this.f449a.getMeasuredState());
        boolean z = (ViewCompat.getWindowSystemUiVisibility(this) & 256) != 0;
        if (z) {
            measuredHeight = this.mActionBarHeight;
            if (this.mHasNonEmbeddedTabs && this.f449a.getTabContainer() != null) {
                measuredHeight += this.mActionBarHeight;
            }
        } else {
            measuredHeight = this.f449a.getVisibility() != 8 ? this.f449a.getMeasuredHeight() : 0;
        }
        ...
        if (!this.mOverlayMode && !z) {
            ...
            build = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
            this.mInnerInsets = build;
        } else {
    ...
    public boolean onStartNestedScroll(View view, View view2, int i2) {
        if ((i2 & 2) == 0 || this.f449a.getVisibility() != 0) {
            return false;
        }
        return this.mHideOnContentScroll;
    }
    ...
    public void onStopNestedScroll(View view) {
        if (this.mHideOnContentScroll && !this.f450b) {
            if (this.mHideOnContentScrollReference <= this.f449a.getHeight()) {
    ...
    public void setActionBarHideOffset(int i2) {
        b();
        this.f449a.setTranslationY(-Math.max(0, Math.min(i2, this.f449a.getHeight())));
    }
