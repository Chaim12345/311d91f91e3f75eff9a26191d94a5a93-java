...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.f436e = obtainStyledAttributes.getLayoutDimension(R.styleable.ActionMode_height, 0);
    ...
    */
    public void initForMode(final ActionMode actionMode) {
        ...
        if (view2 != null) {
            ...
            actionMenuPresenter = this.f435d;
            if (actionMenuPresenter != null) {
                actionMenuPresenter.dismissPopupMenus();
            }
            ActionMenuPresenter actionMenuPresenter2 = new ActionMenuPresenter(getContext());
            this.f435d = actionMenuPresenter2;
            actionMenuPresenter2.setReserveOverflow(true);
            ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(-2, -1);
            menuBuilder.addMenuPresenter(this.f435d, this.f433b);
            ActionMenuView actionMenuView = (ActionMenuView) this.f435d.getMenuView(this);
            this.f434c = actionMenuView;
            ViewCompat.setBackground(actionMenuView, null);
            addView(this.f434c, layoutParams);
        }
        ...
        findViewById2.setOnClickListener(new View.OnClickListener(this) { // from class: androidx.appcompat.widget.ActionBarContextView.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view3) {
                actionMode.finish();
            }
        ...
        this.f435d = actionMenuPresenter22;
        actionMenuPresenter22.setReserveOverflow(true);
        ViewGroup.LayoutParams layoutParams2 = new ViewGroup.LayoutParams(-2, -1);
        menuBuilder2.addMenuPresenter(this.f435d, this.f433b);
        ActionMenuView actionMenuView2 = (ActionMenuView) this.f435d.getMenuView(this);
        this.f434c = actionMenuView2;
        ViewCompat.setBackground(actionMenuView2, null);
        addView(this.f434c, layoutParams2);
    }
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            paddingRight = AbsActionBarView.d(d2 + e(this.mClose, d2, paddingTop, paddingTop2, isLayoutRtl), i7, isLayoutRtl);
        }
        int i8 = paddingRight;
        LinearLayout linearLayout = this.mTitleLayout;
        if (linearLayout != null && this.mCustomView == null && linearLayout.getVisibility() != 8) {
            i8 += e(this.mTitleLayout, i8, paddingTop, paddingTop2, isLayoutRtl);
        }
        int i9 = i8;
        ...
        ActionMenuView actionMenuView = this.f434c;
    ...
    protected void onMeasure(int i2, int i3) {
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f434c, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.mTitleLayout;
