...
public final class ResourceManagerInternal {
    ...
    public static class ColorFilterLruCache extends LruCache<Integer, PorterDuffColorFilter> {
        ...
        PorterDuffColorFilter d(int i2, PorterDuff.Mode mode) {
            return get(Integer.valueOf(generateCacheKey(i2, mode)));
        }

        PorterDuffColorFilter e(int i2, PorterDuff.Mode mode, PorterDuffColorFilter porterDuffColorFilter) {
    ...
    public static synchronized PorterDuffColorFilter getPorterDuffColorFilter(int i2, PorterDuff.Mode mode) {
        ...
        synchronized (ResourceManagerInternal.class) {
            ...
            d2 = colorFilterLruCache.d(i2, mode);
            if (d2 == null) {
                d2 = new PorterDuffColorFilter(i2, mode);
                colorFilterLruCache.e(i2, mode, d2);
            }
        }
        return d2;
    }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i2, boolean z, @NonNull Drawable drawable) {
        ...
        if (b2 == null) {
            ResourceManagerHooks resourceManagerHooks = this.mHooks;
            if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i2, drawable)) && !f(context, i2, drawable) && z) {
                return null;
            }
            return drawable;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Drawable d(@NonNull Context context, @NonNull VectorEnabledTintResources vectorEnabledTintResources, @DrawableRes int i2) {
        Drawable loadDrawableFromDelegates = loadDrawableFromDelegates(context, i2);
        if (loadDrawableFromDelegates == null) {
            loadDrawableFromDelegates = vectorEnabledTintResources.a(i2);
        }
        if (loadDrawableFromDelegates != null) {
