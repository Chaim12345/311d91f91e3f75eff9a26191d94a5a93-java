...
public class Toolbar extends ViewGroup {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean collapseItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            View view = Toolbar.this.f588b;
            if (view instanceof CollapsibleActionView) {
                ((CollapsibleActionView) view).onActionViewCollapsed();
            }
            Toolbar toolbar = Toolbar.this;
            toolbar.removeView(toolbar.f588b);
            Toolbar toolbar2 = Toolbar.this;
            toolbar2.removeView(toolbar2.f587a);
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            Toolbar.this.b();
            ViewParent parent = Toolbar.this.f587a.getParent();
            Toolbar toolbar = Toolbar.this;
            if (parent != toolbar) {
                if (parent instanceof ViewGroup) {
                    ((ViewGroup) parent).removeView(toolbar.f587a);
                }
                Toolbar toolbar2 = Toolbar.this;
                toolbar2.addView(toolbar2.f587a);
            }
            Toolbar.this.f588b = menuItemImpl.getActionView();
            this.f595b = menuItemImpl;
            ViewParent parent2 = Toolbar.this.f588b.getParent();
            Toolbar toolbar3 = Toolbar.this;
            if (parent2 != toolbar3) {
                if (parent2 instanceof ViewGroup) {
                    ((ViewGroup) parent2).removeView(toolbar3.f588b);
                }
                LayoutParams generateDefaultLayoutParams = Toolbar.this.generateDefaultLayoutParams();
                Toolbar toolbar4 = Toolbar.this;
                generateDefaultLayoutParams.gravity = 8388611 | (toolbar4.f589c & 112);
                generateDefaultLayoutParams.f597a = 2;
                toolbar4.f588b.setLayoutParams(generateDefaultLayoutParams);
                Toolbar toolbar5 = Toolbar.this;
                toolbar5.addView(toolbar5.f588b);
            }
            Toolbar.this.e();
            Toolbar.this.requestLayout();
        ...
        public void initForMenu(Context context, MenuBuilder menuBuilder) {
            ...
            MenuBuilder menuBuilder2 = this.f594a;
            if (menuBuilder2 != null && (menuItemImpl = this.f595b) != null) {
                menuBuilder2.collapseItemActionView(menuItemImpl);
            }
            this.f594a = menuBuilder;
        }
        ...
        public void updateMenuView(boolean z) {
            if (this.f595b != null) {
                MenuBuilder menuBuilder = this.f594a;
                boolean z2 = false;
                if (menuBuilder != null) {
                    ...
                    while (true) {
                        if (i2 >= size) {
                            break;
                        } else if (this.f594a.getItem(i2) == this.f595b) {
                            z2 = true;
                            break;
                        } else {
                            i2++;
                ...
                collapseItemActionView(this.f594a, this.f595b);
            }
        }
    }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.mMenuViewItemClickListener = new ActionMenuView.OnMenuItemClickListener() { // from class: androidx.appcompat.widget.Toolbar.1
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                OnMenuItemClickListener onMenuItemClickListener = Toolbar.this.f590d;
        ...
        this.f589c = obtainStyledAttributes.getInteger(R.styleable.Toolbar_buttonGravity, 48);
    ...
    private void addCustomViewsWithGravity(List<View> list, int i2) {
        ...
        if (!z) {
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                if (layoutParams.f597a == 0 && shouldLayout(childAt) && getChildHorizontalGravity(layoutParams.gravity) == absoluteGravity) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i4 = childCount - 1; i4 >= 0; i4--) {
            ...
            if (layoutParams2.f597a == 0 && shouldLayout(childAt2) && getChildHorizontalGravity(layoutParams2.gravity) == absoluteGravity) {
                list.add(childAt2);
            }
        }
    }
    ...
    private void addSystemView(View view, boolean z) {
        ...
        generateDefaultLayoutParams.f597a = 1;
        if (!z || this.f588b == null) {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = 8388613 | (this.f589c & 112);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = 8388611 | (this.f589c & 112);
    ...
    void b() {
        if (this.f587a == null) {
            ...
            this.f587a = appCompatImageButton;
            appCompatImageButton.setImageDrawable(this.mCollapseIcon);
            this.f587a.setContentDescription(this.mCollapseDescription);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = 8388611 | (this.f589c & 112);
            generateDefaultLayoutParams.f597a = 2;
            this.f587a.setLayoutParams(generateDefaultLayoutParams);
            this.f587a.setOnClickListener(new View.OnClickListener() { // from class: androidx.appcompat.widget.Toolbar.3
    ...
    public void collapseActionView() {
        ...
        MenuItemImpl menuItemImpl = expandedActionViewMenuPresenter == null ? null : expandedActionViewMenuPresenter.f595b;
    ...
    void e() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f597a != 2 && childAt != this.mMenuView) {
    ...
    public CharSequence getCollapseContentDescription() {
        ImageButton imageButton = this.f587a;
        if (imageButton != null) {
    ...
    public boolean hasExpandedActionView() {
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        return (expandedActionViewMenuPresenter == null || expandedActionViewMenuPresenter.f595b == null) ? false : true;
    }
    ...
    */
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ImageButton imageButton = this.mNavButtonView;
            if (z2) {
                i7 = layoutChildRight(imageButton, i24, iArr, min);
                i6 = paddingLeft;
                if (shouldLayout(this.f587a)) {
                    ImageButton imageButton2 = this.f587a;
                    if (z2) {
                        i7 = layoutChildRight(imageButton2, i7, iArr, min);
                    } else {
                ...
                if (shouldLayout(this.mMenuView)) {
                    ...
                    if (z2) {
                        ...
                        i7 = layoutChildRight(actionMenuView, i7, iArr, min);
                    }
                }
                ...
                if (!shouldLayout || shouldLayout2) {
                    ...
                    if (z2) {
                        ...
                        int i31 = i16 - iArr[i15];
                        max = i13 + Math.max(i15, i31);
                        iArr[i15] = Math.max(i15, -i31);
                        if (shouldLayout) {
                        ...
                        if (shouldLayout2) {
                            ...
                            this.mSubtitleTextView.layout(max, i32, measuredWidth2, this.mSubtitleTextView.getMeasuredHeight() + i32);
                        ...
                        for (i22 = i15; i22 < size2; i22++) {
                            min2 = layoutChildRight(this.mTempViews.get(i22), min2, iArr, i33);
                        }
                        addCustomViewsWithGravity(this.mTempViews, 1);
                        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                        i23 = (i12 + (((i10 - i12) - i8) / 2)) - (viewListMeasuredWidth / 2);
                        int i34 = viewListMeasuredWidth + i23;
                        if (i23 >= max) {
                            max = i34 > min2 ? i23 - (i34 - min2) : i23;
                        }
                        size3 = this.mTempViews.size();
                        while (i15 < size3) {
                            max = layoutChildLeft(this.mTempViews.get(i15), max, iArr, i33);
                            i15++;
                        }
                        this.mTempViews.clear();
                        return;
                    }
                    int i35 = (z3 ? this.mTitleMarginStart : 0) - iArr[1];
                    min2 -= Math.max(0, i35);
                    ...
                    if (shouldLayout2) {
                        ...
                        this.mSubtitleTextView.layout(min2 - this.mSubtitleTextView.getMeasuredWidth(), i36, min2, this.mSubtitleTextView.getMeasuredHeight() + i36);
                ...
                int i342 = viewListMeasuredWidth2 + i23;
                if (i23 >= max) {
                }
                size3 = this.mTempViews.size();
                while (i15 < size3) {
    ...
    protected void onMeasure(int i2, int i3) {
        ...
        if (shouldLayout(this.f587a)) {
            measureChildConstrained(this.f587a, i2, 0, i3, 0, this.mMaxButtonHeight);
            i4 = this.f587a.getMeasuredWidth() + getHorizontalMargins(this.f587a);
            i5 = Math.max(i5, this.f587a.getMeasuredHeight() + getVerticalMargins(this.f587a));
            i6 = View.combineMeasuredStates(i6, this.f587a.getMeasuredState());
        }
        ...
        if (shouldLayout(this.f588b)) {
            max2 += measureChildCollapseMargins(this.f588b, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, this.f588b.getMeasuredHeight() + getVerticalMargins(this.f588b));
            i6 = View.combineMeasuredStates(i6, this.f588b.getMeasuredState());
        }
        if (shouldLayout(this.mLogoView)) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f597a == 0 && shouldLayout(childAt)) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        if (expandedActionViewMenuPresenter != null && (menuItemImpl = expandedActionViewMenuPresenter.f595b) != null) {
            savedState.f598a = menuItemImpl.getItemId();
        }
        savedState.f599b = isOverflowMenuShowing();
        return savedState;
    }
    ...
    public void setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
        this.f590d = onMenuItemClickListener;
    }
