...
public class SafeCloseImageReaderProxy implements ImageReaderProxy {
    ...
    private ForwardingImageProxy.OnImageCloseListener mImageCloseListener = new ForwardingImageProxy.OnImageCloseListener() { // from class: androidx.camera.core.g1
    ...
    private ImageProxy wrapImageProxy(@Nullable ImageProxy imageProxy) {
        synchronized (this.mLock) {
            if (imageProxy != null) {
                ...
                singleCloseImageProxy.a(this.mImageCloseListener);
    ...
    public void setOnImageAvailableListener(@NonNull final ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, @NonNull Executor executor) {
        synchronized (this.mLock) {
            this.mImageReaderProxy.setOnImageAvailableListener(new ImageReaderProxy.OnImageAvailableListener() { // from class: androidx.camera.core.h1
