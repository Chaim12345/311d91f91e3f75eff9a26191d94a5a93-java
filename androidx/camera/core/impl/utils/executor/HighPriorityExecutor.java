...
final class HighPriorityExecutor implements Executor {
    ...
    private final ExecutorService mHighPriorityService = Executors.newSingleThreadExecutor(new ThreadFactory(this) { // from class: androidx.camera.core.impl.utils.executor.HighPriorityExecutor.1
