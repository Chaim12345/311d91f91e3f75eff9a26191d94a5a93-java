...
final class IoExecutor implements Executor {
    ...
    private final ExecutorService mIoService = Executors.newFixedThreadPool(2, new ThreadFactory(this) { // from class: androidx.camera.core.impl.utils.executor.IoExecutor.1
