...
public final class Camera2ImplConfig extends CaptureRequestOptions {
    ...
    public static final class Extender<T> {
        ...
        ExtendableBuilder f656a;

        public Extender(@NonNull ExtendableBuilder<T> extendableBuilder) {
            this.f656a = extendableBuilder;
        }

        @NonNull
        public Extender<T> setCameraEventCallback(@NonNull CameraEventCallbacks cameraEventCallbacks) {
            this.f656a.getMutableConfig().insertOption(Camera2ImplConfig.CAMERA_EVENT_CALLBACK_OPTION, cameraEventCallbacks);
            return this;
        }
    }
