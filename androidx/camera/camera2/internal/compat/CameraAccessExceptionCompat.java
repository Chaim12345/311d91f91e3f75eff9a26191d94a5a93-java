...
public class CameraAccessExceptionCompat extends Exception {
    ...
    static final Set f759a = Collections.unmodifiableSet(new HashSet(Arrays.asList(4, 5, 1, 2, 3)));
    ...
    static {
        Collections.unmodifiableSet(new HashSet(Arrays.asList(Integer.valueOf((int) CAMERA_UNAVAILABLE_DO_NOT_DISTURB), Integer.valueOf((int) CAMERA_CHARACTERISTICS_CREATION_ERROR))));
    }

    public CameraAccessExceptionCompat(int i2) {
        super(getDefaultMessage(i2));
        this.mReason = i2;
        this.mCameraAccessException = f759a.contains(Integer.valueOf(i2)) ? new CameraAccessException(i2) : null;
    }

    public CameraAccessExceptionCompat(int i2, @Nullable String str) {
        super(getCombinedMessage(i2, str));
        this.mReason = i2;
        this.mCameraAccessException = f759a.contains(Integer.valueOf(i2)) ? new CameraAccessException(i2, str) : null;
    }

    public CameraAccessExceptionCompat(int i2, @Nullable String str, @Nullable Throwable th) {
        super(getCombinedMessage(i2, str), th);
        this.mReason = i2;
        this.mCameraAccessException = f759a.contains(Integer.valueOf(i2)) ? new CameraAccessException(i2, str, th) : null;
    }

    public CameraAccessExceptionCompat(int i2, @Nullable Throwable th) {
        super(getDefaultMessage(i2), th);
        this.mReason = i2;
        this.mCameraAccessException = f759a.contains(Integer.valueOf(i2)) ? new CameraAccessException(i2, null, th) : null;
    }
