...
public class OutputConfigurationCompatApi26Impl extends OutputConfigurationCompatApi24Impl {
    ...
    public static final class OutputConfigurationParamsApi26 {
        ...
        final OutputConfiguration f835a;
        @Nullable
        ...
        OutputConfigurationParamsApi26(@NonNull OutputConfiguration outputConfiguration) {
            this.f835a = outputConfiguration;
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof OutputConfigurationParamsApi26) {
                ...
                return Objects.equals(this.f835a, outputConfigurationParamsApi26.f835a) && Objects.equals(this.f836b, outputConfigurationParamsApi26.f836b);
            }
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @RequiresApi(26)
    public static OutputConfigurationCompatApi26Impl c(@NonNull OutputConfiguration outputConfiguration) {
    ...
    public Object getOutputConfiguration() {
        Preconditions.checkArgument(this.f837a instanceof OutputConfigurationParamsApi26);
        return ((OutputConfigurationParamsApi26) this.f837a).f835a;
    }

    @Override // androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatApi24Impl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompatBaseImpl, androidx.camera.camera2.internal.compat.params.OutputConfigurationCompat.OutputConfigurationCompatImpl
    @Nullable
    public String getPhysicalCameraId() {
        return ((OutputConfigurationParamsApi26) this.f837a).f836b;
    }
    ...
    public void setPhysicalCameraId(@Nullable String str) {
        ((OutputConfigurationParamsApi26) this.f837a).f836b = str;
    }
}
