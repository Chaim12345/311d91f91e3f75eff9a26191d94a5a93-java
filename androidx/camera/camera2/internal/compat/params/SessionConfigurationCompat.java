...
public final class SessionConfigurationCompat {
    ...
    private static final class SessionConfigurationCompatApi28Impl implements SessionConfigurationCompatImpl {
        ...
        SessionConfigurationCompatApi28Impl(int i2, @NonNull List list, @NonNull Executor executor, @NonNull CameraCaptureSession.StateCallback stateCallback) {
        ...
        SessionConfigurationCompatApi28Impl(@NonNull Object obj) {
            ...
            this.mOutputConfigurations = Collections.unmodifiableList(SessionConfigurationCompat.a(sessionConfiguration.getOutputConfigurations()));
        }
    ...
    private static final class SessionConfigurationCompatBaseImpl implements SessionConfigurationCompatImpl {
        ...
        SessionConfigurationCompatBaseImpl(int i2, @NonNull List list, @NonNull Executor executor, @NonNull CameraCaptureSession.StateCallback stateCallback) {
    ...
    public SessionConfigurationCompat(int i2, @NonNull List<OutputConfigurationCompat> list, @NonNull Executor executor, @NonNull CameraCaptureSession.StateCallback stateCallback) {
        this.mImpl = Build.VERSION.SDK_INT < 28 ? new SessionConfigurationCompatBaseImpl(i2, list, executor, stateCallback) : new SessionConfigurationCompatApi28Impl(i2, list, executor, stateCallback);
    }
    ...
    @RequiresApi(24)
    static List a(@NonNull List list) {
