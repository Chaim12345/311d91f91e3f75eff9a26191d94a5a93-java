...
public class OutputConfigurationCompatApi28Impl extends OutputConfigurationCompatApi26Impl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @RequiresApi(28)
    public static OutputConfigurationCompatApi28Impl d(@NonNull OutputConfiguration outputConfiguration) {
    ...
    public Object getOutputConfiguration() {
        Preconditions.checkArgument(this.f837a instanceof OutputConfiguration);
        return this.f837a;
    }
