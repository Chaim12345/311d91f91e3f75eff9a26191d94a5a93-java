...
final class Camera2SessionOptionUnpacker implements SessionConfig.OptionUnpacker {
    ...
    static final Camera2SessionOptionUnpacker f684a = new Camera2SessionOptionUnpacker();
    ...
    public void unpack(@NonNull UseCaseConfig<?> useCaseConfig, @NonNull SessionConfig.Builder builder) {
        ...
        builder.addCameraCaptureCallback(CaptureCallbackContainer.a(camera2ImplConfig.getSessionCaptureCallback(Camera2CaptureCallbacks.createNoOpCallback())));
