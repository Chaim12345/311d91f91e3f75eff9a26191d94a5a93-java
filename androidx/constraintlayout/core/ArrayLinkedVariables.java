...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f2, boolean z) {
        ...
        if (f2 <= (-f3) || f2 >= f3) {
            ...
            int i4 = -1;
            for (int i5 = 0; i2 != -1 && i5 < this.f1646a; i5++) {
            ...
            if (i8 >= iArr5.length && this.f1646a < iArr5.length) {
                int i10 = 0;
                while (true) {
    ...
    public final void clear() {
        int i2 = this.mHead;
        for (int i3 = 0; i2 != -1 && i3 < this.f1646a; i3++) {
            SolverVariable solverVariable = this.f1647b.f1656d[this.mArrayIndices[i2]];
    ...
    public SolverVariable getVariable(int i2) {
        int i3 = this.mHead;
        for (int i4 = 0; i3 != -1 && i4 < this.f1646a; i4++) {
            if (i4 == i2) {
                return this.f1647b.f1656d[this.mArrayIndices[i3]];
            }
    ...
    public final void put(SolverVariable solverVariable, float f2) {
        ...
        int[] iArr4 = this.mArrayIndices;
        if (i8 >= iArr4.length && this.f1646a < iArr4.length) {
            int i10 = 0;
            while (true) {
                int[] iArr5 = this.mArrayIndices;
                if (i10 >= iArr5.length) {
    ...
    public String toString() {
        ...
        String str = "";
        for (int i3 = 0; i2 != -1 && i3 < this.f1646a; i3++) {
            str = ((str + " -> ") + this.mArrayValues[i2] + " : ") + this.f1647b.f1656d[this.mArrayIndices[i2]];
            i2 = this.mArrayNextIndices[i2];
        }
        return str;
    }
