...
public class CustomAttribute {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f1686a[AttributeType.BOOLEAN_TYPE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1686a[AttributeType.STRING_TYPE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1686a[AttributeType.COLOR_TYPE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1686a[AttributeType.COLOR_DRAWABLE_TYPE.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1686a[AttributeType.INT_TYPE.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1686a[AttributeType.FLOAT_TYPE.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f1686a[AttributeType.DIMENSION_TYPE.ordinal()] = 8;
    ...
    public CustomAttribute(CustomAttribute customAttribute, Object obj) {
        this.mMethod = false;
        this.f1684a = customAttribute.f1684a;
    ...
    public static void setAttributes(Object obj, HashMap<String, CustomAttribute> hashMap) {
        ...
        for (String str : hashMap.keySet()) {
            ...
            try {
                switch (AnonymousClass1.f1686a[customAttribute.mType.ordinal()]) {
                    case 1:
                        cls.getMethod(str2, Integer.TYPE).invoke(obj, Integer.valueOf(customAttribute.mIntegerValue));
                        break;
                    case 2:
                        cls.getMethod(str2, Boolean.TYPE).invoke(obj, Boolean.valueOf(customAttribute.f1685b));
                        break;
                    case 3:
    ...
    public void applyCustom(Object obj) {
        ...
        try {
            switch (AnonymousClass1.f1686a[this.mType.ordinal()]) {
                case 1:
                case 6:
                    cls.getMethod(str, Integer.TYPE).invoke(obj, Integer.valueOf(this.mIntegerValue));
                    return;
                case 2:
                    cls.getMethod(str, Boolean.TYPE).invoke(obj, Boolean.valueOf(this.f1685b));
                    return;
                case 3:
    ...
    public boolean diff(CustomAttribute customAttribute) {
        ...
        switch (AnonymousClass1.f1686a[attributeType.ordinal()]) {
            case 1:
            case 6:
                return this.mIntegerValue == customAttribute.mIntegerValue;
            case 2:
                return this.f1685b == customAttribute.f1685b;
            case 3:
                return this.mIntegerValue == customAttribute.mIntegerValue;
            case 4:
            case 5:
    ...
    public boolean isContinuous() {
        int i2 = AnonymousClass1.f1686a[this.mType.ordinal()];
    ...
    public void setInterpolatedValue(Object obj, float[] fArr) {
        ...
        try {
            ...
            if (i2 == 2) {
                ...
                throw new RuntimeException("unable to interpolate strings " + this.f1684a);
            } else if (i2 == 4) {
    ...
    public void setValue(Object obj) {
        switch (AnonymousClass1.f1686a[this.mType.ordinal()]) {
            ...
            case 6:
                ...
                return;
            case 2:
                this.f1685b = ((Boolean) obj).booleanValue();
                return;
            case 3:
    ...
    public void setValue(float[] fArr) {
        ...
        switch (AnonymousClass1.f1686a[this.mType.ordinal()]) {
            ...
            case 6:
                ...
                return;
            case 2:
                this.f1685b = ((double) fArr[0]) > 0.5d;
                return;
            case 3:
                throw new RuntimeException("Color does not have a single color to interpolate");
            case 4:
