...
public class ImageFilterButton extends AppCompatImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            if (this.mAltDrawable == null || drawable == null) {
                ...
                if (drawable2 != null) {
                    Drawable[] drawableArr = this.f2188c;
            ...
            Drawable[] drawableArr2 = this.f2188c;
            Drawable mutate2 = getDrawable().mutate();
            this.mDrawable = mutate2;
            drawableArr2[0] = mutate2;
            this.f2188c[1] = this.mAltDrawable.mutate();
            LayerDrawable layerDrawable = new LayerDrawable(this.f2188c);
            this.f2189d = layerDrawable;
            layerDrawable.getDrawable(1).setAlpha((int) (this.mCrossfade * 255.0f));
            if (!this.mOverlay) {
                this.f2189d.getDrawable(0).setAlpha((int) ((1.0f - this.mCrossfade) * 255.0f));
            }
            super.setImageDrawable(this.f2189d);
        }
    }
    ...
    public void setCrossfade(float f2) {
        ...
        if (this.f2188c != null) {
            ...
            this.f2189d.getDrawable(1).setAlpha((int) (this.mCrossfade * 255.0f));
            super.setImageDrawable(this.f2189d);
        }
    }
        ...
        if (f2 != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.f2186a == null) {
                    ...
                    this.f2186a = viewOutlineProvider;
                    setOutlineProvider(viewOutlineProvider);
                }
                setClipToOutline(true);
            }
            this.f2187b.set(0.0f, 0.0f, getWidth(), getHeight());
            this.mPath.reset();
    ...
    public void setRoundPercent(float f2) {
        ...
        if (f2 != 0.0f) {
            ...
            this.f2187b.set(0.0f, 0.0f, width, height);
            this.mPath.reset();
            this.mPath.addRoundRect(this.f2187b, min, min, Path.Direction.CW);
        } else if (Build.VERSION.SDK_INT >= 21) {
            setClipToOutline(false);
        }
        if (!z || Build.VERSION.SDK_INT < 21) {
