...
public class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static /* synthetic */ String concatToString$default(char[] cArr, int i2, int i3, int i4, Object obj) {
        ...
        concatToString = concatToString(cArr, i2, i3);
    ...
    public static final boolean regionMatches(@NotNull CharSequence charSequence, int i2, @NotNull CharSequence other, int i3, int i4, boolean z) {
        ...
        if ((charSequence instanceof String) && (other instanceof String)) {
            regionMatches = regionMatches((String) charSequence, i2, (String) other, i3, i4, z);
            return regionMatches;
        }
        return StringsKt__StringsKt.regionMatchesImpl(charSequence, i2, other, i3, i4, z);
    }

    public static boolean regionMatches(@NotNull String str, int i2, @NotNull String other, int i3, int i4, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static /* synthetic */ boolean regionMatches$default(String str, int i2, String str2, int i3, int i4, boolean z, int i5, Object obj) {
        ...
        regionMatches = regionMatches(str, i2, str2, i3, i4, z);
        return regionMatches;
    }
    ...
    public static final String replace(@NotNull String str, @NotNull String oldValue, @NotNull String newValue, boolean z) {
        ...
        int i2 = 0;
        indexOf = StringsKt__StringsKt.indexOf(str, oldValue, 0, z);
        if (indexOf < 0) {
            return str;
        }
    ...
    public static boolean startsWith(@NotNull String str, @NotNull String prefix, int i2, boolean z) {
        boolean regionMatches;
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        if (z) {
            regionMatches = regionMatches(str, i2, prefix, 0, prefix.length(), z);
            return regionMatches;
        }
    ...
    public static /* synthetic */ boolean startsWith$default(String str, String str2, int i2, boolean z, int i3, Object obj) {
        ...
        startsWith = startsWith(str, str2, i2, z);
        return startsWith;
    }
