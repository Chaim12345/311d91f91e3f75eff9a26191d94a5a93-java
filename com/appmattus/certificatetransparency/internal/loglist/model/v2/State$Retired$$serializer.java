...
public final class State$Retired$$serializer implements GeneratedSerializer<State.Retired> {
    @NotNull
    ...
    @NotNull
    public State.Retired deserialize(@NotNull Decoder decoder) {
        long j2;
        ...
        return new State.Retired(i2, j2, null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull State.Retired value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        State.Retired.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
