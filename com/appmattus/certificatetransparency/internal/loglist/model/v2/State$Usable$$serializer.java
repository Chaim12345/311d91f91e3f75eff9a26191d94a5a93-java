...
public final class State$Usable$$serializer implements GeneratedSerializer<State.Usable> {
    @NotNull
    ...
    @NotNull
    public State.Usable deserialize(@NotNull Decoder decoder) {
        long j2;
        ...
        return new State.Usable(i2, j2, null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull State.Usable value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        State.Usable.write$Self(value, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
