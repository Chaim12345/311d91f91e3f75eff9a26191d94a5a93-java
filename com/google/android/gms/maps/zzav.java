...
public final class zzav extends DeferredLifecycleHelper<zzau> {
    ...
    protected OnDelegateCreatedListener f6649a;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void g(zzav zzavVar, Activity activity) {
    ...
    protected final void a(OnDelegateCreatedListener onDelegateCreatedListener) {
        this.f6649a = onDelegateCreatedListener;
        zzc();
    }
    ...
    public final void zzc() {
        if (this.zzc == null || this.f6649a == null || getDelegate() != null) {
            return;
        }
        try {
            ...
            this.f6649a.onDelegateCreated(new zzau(this.zzb, zzf));
