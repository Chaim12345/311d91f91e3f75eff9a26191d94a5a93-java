...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i2, @NonNull Activity activity, @Nullable Fragment fragment, int i3, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog a2 = googleApiAvailability.a(activity, i2, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i2, "d"), i3), onCancelListener);
        if (a2 == null) {
            return false;
        }
