...
public final class zan extends AbstractSafeParcelable {
    ...
    public zan(@SafeParcelable.Param(id = 1) int i2, @SafeParcelable.Param(id = 2) ArrayList arrayList, @SafeParcelable.Param(id = 3) String str) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            String str2 = zalVar.f5811b;
            HashMap hashMap2 = new HashMap();
            int size2 = ((ArrayList) Preconditions.checkNotNull(zalVar.f5812c)).size();
            for (int i4 = 0; i4 < size2; i4++) {
                zam zamVar = (zam) zalVar.f5812c.get(i4);
                hashMap2.put(zamVar.f5814b, zamVar.f5815c);
            }
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.writeInt(parcel, 1, this.f5816a);
