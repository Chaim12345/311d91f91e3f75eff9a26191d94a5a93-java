...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    /* renamed from: c */
    static final ThreadLocal f5626c = new zaq();
    public static final /* synthetic */ int zad = 0;
    @NonNull

    /* renamed from: a */
    protected final CallbackHandler f5627a;
    @NonNull

    /* renamed from: b */
    protected final WeakReference f5628b;
    @KeepName
    ...
    public BasePendingResult(@NonNull Looper looper) {
        ...
        this.zaq = false;
        this.f5627a = new CallbackHandler(looper);
    ...
    public BasePendingResult(@Nullable GoogleApiClient googleApiClient) {
        ...
        this.zai = new AtomicReference<>();
        this.zaq = false;
        this.f5627a = new CallbackHandler(googleApiClient != null ? googleApiClient.getLooper() : Looper.getMainLooper());
        this.f5628b = new WeakReference(googleApiClient);
    }
    ...
    private final R zaa() {
        ...
        if (andSet != null) {
            andSet.f5701a.f5702a.remove(this);
        }
    ...
    private final void zab(R r2) {
        ...
        if (this.zam) {
            ...
            if (resultCallback != null) {
                this.f5627a.removeMessages(2);
                this.f5627a.zaa(resultCallback, zaa());
    ...
    @NonNull
    @KeepForSdk
    public abstract Result createFailedResult(@NonNull Status status);
    ...
    public final void setResultCallback(@NonNull ResultCallback<? super R> resultCallback, long j2, @NonNull TimeUnit timeUnit) {
        synchronized (this.zae) {
            ...
            if (isReady()) {
                ...
                this.zah = resultCallback;
                CallbackHandler callbackHandler = this.f5627a;
    ...
    public final <S extends Result> TransformedResult<S> then(@NonNull ResultTransform<? super R, ? extends S> resultTransform) {
        ...
        synchronized (this.zae) {
            ...
            this.zaq = true;
            this.zap = new zada<>(this.f5628b);
            then = this.zap.then(resultTransform);
            if (isReady()) {
                this.f5627a.zaa(this.zap, zaa());
            } else {
                this.zah = this.zap;
            }
        }
    ...
    public final void zak() {
        boolean z = true;
        if (!this.zaq && !((Boolean) f5626c.get()).booleanValue()) {
            z = false;
        }
        this.zaq = z;
    }
    ...
    public final boolean zam() {
        boolean isCanceled;
        synchronized (this.zae) {
            if (((GoogleApiClient) this.f5628b.get()) == null || !this.zaq) {
                cancel();
            }
