...
public final class zabq<O extends Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    /* renamed from: a */
    final /* synthetic */ GoogleApiManager f5682a;
    @NotOnlyInitialized
    ...
    public static /* bridge */ /* synthetic */ ApiKey c(zabq zabqVar) {
        return zabqVar.zad;
    }

    public static /* bridge */ /* synthetic */ void d(zabq zabqVar, Status status) {
        zabqVar.zaD(status);
    }

    public static /* bridge */ /* synthetic */ void g(zabq zabqVar, zabs zabsVar) {
    ...
    public static /* bridge */ /* synthetic */ void h(zabq zabqVar, zabs zabsVar) {
        Handler handler;
        Handler handler2;
        Feature feature;
        Feature[] zab;
        if (zabqVar.zak.remove(zabsVar)) {
            handler = zabqVar.f5682a.zat;
            handler.removeMessages(15, zabsVar);
            handler2 = zabqVar.f5682a.zat;
    ...
    public static /* bridge */ /* synthetic */ boolean j(zabq zabqVar, boolean z) {
    ...
    public final void zaG() {
        ...
        while (it.hasNext()) {
            ...
            if (zaB(next.zaa.getRequiredFeatures()) == null) {
                try {
                    next.zaa.a(this.zac, new TaskCompletionSource());
    ...
    private final boolean zaL(zai zaiVar) {
        ...
        GoogleApiManager googleApiManager3 = this.f5682a;
        ...
        this.f5682a.d(connectionResult, this.zah);
        return false;
    }
    ...
    public final void zar(@NonNull ConnectionResult connectionResult, @Nullable Exception exc) {
        ...
        if ((this.zac instanceof com.google.android.gms.common.internal.service.zap) && connectionResult.getErrorCode() != 24) {
            this.f5682a.zah = true;
            GoogleApiManager googleApiManager = this.f5682a;
            handler5 = googleApiManager.zat;
            handler6 = googleApiManager.zat;
            handler5.sendMessageDelayed(handler6.obtainMessage(19), LocationUtility.UPDATE_INTERVAL_IN_MILLISECONDS);
        }
        if (connectionResult.getErrorCode() == 4) {
            ...
            zaE(zaH2, null, true);
            if (this.zab.isEmpty() || zaM(connectionResult) || this.f5682a.d(connectionResult, this.zah)) {
                return;
            }
