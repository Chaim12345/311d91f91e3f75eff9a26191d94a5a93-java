...
public class GoogleApiManager implements Handler.Callback {
    ...
    public final boolean handleMessage(@NonNull Message message) {
        ...
        ApiKey apiKey4;
        int i2 = message.what;
        long j2 = LocationUtility.UPDATE_INTERVAL_IN_MILLISECONDS;
        switch (i2) {
            case 1:
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        ...
                        zabq.d(zabqVar, new Status(17, sb.toString()));
                        break;
                    } else {
                        zabq.d(zabqVar, zaH(zabq.c(zabqVar), connectionResult));
                        break;
                    }
                } else {
            ...
            case 6:
                if (this.zak.getApplicationContext() instanceof Application) {
                    ...
                    if (!BackgroundDetector.getInstance().readCurrentStateIfPossible(true)) {
                        this.zag = LocationUtility.UPDATE_INTERVAL_IN_MILLISECONDS;
                        break;
                    }
                }
                break;
            ...
            case 14:
                ...
                if (this.zap.containsKey(zaa2)) {
                    boolean j3 = zabq.j(this.zap.get(zaa2), false);
                    zab2 = zaafVar.zab();
                    valueOf = Boolean.valueOf(j3);
                } else {
                    zab2 = zaafVar.zab();
            ...
            case 15:
                ...
                if (map.containsKey(apiKey)) {
                    ...
                    apiKey2 = zabsVar.zaa;
                    zabq.g(map2.get(apiKey2), zabsVar);
                    break;
                }
                break;
            case 16:
                ...
                if (map3.containsKey(apiKey3)) {
                    ...
                    zabq.h(map4.get(apiKey4), zabsVar2);
                    break;
                }
                break;
            case 17:
            ...
            case 18:
                ...
                if (zaceVar.f5689c == 0) {
                    zaJ().log(new TelemetryData(zaceVar.f5688b, Arrays.asList(zaceVar.f5687a)));
                    break;
                } else {
                    TelemetryData telemetryData = this.zai;
                    if (telemetryData != null) {
                        List<MethodInvocation> zab3 = telemetryData.zab();
                        if (telemetryData.zaa() != zaceVar.f5688b || (zab3 != null && zab3.size() >= zaceVar.f5690d)) {
                            this.zat.removeMessages(17);
                            zaK();
                        } else {
                            this.zai.zac(zaceVar.f5687a);
                        }
                    }
                    if (this.zai == null) {
                        ArrayList arrayList = new ArrayList();
                        arrayList.add(zaceVar.f5687a);
                        this.zai = new TelemetryData(zaceVar.f5688b, arrayList);
                        Handler handler2 = this.zat;
                        handler2.sendMessageDelayed(handler2.obtainMessage(17), zaceVar.f5689c);
                        break;
                    }
                }
                break;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Nullable
    public final zabq n(ApiKey apiKey) {
