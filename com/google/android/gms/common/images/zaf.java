...
public final class zaf extends zag {
    ...
    public final void a(@Nullable Drawable drawable, boolean z, boolean z2, boolean z3) {
        ...
        onImageLoadedListener.onImageLoaded(this.f5742a.zaa, drawable, z3);
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof zaf) {
            ...
            return onImageLoadedListener2 != null && onImageLoadedListener != null && Objects.equal(onImageLoadedListener2, onImageLoadedListener) && Objects.equal(zafVar.f5742a, this.f5742a);
        }
        return false;
    }

    public final int hashCode() {
        return Objects.hashCode(this.f5742a);
    }
}
