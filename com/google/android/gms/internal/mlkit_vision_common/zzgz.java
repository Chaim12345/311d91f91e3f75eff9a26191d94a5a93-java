...
public enum zzgz implements zzaf {
    ...
    ON_DEVICE_SMART_REPLY_DETECT(CipherSuite.TLS_DH_DSS_WITH_SEED_CBC_SHA),
    ON_DEVICE_SMART_REPLY_CREATE(CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA),
    ON_DEVICE_SMART_REPLY_CLOSE(CipherSuite.TLS_DHE_DSS_WITH_SEED_CBC_SHA),
    ...
    ACCELERATION_ANALYTICS(NamedGroup.ffdhe8192),
