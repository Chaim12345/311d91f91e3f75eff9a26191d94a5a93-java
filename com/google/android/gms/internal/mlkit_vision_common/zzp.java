...
public abstract class zzp extends zzl implements List, RandomAccess {
    private static final zzab zza = new zzn(zzt.f6580b, 0);

    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzp e(Object[] objArr) {
        return f(objArr, objArr.length);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzp f(Object[] objArr, int i2) {
        return i2 == 0 ? zzt.f6580b : new zzt(objArr, i2);
    }
    ...
    public zzp subList(int i2, int i3) {
        zzf.zzc(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? zzt.f6580b : new zzo(this, i2, i4);
    }

    @Override // java.util.List
    /* renamed from: zzj */
    public final zzab listIterator(int i2) {
