...
public final class zzaj implements ObjectEncoderContext {
    ...
    private final zzaj zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    private final zzaj zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzaj d(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z) {
        if (z && i2 == 0) {
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzaj e(@NonNull FieldDescriptor fieldDescriptor, long j2, boolean z) {
        if (z && j2 == 0) {
            return this;
        }
        zzah zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzaj f(@Nullable Object obj) {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
