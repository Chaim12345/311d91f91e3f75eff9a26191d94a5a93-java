...
public final class zzbr {
    public static int zza(int i2, int i3, String str) {
        ...
        if (i2 < 0 || i2 >= i3) {
            if (i2 < 0) {
                zza = zzbs.zza("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2));
            } else if (i3 < 0) {
                ...
                zza = zzbs.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i2), Integer.valueOf(i3));
            }
