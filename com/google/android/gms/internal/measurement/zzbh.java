...
public final class zzbh extends zzaw {
    ...
    public zzbh() {
        this.f5933a.add(zzbl.FOR_IN);
        this.f5933a.add(zzbl.FOR_IN_CONST);
        this.f5933a.add(zzbl.FOR_IN_LET);
        this.f5933a.add(zzbl.FOR_LET);
        this.f5933a.add(zzbl.FOR_OF);
        this.f5933a.add(zzbl.FOR_OF_CONST);
        this.f5933a.add(zzbl.FOR_OF_LET);
        this.f5933a.add(zzbl.WHILE);
    }
