...
public final class zzay extends zzaw {
    public zzay() {
        this.f5933a.add(zzbl.EQUALS);
        this.f5933a.add(zzbl.GREATER_THAN);
        this.f5933a.add(zzbl.GREATER_THAN_EQUALS);
        this.f5933a.add(zzbl.IDENTITY_EQUALS);
        this.f5933a.add(zzbl.IDENTITY_NOT_EQUALS);
        this.f5933a.add(zzbl.LESS_THAN);
        this.f5933a.add(zzbl.LESS_THAN_EQUALS);
        this.f5933a.add(zzbl.NOT_EQUALS);
    }
    ...
    private static boolean zzd(zzap zzapVar, zzap zzapVar2) {
        ...
        return (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || (doubleValue == 0.0d && doubleValue2 == 0.0d) || ((i2 == 0 && doubleValue2 == 0.0d) || Double.compare(doubleValue, doubleValue2) >= 0)) ? false : true;
    }
