...
public final class zzbk extends zzaw {
    ...
    public zzbk() {
        this.f5933a.add(zzbl.ASSIGN);
        this.f5933a.add(zzbl.CONST);
        this.f5933a.add(zzbl.CREATE_ARRAY);
        this.f5933a.add(zzbl.CREATE_OBJECT);
        this.f5933a.add(zzbl.EXPRESSION_LIST);
        this.f5933a.add(zzbl.GET);
        this.f5933a.add(zzbl.GET_INDEX);
        this.f5933a.add(zzbl.GET_PROPERTY);
        this.f5933a.add(zzbl.NULL);
        this.f5933a.add(zzbl.SET_PROPERTY);
        this.f5933a.add(zzbl.TYPEOF);
        this.f5933a.add(zzbl.UNDEFINED);
        this.f5933a.add(zzbl.VAR);
    }
