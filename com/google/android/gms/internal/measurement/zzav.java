...
public final class zzav extends zzaw {
    public zzav() {
        this.f5933a.add(zzbl.BITWISE_AND);
        this.f5933a.add(zzbl.BITWISE_LEFT_SHIFT);
        this.f5933a.add(zzbl.BITWISE_NOT);
        this.f5933a.add(zzbl.BITWISE_OR);
        this.f5933a.add(zzbl.BITWISE_RIGHT_SHIFT);
        this.f5933a.add(zzbl.BITWISE_UNSIGNED_RIGHT_SHIFT);
        this.f5933a.add(zzbl.BITWISE_XOR);
    }
