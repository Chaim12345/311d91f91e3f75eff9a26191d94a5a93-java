...
public final class zzae implements SafetyNetApi {
    ...
    public static PendingResult<SafetyNetApi.SafeBrowsingResult> zzb(GoogleApiClient googleApiClient, String str, int i2, String str2, int... iArr) {
        if (iArr.length != 0) {
            if (TextUtils.isEmpty(str)) {
                throw new IllegalArgumentException("Null or empty uri in lookupUri");
            }
            return googleApiClient.enqueue(new zzk(googleApiClient, iArr, i2, str, str2));
        }
