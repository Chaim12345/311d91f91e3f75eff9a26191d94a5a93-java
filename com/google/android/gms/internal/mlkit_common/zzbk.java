...
public final class zzbk implements ObjectEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzbk(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzbi zzbiVar = (zzbi) fieldDescriptor.getProperty(zzbi.class);
        if (zzbiVar != null) {
            return zzbiVar.zza();
        }
    ...
    private static zzbi zzj(FieldDescriptor fieldDescriptor) {
        zzbi zzbiVar = (zzbi) fieldDescriptor.getProperty(zzbi.class);
        if (zzbiVar != null) {
            return zzbiVar;
        }
    ...
    private final zzbk zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    private final zzbk zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) {
    ...
    public final ObjectEncoderContext c(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj, boolean z) {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                d(fieldDescriptor, ((zzbg) obj).zza(), true);
                return this;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbk d(@NonNull FieldDescriptor fieldDescriptor, int i2, boolean z) {
        if (z && i2 == 0) {
            return this;
        }
        zzbi zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbk e(@NonNull FieldDescriptor fieldDescriptor, long j2, boolean z) {
        if (z && j2 == 0) {
            return this;
        }
        zzbi zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbk f(@Nullable Object obj) {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
