...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder<AndroidClientInfo> {
        ...
        static final AndroidClientInfoEncoder f5489a = new AndroidClientInfoEncoder();
        ...
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.of(CarContext.HARDWARE_SERVICE);
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder<BatchedLogRequest> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final BatchedLogRequestEncoder f5490a = new BatchedLogRequestEncoder();
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder<ClientInfo> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final ClientInfoEncoder f5491a = new ClientInfoEncoder();
    ...
    private static final class LogEventEncoder implements ObjectEncoder<LogEvent> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final LogEventEncoder f5492a = new LogEventEncoder();
    ...
    private static final class LogRequestEncoder implements ObjectEncoder<LogRequest> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final LogRequestEncoder f5493a = new LogRequestEncoder();
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder<NetworkConnectionInfo> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final NetworkConnectionInfoEncoder f5494a = new NetworkConnectionInfoEncoder();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        BatchedLogRequestEncoder batchedLogRequestEncoder = BatchedLogRequestEncoder.f5490a;
        ...
        LogRequestEncoder logRequestEncoder = LogRequestEncoder.f5493a;
        ...
        ClientInfoEncoder clientInfoEncoder = ClientInfoEncoder.f5491a;
        ...
        AndroidClientInfoEncoder androidClientInfoEncoder = AndroidClientInfoEncoder.f5489a;
        ...
        LogEventEncoder logEventEncoder = LogEventEncoder.f5492a;
        ...
        NetworkConnectionInfoEncoder networkConnectionInfoEncoder = NetworkConnectionInfoEncoder.f5494a;
