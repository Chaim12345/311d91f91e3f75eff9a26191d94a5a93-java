...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    */
    public ShapeableImageView(Context context, @Nullable AttributeSet attributeSet, int i2) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, i2, r0), attributeSet, i2);
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i2, i3);
