...
public final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    private static final Property<LinearIndeterminateContiguousAnimatorDelegate, Float> ANIMATION_FRACTION = new Property<LinearIndeterminateContiguousAnimatorDelegate, Float>(Float.class, "animationFraction") { // from class: com.google.android.material.progressindicator.LinearIndeterminateContiguousAnimatorDelegate.2
        ...
        public void set(LinearIndeterminateContiguousAnimatorDelegate linearIndeterminateContiguousAnimatorDelegate, Float f2) {
            linearIndeterminateContiguousAnimatorDelegate.i(f2.floatValue());
        }
    };
    ...
    private void maybeUpdateSegmentColors() {
        if (!this.dirtyColors || this.f7431b[3] >= 1.0f) {
            return;
        }
        int[] iArr = this.f7432c;
        iArr[2] = iArr[1];
        iArr[1] = iArr[0];
        iArr[0] = MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[this.newIndicatorColorIndex], this.f7430a.getAlpha());
    ...
    void h() {
        ...
        this.newIndicatorColorIndex = 1;
        Arrays.fill(this.f7432c, MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[0], this.f7430a.getAlpha()));
    }
