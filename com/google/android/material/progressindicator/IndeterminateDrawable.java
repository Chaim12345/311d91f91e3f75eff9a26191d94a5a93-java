...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    IndeterminateDrawable(@NonNull Context context, @NonNull BaseProgressIndicatorSpec baseProgressIndicatorSpec, @NonNull DrawingDelegate drawingDelegate, @NonNull IndeterminateAnimatorDelegate indeterminateAnimatorDelegate) {
        super(context, baseProgressIndicatorSpec);
        j(drawingDelegate);
        i(indeterminateAnimatorDelegate);
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.save();
        this.drawingDelegate.c(canvas, d());
        this.drawingDelegate.a(canvas, this.f7425d);
        int i2 = 0;
        while (true) {
            IndeterminateAnimatorDelegate<ObjectAnimator> indeterminateAnimatorDelegate = this.animatorDelegate;
            int[] iArr = indeterminateAnimatorDelegate.f7432c;
            if (i2 >= iArr.length) {
                canvas.restore();
                return;
            }
            DrawingDelegate<S> drawingDelegate = this.drawingDelegate;
            Paint paint = this.f7425d;
            float[] fArr = indeterminateAnimatorDelegate.f7431b;
            int i3 = i2 * 2;
    ...
    public boolean f(boolean z, boolean z2, boolean z3) {
        ...
        float systemAnimatorDurationScale = this.f7424c.getSystemAnimatorDurationScale(this.f7422a.getContentResolver());
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @NonNull
    public IndeterminateAnimatorDelegate g() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void i(@NonNull IndeterminateAnimatorDelegate indeterminateAnimatorDelegate) {
    ...
    void j(@NonNull DrawingDelegate drawingDelegate) {
