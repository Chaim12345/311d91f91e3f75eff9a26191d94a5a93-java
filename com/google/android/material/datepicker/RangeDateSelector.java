...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) {
        ...
        SimpleDateFormat h2 = UtcDates.h();
        Long l2 = this.selectedStartItem;
        if (l2 != null) {
        ...
        String i2 = UtcDates.i(inflate.getResources(), h2);
        textInputLayout.setPlaceholderText(i2);
        textInputLayout2.setPlaceholderText(i2);
        editText.addTextChangedListener(new DateFormatTextWatcher(i2, h2, textInputLayout, calendarConstraints) { // from class: com.google.android.material.datepicker.RangeDateSelector.1
        ...
        editText2.addTextChangedListener(new DateFormatTextWatcher(i2, h2, textInputLayout2, calendarConstraints) { // from class: com.google.android.material.datepicker.RangeDateSelector.2
            @Override // com.google.android.material.datepicker.DateFormatTextWatcher
            void d() {
    ...
    public void setSelection(@NonNull Pair<Long, Long> pair) {
        ...
        Long l3 = pair.first;
        this.selectedStartItem = l3 == null ? null : Long.valueOf(UtcDates.a(l3.longValue()));
        Long l4 = pair.second;
        this.selectedEndItem = l4 != null ? Long.valueOf(UtcDates.a(l4.longValue())) : null;
    }
