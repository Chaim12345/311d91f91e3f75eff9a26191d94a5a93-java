...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        return resources.getString(R.string.mtrl_picker_date_header_selected, DateStrings.j(l2.longValue()));
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        ...
        editText.addTextChangedListener(new DateFormatTextWatcher(i2, h2, textInputLayout, calendarConstraints) { // from class: com.google.android.material.datepicker.SingleDateSelector.1
    ...
    public void setSelection(@Nullable Long l2) {
        this.selectedItem = l2 == null ? null : Long.valueOf(UtcDates.a(l2.longValue()));
    }
