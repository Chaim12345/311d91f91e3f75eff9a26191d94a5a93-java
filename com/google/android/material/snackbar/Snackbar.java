...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setAction(@Nullable CharSequence charSequence, @Nullable final View.OnClickListener onClickListener) {
        Button actionView = ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getActionView();
    ...
    public Snackbar setActionTextColor(@ColorInt int i2) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getActionView().setTextColor(i2);
        return this;
    }

    @NonNull
    public Snackbar setActionTextColor(ColorStateList colorStateList) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getActionView().setTextColor(colorStateList);
        return this;
    }
    ...
    public Snackbar setBackgroundTintList(@Nullable ColorStateList colorStateList) {
        this.f7491a.setBackgroundTintList(colorStateList);
        return this;
    }

    @NonNull
    public Snackbar setBackgroundTintMode(@Nullable PorterDuff.Mode mode) {
        this.f7491a.setBackgroundTintMode(mode);
        return this;
    }
    ...
    public Snackbar setMaxInlineActionWidth(@Dimension int i2) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).setMaxInlineActionWidth(i2);
        return this;
    }
    ...
    public Snackbar setText(@NonNull CharSequence charSequence) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getMessageView().setText(charSequence);
        return this;
    }

    @NonNull
    public Snackbar setTextColor(@ColorInt int i2) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getMessageView().setTextColor(i2);
        return this;
    }

    @NonNull
    public Snackbar setTextColor(ColorStateList colorStateList) {
        ((SnackbarContentLayout) this.f7491a.getChildAt(0)).getMessageView().setTextColor(colorStateList);
        return this;
    }
