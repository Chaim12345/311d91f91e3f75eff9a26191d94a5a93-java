...
public class MaterialComponentsViewInflater extends AppCompatViewInflater {
    ...
    @NonNull
    protected AppCompatAutoCompleteTextView a(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        return new MaterialAutoCompleteTextView(context, attributeSet);
    }

    @Override // androidx.appcompat.app.AppCompatViewInflater
    @NonNull
    protected AppCompatButton b(@NonNull Context context, @NonNull AttributeSet attributeSet) {
