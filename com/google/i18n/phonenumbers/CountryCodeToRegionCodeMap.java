...
public class CountryCodeToRegionCodeMap {
    ...
    public static Map a() {
        ...
        arrayList41.add(AppConstants.GEO_FENCE_TRANSITION_IN);
        ...
        arrayList56.add("GN");
        hashMap.put(Integer.valueOf((int) BERTags.FLAGS), arrayList56);
        ...
        arrayList63.add("LR");
        hashMap.put(Integer.valueOf((int) AddCarActivity.REQ_BARCODE_SCAN), arrayList63);
        ...
        arrayList90.add("MZ");
        hashMap.put(Integer.valueOf((int) NamedGroup.ffdhe4096), arrayList90);
        ArrayList arrayList91 = new ArrayList(1);
        arrayList91.add("ZM");
        hashMap.put(Integer.valueOf((int) NamedGroup.ffdhe8192), arrayList91);
        ...
        arrayList95.add(AppConstants.SECONDARY_USER_STATE_NA);
        ...
        arrayList106.add("GI");
        hashMap.put(Integer.valueOf((int) AbsAnimation.DEFAULT_ANIMATION_TIME), arrayList106);
        ...
        arrayList141.add("CR");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_PERCENT_X), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("PA");
        hashMap.put(507, arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PM");
        hashMap.put(Integer.valueOf((int) TypedValues.Position.TYPE_CURVE_FIT), arrayList143);
        ...
        arrayList162.add("VU");
        hashMap.put(Integer.valueOf((int) AppConstants.REQ_TRIP_SPINNER_SELECTION), arrayList162);
