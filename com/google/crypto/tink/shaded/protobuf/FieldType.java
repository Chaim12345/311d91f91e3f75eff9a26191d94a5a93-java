...
public final class FieldType {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f9748b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9748b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f9747a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9747a[Collection.SCALAR.ordinal()] = 3;
    ...
    private FieldType(String str, int i2, int i3, Collection collection, JavaType javaType) {
        ...
        int i5 = AnonymousClass1.f9747a[collection.ordinal()];
        boolean z = true;
        this.elementType = (i5 == 1 || i5 == 2) ? javaType.getBoxedType() : null;
        this.primitiveScalar = (collection != Collection.SCALAR || (i4 = AnonymousClass1.f9748b[javaType.ordinal()]) == 1 || i4 == 2 || i4 == 3) ? false : z;
    }
