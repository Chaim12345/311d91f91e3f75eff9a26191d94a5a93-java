...
public final class PemKeyType {
    ...
    private PemKeyType(String str, int i2, String str2, String str3, int i3, Enums.HashType hashType) {
        this.keyType = str2;
        this.algorithm = str3;
    ...
    private Key validate(Key key) {
        if (this.keyType.equals("RSA")) {
            ...
            int c2 = EllipticCurves.c(params.getCurve());
            if (c2 != this.keySizeInBits) {
                throw new GeneralSecurityException(String.format("invalid EC key size, want %d got %d", Integer.valueOf(this.keySizeInBits), Integer.valueOf(c2)));
            }
        }
        return key;
    }
