...
public abstract class UnicodeEscaper extends Escaper {
    ...
    protected static int a(CharSequence charSequence, int i2, int i3) {
        ...
        if (i2 < i3) {
            ...
            if (charAt > 56319) {
                ...
                throw new IllegalArgumentException("Expected low surrogate but got char '" + charAt2 + "' with value " + ((int) charAt2) + " at index " + i4 + " in '" + ((Object) charSequence) + "'");
            }
        }
    ...
    protected int d(CharSequence charSequence, int i2, int i3) {
        while (i2 < i3) {
            int a2 = a(charSequence, i2, i3);
            if (a2 < 0 || b(a2) != null) {
                break;
            }
            i2 += Character.isSupplementaryCodePoint(a2) ? 2 : 1;
        }
        return i2;
    }
    ...
    public String escape(String str) {
        ...
        int length = str.length();
        int d2 = d(str, 0, length);
        return d2 == length ? str : c(str, d2);
    }
}
