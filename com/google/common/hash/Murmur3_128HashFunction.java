...
public final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    static final HashFunction f9241a = new Murmur3_128HashFunction(0);

    /* renamed from: b  reason: collision with root package name */
    static final HashFunction f9242b = new Murmur3_128HashFunction(Hashing.f9235a);
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        protected HashCode a() {
            ...
            this.h1 = j6;
            this.h2 = fmix64 + j6;
            return HashCode.b(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.h1).putLong(this.h2).array());
        }
