...
public final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    static final HashFunction f9243a = new Murmur3_32HashFunction(0);

    /* renamed from: b  reason: collision with root package name */
    static final HashFunction f9244b = new Murmur3_32HashFunction(Hashing.f9235a);
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i2, long j2) {
            ...
            this.length += i2;
            if (i4 >= 32) {
                this.h1 = Murmur3_32HashFunction.mixH1(this.h1, Murmur3_32HashFunction.mixK1((int) j5));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
            ...
            if (Charsets.UTF_8.equals(charset)) {
                ...
                while (i3 < length) {
                    ...
                    if (charAt5 < 128) {
                        ...
                        update(i2, charToThreeUtf8Bytes);
                    }
                    i3++;
                }
                return this;
