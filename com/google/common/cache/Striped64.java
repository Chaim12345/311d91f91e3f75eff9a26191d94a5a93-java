...
abstract class Striped64 extends Number {
    ...
    static final ThreadLocal f8359d = new ThreadLocal();

    /* renamed from: e  reason: collision with root package name */
    static final Random f8360e = new Random();

    /* renamed from: f  reason: collision with root package name */
    static final int f8361f = Runtime.getRuntime().availableProcessors();
    @NullableDecl

    /* renamed from: a  reason: collision with root package name */
    volatile transient Cell[] f8362a;

    /* renamed from: b  reason: collision with root package name */
    volatile transient long f8363b;

    /* renamed from: c  reason: collision with root package name */
    volatile transient int f8364c;
    ...
    */
    public final void f(long j2, int[] iArr, boolean z) {
        int i2;
        int[] iArr2;
        boolean z2;
        int length;
        ...
        while (true) {
            ...
            if (cellArr != null && (length = cellArr.length) > 0) {
                ...
                if (cell == null) {
                    ...
                    if (length < f8361f && this.f8362a == cellArr) {
                        if (!z4) {
                            z4 = true;
                        } else if (this.f8364c == 0 && c()) {
                            try {
                                if (this.f8362a == cellArr) {
                                    Cell[] cellArr3 = new Cell[length << 1];
                                    for (int i5 = 0; i5 < length; i5++) {
                                        cellArr3[i5] = cellArr[i5];
                                    }
                                    this.f8362a = cellArr3;
                                }
                                this.f8364c = 0;
                                z4 = false;
                            } finally {
                ...
                i3 = i7 ^ (i7 << 5);
                iArr2[0] = i3;
            } else if (this.f8364c == 0 && this.f8362a == cellArr && c()) {
                try {
                    if (this.f8362a == cellArr) {
                        Cell[] cellArr4 = new Cell[2];
                        cellArr4[i3 & 1] = new Cell(j2);
                        this.f8362a = cellArr4;
                        z2 = true;
                    } else {
                        z2 = false;
                    }
