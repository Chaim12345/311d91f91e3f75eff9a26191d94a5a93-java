...
public final class Iterables {
    ...
    @NullableDecl
    public static Object a(Iterable iterable, Predicate predicate) {
    ...
    public static <T> boolean addAll(Collection<T> collection, Iterable<? extends T> iterable) {
        return iterable instanceof Collection ? collection.addAll(Collections2.b(iterable)) : Iterators.addAll(collection, ((Iterable) Preconditions.checkNotNull(iterable)).iterator());
    }
    ...
    public static boolean contains(Iterable<?> iterable, @NullableDecl Object obj) {
        return iterable instanceof Collection ? Collections2.e((Collection) iterable, obj) : Iterators.contains(iterable.iterator(), obj);
    }
    ...
    public static <T> Iterable<T> mergeSorted(final Iterable<? extends Iterable<? extends T>> iterable, final Comparator<? super T> comparator) {
        ...
        return new UnmodifiableIterable(new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.9
            @Override // java.lang.Iterable
            public Iterator<T> iterator() {
                return Iterators.mergeSorted(Iterables.transform(iterable, Iterables.d()), comparator);
            }
        });
    }
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.Iterables.6
            ...
            public Iterator<T> iterator() {
                ...
                return new Iterator<T>(this) { // from class: com.google.common.collect.Iterables.6.1
                    ...
                    @Override // java.util.Iterator
                    public void remove() {
                        CollectPreconditions.e(!this.f8640a);
                        it.remove();
                    }
                };
            }
    ...
    public static <T> T[] toArray(Iterable<? extends T> iterable, Class<T> cls) {
        return (T[]) c(iterable, ObjectArrays.newArray(cls, 0));
    }
