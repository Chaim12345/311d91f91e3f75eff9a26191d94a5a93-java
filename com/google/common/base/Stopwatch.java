...
public final class Stopwatch {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f8180a[TimeUnit.MICROSECONDS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f8180a[TimeUnit.MILLISECONDS.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f8180a[TimeUnit.SECONDS.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f8180a[TimeUnit.MINUTES.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f8180a[TimeUnit.HOURS.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f8180a[TimeUnit.DAYS.ordinal()] = 7;
    ...
    private static String abbreviate(TimeUnit timeUnit) {
        switch (AnonymousClass1.f8180a[timeUnit.ordinal()]) {
            case 1:
                return "ns";
            case 2:
                return "μs";
    ...
    public String toString() {
        ...
        return Platform.c(convert) + " " + abbreviate(chooseUnit);
    }
}
