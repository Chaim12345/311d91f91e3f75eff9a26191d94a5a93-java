...
public class ProtobufEncoder {
    ...
    public static final class Builder implements EncoderConfig<Builder> {
        private static final ObjectEncoder<Object> DEFAULT_FALLBACK_ENCODER = b.f10036a;
    ...
    public void encode(@NonNull Object obj, @NonNull OutputStream outputStream) {
        new ProtobufDataEncoderContext(outputStream, this.objectEncoders, this.valueEncoders, this.fallbackEncoder).h(obj);
    }
