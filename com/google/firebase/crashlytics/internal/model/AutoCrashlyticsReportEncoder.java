...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        static final CrashlyticsReportApplicationExitInfoEncoder f9996a = new CrashlyticsReportApplicationExitInfoEncoder();
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportCustomAttributeEncoder f9997a = new CrashlyticsReportCustomAttributeEncoder();
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportEncoder f9998a = new CrashlyticsReportEncoder();
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportFilesPayloadEncoder f9999a = new CrashlyticsReportFilesPayloadEncoder();
    ...
    private static final class CrashlyticsReportFilesPayloadFileEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload.File> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportFilesPayloadFileEncoder f10000a = new CrashlyticsReportFilesPayloadFileEncoder();
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionApplicationEncoder f10001a = new CrashlyticsReportSessionApplicationEncoder();
    ...
    private static final class CrashlyticsReportSessionApplicationOrganizationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application.Organization> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionApplicationOrganizationEncoder f10002a = new CrashlyticsReportSessionApplicationOrganizationEncoder();
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionDeviceEncoder f10003a = new CrashlyticsReportSessionDeviceEncoder();
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEncoder f10004a = new CrashlyticsReportSessionEncoder();
        ...
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.of(CarContext.APP_SERVICE);
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationEncoder f10005a = new CrashlyticsReportSessionEventApplicationEncoder();
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder f10006a = new CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder();
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionEncoder f10007a = new CrashlyticsReportSessionEventApplicationExecutionEncoder();
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder f10008a = new CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder();
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionSignalEncoder f10009a = new CrashlyticsReportSessionEventApplicationExecutionSignalEncoder();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.of(AppMeasurementSdk.ConditionalUserProperty.NAME);
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionThreadEncoder f10010a = new CrashlyticsReportSessionEventApplicationExecutionThreadEncoder();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.of(AppMeasurementSdk.ConditionalUserProperty.NAME);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.of("importance");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.of("frames");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder f10011a = new CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder();
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventDeviceEncoder f10012a = new CrashlyticsReportSessionEventDeviceEncoder();
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventEncoder f10013a = new CrashlyticsReportSessionEventEncoder();
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.of("timestamp");
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.of("type");
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.of(CarContext.APP_SERVICE);
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.of("device");
    ...
    private static final class CrashlyticsReportSessionEventLogEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Log> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionEventLogEncoder f10014a = new CrashlyticsReportSessionEventLogEncoder();
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionOperatingSystemEncoder f10015a = new CrashlyticsReportSessionOperatingSystemEncoder();
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.of("platform");
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.of(ClientCookie.VERSION_ATTR);
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.of("buildVersion");
    ...
    private static final class CrashlyticsReportSessionUserEncoder implements ObjectEncoder<CrashlyticsReport.Session.User> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final CrashlyticsReportSessionUserEncoder f10016a = new CrashlyticsReportSessionUserEncoder();
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.of("identifier");
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        CrashlyticsReportEncoder crashlyticsReportEncoder = CrashlyticsReportEncoder.f9998a;
        ...
        CrashlyticsReportSessionEncoder crashlyticsReportSessionEncoder = CrashlyticsReportSessionEncoder.f10004a;
        ...
        CrashlyticsReportSessionApplicationEncoder crashlyticsReportSessionApplicationEncoder = CrashlyticsReportSessionApplicationEncoder.f10001a;
        ...
        CrashlyticsReportSessionApplicationOrganizationEncoder crashlyticsReportSessionApplicationOrganizationEncoder = CrashlyticsReportSessionApplicationOrganizationEncoder.f10002a;
        ...
        CrashlyticsReportSessionUserEncoder crashlyticsReportSessionUserEncoder = CrashlyticsReportSessionUserEncoder.f10016a;
        ...
        CrashlyticsReportSessionOperatingSystemEncoder crashlyticsReportSessionOperatingSystemEncoder = CrashlyticsReportSessionOperatingSystemEncoder.f10015a;
        ...
        CrashlyticsReportSessionDeviceEncoder crashlyticsReportSessionDeviceEncoder = CrashlyticsReportSessionDeviceEncoder.f10003a;
        ...
        CrashlyticsReportSessionEventEncoder crashlyticsReportSessionEventEncoder = CrashlyticsReportSessionEventEncoder.f10013a;
        ...
        CrashlyticsReportSessionEventApplicationEncoder crashlyticsReportSessionEventApplicationEncoder = CrashlyticsReportSessionEventApplicationEncoder.f10005a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionEncoder crashlyticsReportSessionEventApplicationExecutionEncoder = CrashlyticsReportSessionEventApplicationExecutionEncoder.f10007a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionThreadEncoder crashlyticsReportSessionEventApplicationExecutionThreadEncoder = CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.f10010a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder crashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder = CrashlyticsReportSessionEventApplicationExecutionThreadFrameEncoder.f10011a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder crashlyticsReportSessionEventApplicationExecutionExceptionEncoder = CrashlyticsReportSessionEventApplicationExecutionExceptionEncoder.f10008a;
        ...
        CrashlyticsReportApplicationExitInfoEncoder crashlyticsReportApplicationExitInfoEncoder = CrashlyticsReportApplicationExitInfoEncoder.f9996a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionSignalEncoder crashlyticsReportSessionEventApplicationExecutionSignalEncoder = CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.f10009a;
        ...
        CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder crashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder = CrashlyticsReportSessionEventApplicationExecutionBinaryImageEncoder.f10006a;
        ...
        CrashlyticsReportCustomAttributeEncoder crashlyticsReportCustomAttributeEncoder = CrashlyticsReportCustomAttributeEncoder.f9997a;
        ...
        CrashlyticsReportSessionEventDeviceEncoder crashlyticsReportSessionEventDeviceEncoder = CrashlyticsReportSessionEventDeviceEncoder.f10012a;
        ...
        CrashlyticsReportSessionEventLogEncoder crashlyticsReportSessionEventLogEncoder = CrashlyticsReportSessionEventLogEncoder.f10014a;
        ...
        CrashlyticsReportFilesPayloadEncoder crashlyticsReportFilesPayloadEncoder = CrashlyticsReportFilesPayloadEncoder.f9999a;
        ...
        CrashlyticsReportFilesPayloadFileEncoder crashlyticsReportFilesPayloadFileEncoder = CrashlyticsReportFilesPayloadFileEncoder.f10000a;
