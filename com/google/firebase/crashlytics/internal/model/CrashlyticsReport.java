...
public abstract class CrashlyticsReport {
    ...
    public static abstract class Session {
        ...
        public static abstract class Application {
            ...
            Application b(@NonNull String str) {
                ...
                return a().setOrganization((organization != null ? organization.a() : Organization.builder()).setClsId(str).build()).build();
            }
        ...
        @NonNull
        Session a(@NonNull ImmutableList immutableList) {
            return toBuilder().setEvents(immutableList).build();
        }

        @NonNull
        Session b(@NonNull String str) {
            return toBuilder().setApp(getApp().b(str)).build();
        }

        @NonNull
        Session c(long j2, boolean z, @Nullable String str) {
    ...
    public CrashlyticsReport withEvents(@NonNull ImmutableList<Session.Event> immutableList) {
        if (getSession() != null) {
            return b().setSession(getSession().a(immutableList)).build();
        }
    ...
    public CrashlyticsReport withSessionEndFields(long j2, boolean z, @Nullable String str) {
        Builder b2 = b();
        if (getSession() != null) {
            b2.setSession(getSession().c(j2, z, str));
        }
        return b2.build();
    }
}
