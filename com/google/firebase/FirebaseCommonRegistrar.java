...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public static /* synthetic */ String lambda$getComponents$2(Context context) {
        ...
        return (i2 < 16 || !context.getPackageManager().hasSystemFeature("android.hardware.type.television")) ? (i2 < 20 || !context.getPackageManager().hasSystemFeature("android.hardware.type.watch")) ? (i2 < 23 || !context.getPackageManager().hasSystemFeature("android.hardware.type.automotive")) ? (i2 < 26 || !context.getPackageManager().hasSystemFeature("android.hardware.type.embedded")) ? "" : "embedded" : DebugKt.DEBUG_PROPERTY_VALUE_AUTO : "watch" : "tv";
    }
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, d.f10028a));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, e.f10029a));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, f.f10037a));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, c.f9886a));
