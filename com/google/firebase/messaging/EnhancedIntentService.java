...
public abstract class EnhancedIntentService extends Service {
    ...
    final ExecutorService f10059a = FcmExecutors.c();
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.f10059a.execute(new Runnable() { // from class: com.google.firebase.messaging.b
    ...
    public final int onStartCommand(final Intent intent, int i2, int i3) {
        ...
        Task<Void> processIntent = processIntent(d2);
        if (processIntent.isComplete()) {
            finishTask(intent);
            return 2;
        }
        processIntent.addOnCompleteListener(c.f10080a, new OnCompleteListener() { // from class: com.google.firebase.messaging.a
