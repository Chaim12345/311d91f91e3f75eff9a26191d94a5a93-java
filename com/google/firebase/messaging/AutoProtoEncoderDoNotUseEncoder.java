...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        static final MessagingClientEventEncoder f10056a = new MessagingClientEventEncoder();
        ...
        private static final FieldDescriptor PRIORITY_DESCRIPTOR = FieldDescriptor.builder(LogFactory.PRIORITY_KEY).withProperty(AtProtobuf.builder().tag(8).build()).build();
    ...
    private static final class MessagingClientEventExtensionEncoder implements ObjectEncoder<MessagingClientEventExtension> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final MessagingClientEventExtensionEncoder f10057a = new MessagingClientEventExtensionEncoder();
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder<ProtoEncoderDoNotUse> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final ProtoEncoderDoNotUseEncoder f10058a = new ProtoEncoderDoNotUseEncoder();
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        encoderConfig.registerEncoder(ProtoEncoderDoNotUse.class, ProtoEncoderDoNotUseEncoder.f10058a);
        encoderConfig.registerEncoder(MessagingClientEventExtension.class, MessagingClientEventExtensionEncoder.f10057a);
        encoderConfig.registerEncoder(MessagingClientEvent.class, MessagingClientEventEncoder.f10056a);
    }
}
