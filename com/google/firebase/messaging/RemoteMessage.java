...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Notification {
        ...
        private Notification(NotificationParams notificationParams) {
            ...
            this.lightSettings = notificationParams.a();
    ...
    public void a(Intent intent) {
        intent.putExtras(this.f10064a);
    }

    @Nullable
    public String getCollapseKey() {
        return this.f10064a.getString(Constants.MessagePayloadKeys.COLLAPSE_KEY);
    }

    @NonNull
    public Map<String, String> getData() {
        if (this.data == null) {
            this.data = Constants.MessagePayloadKeys.extractDeveloperDefinedPayload(this.f10064a);
        }
        return this.data;
    }
    ...
    public String getFrom() {
        return this.f10064a.getString("from");
    }

    @Nullable
    public String getMessageId() {
        String string = this.f10064a.getString(Constants.MessagePayloadKeys.MSGID);
        return string == null ? this.f10064a.getString(Constants.MessagePayloadKeys.MSGID_SERVER) : string;
    }

    @Nullable
    public String getMessageType() {
        return this.f10064a.getString(Constants.MessagePayloadKeys.MESSAGE_TYPE);
    }

    @Nullable
    public Notification getNotification() {
        if (this.notification == null && NotificationParams.isNotification(this.f10064a)) {
            this.notification = new Notification(new NotificationParams(this.f10064a));
        }
        return this.notification;
    }

    public int getOriginalPriority() {
        String string = this.f10064a.getString(Constants.MessagePayloadKeys.ORIGINAL_PRIORITY);
        if (string == null) {
            string = this.f10064a.getString(Constants.MessagePayloadKeys.PRIORITY_V19);
        }
        return getMessagePriority(string);
    }

    public int getPriority() {
        String string = this.f10064a.getString(Constants.MessagePayloadKeys.DELIVERED_PRIORITY);
        if (string == null) {
            if ("1".equals(this.f10064a.getString(Constants.MessagePayloadKeys.PRIORITY_REDUCED_V19))) {
                return 2;
            }
            string = this.f10064a.getString(Constants.MessagePayloadKeys.PRIORITY_V19);
        }
    ...
    public byte[] getRawData() {
        return this.f10064a.getByteArray(Constants.MessagePayloadKeys.RAW_DATA);
    }

    @Nullable
    public String getSenderId() {
        return this.f10064a.getString(Constants.MessagePayloadKeys.SENDER_ID);
    }

    public long getSentTime() {
        Object obj = this.f10064a.get(Constants.MessagePayloadKeys.SENT_TIME);
    ...
    @Nullable
    public String getTo() {
        return this.f10064a.getString(Constants.MessagePayloadKeys.TO);
    }

    public int getTtl() {
        Object obj = this.f10064a.get(Constants.MessagePayloadKeys.TTL);
