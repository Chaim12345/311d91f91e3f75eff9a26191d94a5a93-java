...
public final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    private final class GsonContextImpl implements JsonSerializationContext, JsonDeserializationContext {
        ...
        public <R> R deserialize(JsonElement jsonElement, Type type) {
            return (R) TreeTypeAdapter.this.f10224a.fromJson(jsonElement, type);
        }

        @Override // com.google.gson.JsonSerializationContext
        public JsonElement serialize(Object obj) {
            return TreeTypeAdapter.this.f10224a.toJsonTree(obj);
        }

        @Override // com.google.gson.JsonSerializationContext
        public JsonElement serialize(Object obj, Type type) {
            return TreeTypeAdapter.this.f10224a.toJsonTree(obj, type);
        }
    }
    ...
    private TypeAdapter<T> delegate() {
        ...
        TypeAdapter<T> delegateAdapter = this.f10224a.getDelegateAdapter(this.skipPast, this.typeToken);
