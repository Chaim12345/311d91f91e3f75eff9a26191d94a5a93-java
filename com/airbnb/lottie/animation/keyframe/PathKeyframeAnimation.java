...
public class PathKeyframeAnimation extends KeyframeAnimation<PointF> {
    ...
    public PointF getValue(Keyframe<PointF> keyframe, float f2) {
        ...
        if (lottieValueCallback == null || (pointF = (PointF) lottieValueCallback.getValueInternal(pathKeyframe.startFrame, pathKeyframe.endFrame.floatValue(), pathKeyframe.startValue, pathKeyframe.endValue, d(), f2, getProgress())) == null) {
            if (this.pathMeasureKeyframe != pathKeyframe) {
                this.pathMeasure.setPath(a2, false);
