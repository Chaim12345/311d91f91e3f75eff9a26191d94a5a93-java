...
public abstract class BaseStrokeContent implements BaseKeyframeAnimation.AnimationListener, KeyPathElementContent, DrawingContent {
    ...
    protected final BaseLayer f4419a;
    ...
    private void applyDashPatternIfNeeded(Matrix matrix) {
        ...
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation = this.dashPatternOffsetAnimation;
        this.f4420b.setPathEffect(new DashPathEffect(this.dashPatternValues, baseKeyframeAnimation == null ? 0.0f : scale * baseKeyframeAnimation.getValue().floatValue()));
        L.endSection("StrokeContent#applyDashPattern");
    }
        ...
        for (int size2 = pathGroup.paths.size() - 1; size2 >= 0; size2--) {
            ...
            if (floatValue3 > length) {
                ...
                if (f3 < f2 + length2 && f2 < f3) {
                    ...
                    canvas.drawPath(this.trimPathPath, this.f4420b);
                    f2 += length2;
                }
            }
            float f4 = f2 + length2;
            if (f4 >= floatValue2 && f2 <= floatValue3) {
                if (f4 > floatValue3 || floatValue2 >= f2) {
                    Utils.applyTrimPathIfNeeded(this.trimPathPath, floatValue2 < f2 ? 0.0f : (floatValue2 - f2) / length2, floatValue3 <= f4 ? (floatValue3 - f2) / length2 : 1.0f, 0.0f);
                }
                canvas.drawPath(this.trimPathPath, this.f4420b);
            }
            f2 += length2;
    ...
    public <T> void addValueCallback(T t2, @Nullable LottieValueCallback<T> lottieValueCallback) {
        ...
        if (t2 == LottieProperty.OPACITY) {
            ...
            if (t2 == LottieProperty.COLOR_FILTER) {
                ...
                if (baseKeyframeAnimation2 != null) {
                    this.f4419a.removeAnimation(baseKeyframeAnimation2);
                }
                ...
                this.f4419a.addAnimation(this.colorFilterAnimation);
                return;
            }
            return;
        } else {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i2) {
        ...
        this.f4420b.setAlpha(MiscUtils.clamp((int) ((((i2 / 255.0f) * ((IntegerKeyframeAnimation) this.opacityAnimation).getIntValue()) / 100.0f) * 255.0f), 0, 255));
        this.f4420b.setStrokeWidth(((FloatKeyframeAnimation) this.widthAnimation).getFloatValue() * Utils.getScale(matrix));
        if (this.f4420b.getStrokeWidth() <= 0.0f) {
            L.endSection("StrokeContent#draw");
            return;
        }
        ...
        if (baseKeyframeAnimation != null) {
            this.f4420b.setColorFilter(baseKeyframeAnimation.getValue());
        }
        for (int i3 = 0; i3 < this.pathGroups.size(); i3++) {
            ...
            if (pathGroup.trimPath != null) {
                ...
                canvas.drawPath(this.path, this.f4420b);
