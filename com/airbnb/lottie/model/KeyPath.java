...
public class KeyPath {
    ...
    public boolean fullyResolvesTo(String str, int i2) {
        ...
        if (!str2.equals("**")) {
            return (z || (i2 == this.keys.size() + (-2) && endsWithGlobstar())) && (str2.equals(str) || str2.equals(org.slf4j.Marker.ANY_MARKER));
        }
    ...
    public boolean matches(String str, int i2) {
        ...
        return this.keys.get(i2).equals(str) || this.keys.get(i2).equals("**") || this.keys.get(i2).equals(org.slf4j.Marker.ANY_MARKER);
    }
