...
public final class OkHttpClientInstance {
    ...
    public static final class Builder {
        ...
        private final OkHttpClient.Builder createOkhttpClientBuilderWithTlsConfig() {
            ...
            lazy = LazyKt__LazyJVMKt.lazy(OkHttpClientInstance$Builder$createOkhttpClientBuilderWithTlsConfig$1$trustManager$2.INSTANCE);
            if (Build.VERSION.SDK_INT < 22) {
                try {
                    ...
                    builder.sslSocketFactory(new TlsSocketFactory(socketFactory), m45createOkhttpClientBuilderWithTlsConfig$lambda1$lambda0(lazy));
        ...
        private static final X509TrustManager m45createOkhttpClientBuilderWithTlsConfig$lambda1$lambda0(Lazy<? extends X509TrustManager> lazy) {
            return lazy.getValue();
        }

        /* JADX INFO: Access modifiers changed from: private */
        /* renamed from: getUnsafeOkHttpClient$lambda-3  reason: not valid java name */
        public static final boolean m46getUnsafeOkHttpClient$lambda3(String str, SSLSession sSLSession) {
            return true;
        }
        ...
        public final OkHttpClient build() {
            ...
            RefreshTokenAuthenticator refreshTokenAuthenticator = new RefreshTokenAuthenticator(context, this.apiHolder);
            OkHttpClient.Builder addInterceptor = createOkhttpClientBuilderWithTlsConfig().addInterceptor(new Interceptor() { // from class: com.psa.mym.mycitroenconnect.api.retrofit.OkHttpClientInstance$Builder$build$$inlined$-addInterceptor$1
                ...
                public final Response intercept(@NotNull Interceptor.Chain chain) {
                    ...
                    context2 = OkHttpClientInstance.Builder.this.context;
                    Intrinsics.checkNotNull(context2);
                    String primaryUserToken = companion.getPrimaryUserToken(context2);
                    Logger logger = Logger.INSTANCE;
                    logger.e("Token: " + primaryUserToken);
                    if (primaryUserToken != null) {
                        addHeader.addHeader("Authorization", "Bearer " + primaryUserToken);
                    }
            ...
            readTimeout.authenticator(refreshTokenAuthenticator);
            readTimeout.followRedirects(false);
            readTimeout.followSslRedirects(false);
        ...
        public final OkHttpClient.Builder getUnsafeOkHttpClient() {
            Set emptySet;
            try {
                TrustManager[] trustManagerArr = {new X509TrustManager() { // from class: com.psa.mym.mycitroenconnect.api.retrofit.OkHttpClientInstance$Builder$getUnsafeOkHttpClient$trustAllCerts$1
                ...
                OkHttpClient.Builder addInterceptor = sslSocketFactory2.hostnameVerifier(b.f10360a).addInterceptor(new Interceptor() { // from class: com.psa.mym.mycitroenconnect.api.retrofit.OkHttpClientInstance$Builder$getUnsafeOkHttpClient$$inlined$-addInterceptor$1
                    @Override // okhttp3.Interceptor
                    @NotNull
                    public final Response intercept(@NotNull Interceptor.Chain chain) {
                        Context context2;
                ...
                sslSocketFactory2.authenticator(refreshTokenAuthenticator);
                sslSocketFactory2.followRedirects(false);
                sslSocketFactory2.followSslRedirects(false);
