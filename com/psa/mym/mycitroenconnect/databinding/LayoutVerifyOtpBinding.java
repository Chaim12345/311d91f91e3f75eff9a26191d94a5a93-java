...
public final class LayoutVerifyOtpBinding implements ViewBinding {
    @NonNull
                                        ...
                                        if (appCompatTextView5 != null) {
                                            ...
                                            if (appCompatTextView6 != null) {
                                                ...
                                                if (textInputLayout != null) {
                                                    return new LayoutVerifyOtpBinding((ConstraintLayout) view, appCompatImageButton, appCompatButton, pinView, appCompatImageView, appCompatTextView, appCompatTextView2, appCompatTextView3, appCompatTextView4, appCompatTextView5, appCompatTextView6, textInputLayout);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static LayoutVerifyOtpBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static LayoutVerifyOtpBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.layout_verify_otp, viewGroup, false);
        if (z) {
