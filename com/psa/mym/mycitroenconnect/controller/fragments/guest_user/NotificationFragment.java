...
public final class NotificationFragment extends Fragment {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final NotificationFragment newInstance(@NotNull String param1, @NotNull String param2) {
    ...
    @JvmStatic
    @NotNull
    public static final NotificationFragment newInstance(@NotNull String str, @NotNull String str2) {
