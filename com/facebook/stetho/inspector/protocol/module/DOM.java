...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private final class DocumentUpdateListener implements Document.UpdateListener {
        ...
        public void onChildNodeInserted(DocumentView documentView, Object obj, int i2, int i3, Accumulator<Object> accumulator) {
            ...
            acquireChildNodeInsertedEvent.parentNodeId = i2;
            acquireChildNodeInsertedEvent.previousNodeId = i3;
        ...
        public void onChildNodeRemoved(int i2, int i3) {
            ...
            acquireChildNodeRemovedEvent.parentNodeId = i2;
            acquireChildNodeRemovedEvent.nodeId = i3;
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            ...
            return Color.argb((int) b3, this.f5019r, this.f5018g, this.f5017b);
        }
    }
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        String str2 = getSearchResultsRequest.searchId;
        if (str2 == null) {
            str = "searchId may not be null";
        } else {
            List<Integer> list = this.mSearchResults.get(str2);
            if (list != null) {
            ...
            str = "\"" + getSearchResultsRequest.searchId + "\" is not a valid reference to a search result";
        }
        LogUtil.w(str);
        return null;
    }
