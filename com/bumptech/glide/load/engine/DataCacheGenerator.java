...
public class DataCacheGenerator implements DataFetcherGenerator, DataFetcher.DataCallback<Object> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:12:0x001d, code lost:
        ...
        r7.loadData = r0.get(r3).buildLoadData(r7.cacheFile, r7.helper.t(), r7.helper.f(), r7.helper.k());
     */
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0047, code lost:
        if (r7.loadData == null) goto L24;
     */
    /* JADX WARN: Code restructure failed: missing block: B:15:0x0057, code lost:
        if (r7.helper.u(r7.loadData.fetcher.getDataClass()) == false) goto L23;
     */
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0059, code lost:
        r7.loadData.fetcher.loadData(r7.helper.l(), r7);
     */
    ...
    public boolean startNext() {
        ...
        while (true) {
            try {
                ...
                File file = this.helper.d().get(new DataCacheKey(key, this.helper.p()));
                this.cacheFile = file;
                if (file != null) {
                    this.sourceKey = key;
