...
public class GifDrawable extends Drawable implements GifFrameLoader.FrameCallback, Animatable, Animatable2Compat {
    ...
    public static final class GifState extends Drawable.ConstantState {
        ...
        final GifFrameLoader f4796a;

        GifState(GifFrameLoader gifFrameLoader) {
            this.f4796a = gifFrameLoader;
        }
    ...
    private void startRunning() {
        ...
        if (this.state.f4796a.f() != 1) {
            if (this.isRunning) {
                return;
            }
            this.isRunning = true;
            this.state.f4796a.o(this);
        }
        invalidateSelf();
    }
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawBitmap(this.state.f4796a.c(), (Rect) null, getDestRect(), getPaint());
    }

    public ByteBuffer getBuffer() {
        return this.state.f4796a.b();
    }
    ...
    public Bitmap getFirstFrame() {
        return this.state.f4796a.e();
    }

    public int getFrameCount() {
        return this.state.f4796a.f();
    }

    public int getFrameIndex() {
        return this.state.f4796a.d();
    }

    public Transformation<Bitmap> getFrameTransformation() {
        return this.state.f4796a.g();
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicHeight() {
        return this.state.f4796a.h();
    }

    @Override // android.graphics.drawable.Drawable
    public int getIntrinsicWidth() {
        return this.state.f4796a.k();
    }
    ...
    public void setFrameTransformation(Transformation<Bitmap> transformation, Bitmap bitmap) {
        this.state.f4796a.m(transformation, bitmap);
    }
