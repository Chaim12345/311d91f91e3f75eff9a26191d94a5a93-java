...
public final class AnimatedWebpDecoder {
    ...
    public static final class ByteBufferAnimatedWebpDecoder implements ResourceDecoder<ByteBuffer, Drawable> {
        ...
        public Resource<Drawable> decode(@NonNull ByteBuffer byteBuffer, int i2, int i3, @NonNull Options options) {
    ...
    public static final class StreamAnimatedWebpDecoder implements ResourceDecoder<InputStream, Drawable> {
        ...
        @Override // com.bumptech.glide.load.ResourceDecoder
        public Resource<Drawable> decode(@NonNull InputStream inputStream, int i2, int i3, @NonNull Options options) {
    ...
    Resource a(@NonNull ImageDecoder.Source source, int i2, int i3, @NonNull Options options) {
