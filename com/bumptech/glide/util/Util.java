...
public final class Util {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f4841a[Bitmap.Config.RGB_565.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f4841a[Bitmap.Config.ARGB_4444.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f4841a[Bitmap.Config.RGBA_F16.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f4841a[Bitmap.Config.ARGB_8888.ordinal()] = 5;
    ...
    public static int getBytesPerPixel(@Nullable Bitmap.Config config) {
        ...
        int i2 = AnonymousClass1.f4841a[config.ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return 2;
            }
