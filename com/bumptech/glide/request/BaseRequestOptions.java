...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    private T scaleOnlyTransform(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation<Bitmap> transformation, boolean z) {
        T t2 = z ? (T) f(downsampleStrategy, transformation) : (T) c(downsampleStrategy, transformation);
    ...
    public T apply(@NonNull BaseRequestOptions<?> baseRequestOptions) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().apply(baseRequestOptions);
        }
    ...
    @NonNull
    final BaseRequestOptions c(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation transformation) {
        if (this.isAutoCloneEnabled) {
            return m36clone().c(downsampleStrategy, transformation);
        }
    ...
    public T diskCacheStrategy(@NonNull DiskCacheStrategy diskCacheStrategy) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().diskCacheStrategy(diskCacheStrategy);
        }
    ...
    public T dontTransform() {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().dontTransform();
        }
        this.transformations.clear();
        int i2 = this.fields & (-2049);
        this.fields = i2;
    ...
    @NonNull
    BaseRequestOptions e(@NonNull Transformation transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return m36clone().e(transformation, z);
        }
    ...
    public T error(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().error(drawable);
        }
    ...
    @NonNull
    @CheckResult
    final BaseRequestOptions f(@NonNull DownsampleStrategy downsampleStrategy, @NonNull Transformation transformation) {
        if (this.isAutoCloneEnabled) {
            return m36clone().f(downsampleStrategy, transformation);
        }
        downsample(downsampleStrategy);
    ...
    public T fallback(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().fallback(drawable);
        }
    ...
    @NonNull
    BaseRequestOptions g(@NonNull Class cls, @NonNull Transformation transformation, boolean z) {
        if (this.isAutoCloneEnabled) {
            return m36clone().g(cls, transformation, z);
        }
    ...
    public T onlyRetrieveFromCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().onlyRetrieveFromCache(z);
        }
    ...
    public T override(int i2, int i3) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().override(i2, i3);
        }
    ...
    public T placeholder(@DrawableRes int i2) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().placeholder(i2);
        }
    ...
    public T placeholder(@Nullable Drawable drawable) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().placeholder(drawable);
        }
    ...
    public T priority(@NonNull Priority priority) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().priority(priority);
        }
    ...
    public <Y> T set(@NonNull Option<Y> option, @NonNull Y y) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().set(option, y);
        }
    ...
    public T signature(@NonNull Key key) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().signature(key);
        }
    ...
    public T sizeMultiplier(@FloatRange(from = 0.0d, to = 1.0d) float f2) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().sizeMultiplier(f2);
        }
        if (f2 < 0.0f || f2 > 1.0f) {
    ...
    public T skipMemoryCache(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().skipMemoryCache(true);
        }
        this.isCacheable = !z;
        this.fields |= 256;
        return (T) d();
    ...
    public T transform(@NonNull Transformation<Bitmap>... transformationArr) {
        return transformationArr.length > 1 ? (T) e(new MultiTransformation(transformationArr), true) : transformationArr.length == 1 ? transform(transformationArr[0]) : (T) d();
    }
    ...
    public T useAnimationPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().useAnimationPool(z);
        }
    ...
    public T useUnlimitedSourceGeneratorsPool(boolean z) {
        if (this.isAutoCloneEnabled) {
            return (T) m36clone().useUnlimitedSourceGeneratorsPool(z);
        }
