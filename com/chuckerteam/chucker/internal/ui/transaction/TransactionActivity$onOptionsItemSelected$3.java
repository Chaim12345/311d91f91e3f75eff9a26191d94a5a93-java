...
final class TransactionActivity$onOptionsItemSelected$3 extends Lambda implements Function1<HttpTransaction, Sharable> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ TransactionActivity f4957a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransactionActivity$onOptionsItemSelected$3(TransactionActivity transactionActivity) {
        super(1);
        this.f4957a = transactionActivity;
    }
    ...
    public final Sharable invoke(@NotNull HttpTransaction transaction) {
        ...
        viewModel = this.f4957a.getViewModel();
