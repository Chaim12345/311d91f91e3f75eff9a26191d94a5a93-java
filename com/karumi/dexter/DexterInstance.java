...
public final class DexterInstance {
    ...
    private void updatePermissionsAsDenied(Collection<String> collection) {
        for (String str : collection) {
            this.multiplePermissionsReport.addDeniedPermissionResponse(PermissionDeniedResponse.from(str, !this.androidPermissionService.shouldShowRequestPermissionRationale(this.activity, str)));
        }
