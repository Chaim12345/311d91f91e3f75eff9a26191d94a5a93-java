...
public interface ThreadContextElement<S> extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(@NotNull ThreadContextElement<S> threadContextElement, R r2, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
    ...
    void restoreThreadContext(@NotNull CoroutineContext coroutineContext, S s2);
