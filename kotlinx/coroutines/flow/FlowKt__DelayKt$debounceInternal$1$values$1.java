...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ ProducerScope f11708a;

        AnonymousClass1(ProducerScope producerScope) {
            this.f11708a = producerScope;
        }
        ...
        */
        public final Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof FlowKt__DelayKt$debounceInternal$1$values$1$1$emit$1) {
                ...
                int i3 = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11711c;
                if ((i3 & Integer.MIN_VALUE) != 0) {
                    flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11711c = i3 - Integer.MIN_VALUE;
                    Object obj = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11709a;
                    coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i2 = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11711c;
                    if (i2 != 0) {
                        ResultKt.throwOnFailure(obj);
                        ProducerScope producerScope = this.f11708a;
                        if (t2 == null) {
                            t2 = (T) NullSurrogateKt.NULL;
                        }
                        flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11711c = 1;
                        if (producerScope.send(t2, flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1) == coroutine_suspended) {
            ...
            Object obj2 = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11709a;
            coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
            i2 = flowKt__DelayKt$debounceInternal$1$values$1$1$emit$1.f11711c;
            if (i2 != 0) {
            }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FlowKt__DelayKt$debounceInternal$1$values$1 flowKt__DelayKt$debounceInternal$1$values$1 = new FlowKt__DelayKt$debounceInternal$1$values$1(this.f11707b, continuation);
