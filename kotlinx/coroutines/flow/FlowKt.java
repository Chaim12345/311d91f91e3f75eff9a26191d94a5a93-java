...
public final class FlowKt {
    ...
    public static final <T> Flow<T> m1652catch(@NotNull Flow<? extends T> flow, @NotNull Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    @NotNull
    public static final <T> Flow<T> concatWith(@NotNull Flow<? extends T> flow, T t2) {
    ...
    public static final <T> Flow<T> m1653debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j2) {
        return FlowKt__DelayKt.m1655debounceHG0u8IE(flow, j2);
    }
    ...
    @NotNull
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t2) {
        return FlowKt__MigrationKt.onErrorReturn(flow, t2);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "Flow analogue of 'onErrorXxx' is 'catch'. Use 'catch { e -> if (predicate(e)) emit(fallback) else throw e }'", replaceWith = @ReplaceWith(expression = "catch { e -> if (predicate(e)) emit(fallback) else throw e }", imports = {}))
    @NotNull
    public static final <T> Flow<T> onErrorReturn(@NotNull Flow<? extends T> flow, T t2, @NotNull Function1<? super Throwable, Boolean> function1) {
    ...
    @NotNull
    public static final <T> Flow<T> publish(@NotNull Flow<? extends T> flow, int i2) {
    ...
    @NotNull
    public static final <T> Flow<T> replay(@NotNull Flow<? extends T> flow, int i2) {
    ...
    public static final <T> Flow<T> m1654sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j2) {
        return FlowKt__DelayKt.m1656sampleHG0u8IE(flow, j2);
    }
    ...
    @NotNull
    public static final <T, R> Flow<R> scanFold(@NotNull Flow<? extends T> flow, R r2, @BuilderInference @NotNull Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
    ...
    @NotNull
    public static final <T> Flow<T> startWith(@NotNull Flow<? extends T> flow, T t2) {
