...
final class FlowCoroutineKt$scopedFlow$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    final /* synthetic */ Function3 f12341b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ FlowCollector f12342c;
    ...
    public FlowCoroutineKt$scopedFlow$1$1(Function3 function3, FlowCollector flowCollector, Continuation continuation) {
        ...
        this.f12341b = function3;
        this.f12342c = flowCollector;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FlowCoroutineKt$scopedFlow$1$1 flowCoroutineKt$scopedFlow$1$1 = new FlowCoroutineKt$scopedFlow$1$1(this.f12341b, this.f12342c, continuation);
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            Function3 function3 = this.f12341b;
            FlowCollector flowCollector = this.f12342c;
            this.f12340a = 1;
