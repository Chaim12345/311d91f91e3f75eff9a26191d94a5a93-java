...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    final /* synthetic */ Flow f12039a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ Function2 f12040b;
    ...
    public static final class AnonymousClass2<T> implements FlowCollector {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ FlowCollector f12044a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Function2 f12045b;
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                this.f12046a = obj;
                this.f12047b |= Integer.MIN_VALUE;
                return AnonymousClass2.this.emit(null, this);
            }
        }

        public AnonymousClass2(FlowCollector flowCollector, Function2 function2) {
            this.f12044a = flowCollector;
        ...
        */
        public final Object emit(T t2, @NotNull Continuation<? super Unit> continuation) {
            ...
            if (continuation instanceof AnonymousClass1) {
                ...
                int i3 = anonymousClass1.f12047b;
                if ((i3 & Integer.MIN_VALUE) != 0) {
                    anonymousClass1.f12047b = i3 - Integer.MIN_VALUE;
                    obj = anonymousClass1.f12046a;
                    coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    i2 = anonymousClass1.f12047b;
                    if (i2 != 0) {
                        ResultKt.throwOnFailure(obj);
                        FlowCollector flowCollector2 = this.f12044a;
                        Function2 function2 = this.f12045b;
                        anonymousClass1.f12049d = flowCollector2;
                        anonymousClass1.f12047b = 1;
                        ...
                        flowCollector = (FlowCollector) anonymousClass1.f12049d;
                        ResultKt.throwOnFailure(obj);
                    }
                    anonymousClass1.f12049d = null;
                    anonymousClass1.f12047b = 2;
        ...
        public final Object emit$$forInline(Object obj, @NotNull Continuation continuation) {
            ...
            InlineMarker.mark(5);
            FlowCollector flowCollector = this.f12044a;
            Object invoke = this.f12045b.invoke(obj, continuation);
            InlineMarker.mark(0);
    ...
    public Object collect(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        Object coroutine_suspended;
        Object collect = this.f12039a.collect(new AnonymousClass2(flowCollector, this.f12040b), continuation);
        coroutine_suspended = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
    ...
    public Object collect$$forInline(@NotNull FlowCollector flowCollector, @NotNull Continuation continuation) {
        ...
        InlineMarker.mark(5);
        Flow flow = this.f12039a;
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(flowCollector, this.f12040b);
        InlineMarker.mark(0);
