...
public interface CompletableDeferred<T> extends Deferred<T> {
    ...
    public static final class DefaultImpls {
        public static <T, R> R fold(@NotNull CompletableDeferred<T> completableDeferred, R r2, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
