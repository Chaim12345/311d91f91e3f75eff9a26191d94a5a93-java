...
public class EventRecodingLogger implements Logger {
    ...
    SubstituteLogger f15230b;

    /* renamed from: c  reason: collision with root package name */
    Queue f15231c;

    public EventRecodingLogger(SubstituteLogger substituteLogger, Queue<SubstituteLoggingEvent> queue) {
        this.f15230b = substituteLogger;
        this.f15229a = substituteLogger.getName();
        this.f15231c = queue;
    }
    ...
    private void recordEvent(Level level, Marker marker, String str, Object[] objArr, Throwable th) {
        ...
        substituteLoggingEvent.setLogger(this.f15230b);
        substituteLoggingEvent.setLoggerName(this.f15229a);
        ...
        this.f15231c.add(substituteLoggingEvent);
    }
