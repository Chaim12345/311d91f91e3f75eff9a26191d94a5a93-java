    ...
    private static final Properties getConfigurationFile(ClassLoader classLoader, String str) {
                ...
                if (properties2 != null) {
                    if (properties == null) {
                        try {
                            ...
                            d2 = property != null ? Double.parseDouble(property) : 0.0d;
                            if (isDiagnosticsEnabled()) {
                                StringBuffer stringBuffer2 = new StringBuffer();
                        ...
                        if (parseDouble > d2) {
                            if (isDiagnosticsEnabled()) {
                                ...
                                stringBuffer3.append(" overrides file at '");
                            ...
                            stringBuffer4.append(parseDouble);
                            stringBuffer4.append(" does not override file at '");
        ...
        if (isDiagnosticsEnabled()) {
            if (properties == null) {
                ...
                stringBuffer.append("[LOOKUP] No properties file of name '");
                stringBuffer.append(str);
                stringBuffer.append("' found.");
            } else {
                stringBuffer = new StringBuffer();
                stringBuffer.append("[LOOKUP] Properties file of name '");
                stringBuffer.append(str);
                stringBuffer.append("' found at '");
    ...
    private static boolean implementsLogFactory(Class cls) {
        ...
        if (cls != null) {
            try {
                ...
                stringBuffer = new StringBuffer();
                stringBuffer.append("[CUSTOM LOG FACTORY] LinkageError thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: ");
                ...
                stringBuffer = new StringBuffer();
                stringBuffer.append("[CUSTOM LOG FACTORY] SecurityException thrown whilst trying to determine whether the compatibility was caused by a classloader conflict: ");
