            ...
            if (i5 != 0) {
                ...
                if (nextLine.startsWith("/*")) {
                    ...
                    if (trim.length() == 0) {
                        ...
                        try {
                            String stripQuotes = stripQuotes(split[i3]);
                            String stripQuotes2 = stripQuotes(split[1]);
                            String stripQuotes3 = stripQuotes(split[2]);
                            str2 = "' in ";
                            try {
                                Rule rule = new Rule(stripQuotes, stripQuotes2, stripQuotes3, parsePhonemeExpr(stripQuotes(split[3])), i6, str, stripQuotes, stripQuotes2, stripQuotes3) { // from class: org.apache.commons.codec.language.bm.Rule.2
                                    ...
                                    public String toString() {
                                        return "Rule{line=" + this.myLine + ", loc='" + this.loc + "', pat='" + this.val$pat + "', lcon='" + this.val$lCon + "', rcon='" + this.val$rCon + '\'' + AbstractJsonLexerKt.END_OBJ;
                                    }
                                };
                                i2 = 0;
