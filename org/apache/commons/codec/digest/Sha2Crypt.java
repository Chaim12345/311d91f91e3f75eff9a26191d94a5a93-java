...
public class Sha2Crypt {
    ...
    private static String sha2Crypt(byte[] bArr, String str, String str2, int i2, String str3) {
        ...
        if (str != null) {
            ...
            int i5 = 0;
            while (i5 < length - i2) {
                System.arraycopy(digest6, 0, bArr2, i5, i2);
                i5 += i2;
            }
            System.arraycopy(digest6, 0, bArr2, i5, length - i5);
            ...
            int i7 = 0;
            while (i7 < length2 - i2) {
                System.arraycopy(digest8, 0, bArr3, i7, i2);
                i7 += i2;
            }
            System.arraycopy(digest8, 0, bArr3, i7, length2 - i7);
            int i8 = 0;
