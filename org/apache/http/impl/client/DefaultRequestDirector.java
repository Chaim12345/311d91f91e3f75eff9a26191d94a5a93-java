...
public class DefaultRequestDirector implements RequestDirector {
        ...
        while (true) {
            ...
            try {
                ...
                if (this.log.isInfoEnabled()) {
                    Log log = this.log;
                    log.info("I/O exception (" + e2.getClass().getName() + ") caught when connecting to " + route + ": " + e2.getMessage());
                    if (this.log.isDebugEnabled()) {
                        this.log.debug(e2.getMessage(), e2);
                    }
                    Log log2 = this.log;
    ...
    protected boolean createTunnelToProxy(HttpRoute httpRoute, int i2, HttpContext httpContext) {
        ...
        try {
            ...
            if (httpRoute.getProxyHost() == null || httpRoute.isTunnelled()) {
                if (uri.isAbsolute()) {
                    ...
                    rewriteURI = URIUtils.rewriteURI(uri, httpHost, enumSet);
                }
