...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager2 == null) {
            ...
            PoolingHttpClientConnectionManager poolingHttpClientConnectionManager2 = new PoolingHttpClientConnectionManager(build, null, null, dnsResolver, j2, timeUnit);
            ...
            if (i3 > 0) {
                poolingHttpClientConnectionManager2.setDefaultMaxPerRoute(i3);
            }
        ...
        if (this.connManagerShared) {
            ...
            if (this.evictExpiredConnections || this.evictIdleConnections) {
                ...
                credentialsProvider = credentialsProvider2;
                httpClientConnectionManager = poolingHttpClientConnectionManager;
                final IdleConnectionEvictor idleConnectionEvictor = new IdleConnectionEvictor(poolingHttpClientConnectionManager, j4, timeUnit2 != null ? timeUnit2 : TimeUnit.SECONDS, j3, timeUnit2);
