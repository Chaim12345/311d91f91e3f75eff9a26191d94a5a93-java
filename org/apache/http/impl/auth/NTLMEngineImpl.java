...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    static class Handle {
        ...
        Handle(byte[] bArr, Mode mode, boolean z) {
    ...
    public static class NTLMMessage {
        ...
        NTLMMessage(String str, int i2) {
            this(Base64.decodeBase64(str.getBytes(NTLMEngineImpl.DEFAULT_CHARSET)), i2);
        }

        NTLMMessage(byte[] bArr, int i2) {
            this.messageContents = null;
            this.currentOutputPosition = 0;
        ...
        protected byte readByte(int i2) {
            byte[] bArr = this.messageContents;
            if (bArr.length >= i2 + 1) {
                return bArr[i2];
            }
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2) {
            this(str, str2, str3, str4, bArr, i2, str5, bArr2, null, null, null);
        }

        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2, Certificate certificate, byte[] bArr3, byte[] bArr4) {
            this(NTLMEngineImpl.RND_GEN, System.currentTimeMillis(), str, str2, str3, str4, bArr, i2, str5, bArr2, certificate, bArr3, bArr4);
        }

        Type3Message(Random random, long j2, String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2) {
        ...
        */
        Type3Message(Random random, long j2, String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2, Certificate certificate, byte[] bArr3, byte[] bArr4) {
            byte[] bArr5;
            ...
            if ((8388608 & i2) != 0 && bArr2 != null && str5 != null) {
                ...
                Charset charset2 = NTLMEngineImpl.getCharset(i2);
                this.hostBytes = convertHost != null ? convertHost.getBytes(charset2) : null;
                this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset2) : null;
                this.userBytes = str3.getBytes(charset2);
            } else if ((524288 & i2) == 0) {
                ...
                if ((i2 & 128) != 0) {
                    ...
                    Charset charset22 = NTLMEngineImpl.getCharset(i2);
                    this.hostBytes = convertHost != null ? convertHost.getBytes(charset22) : null;
                    this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset22) : null;
                    this.userBytes = str3.getBytes(charset22);
                }
                lanManagerSessionKey = cipherGen.getNTLMUserSessionKey();
                if ((i2 & 16) != 0) {
                }
                Charset charset222 = NTLMEngineImpl.getCharset(i2);
                this.hostBytes = convertHost != null ? convertHost.getBytes(charset222) : null;
                this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset222) : null;
                this.userBytes = str3.getBytes(charset222);
            } else {
                ...
                if ((i2 & 128) == 0) {
                    ...
                    Charset charset2222 = NTLMEngineImpl.getCharset(i2);
                    this.hostBytes = convertHost != null ? convertHost.getBytes(charset2222) : null;
                    this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset2222) : null;
                    this.userBytes = str3.getBytes(charset2222);
                }
                lanManagerSessionKey = cipherGen.getLanManagerSessionKey();
                if ((i2 & 16) != 0) {
                    if ((1073741824 & i2) != 0) {
                ...
                Charset charset22222 = NTLMEngineImpl.getCharset(i2);
                this.hostBytes = convertHost != null ? convertHost.getBytes(charset22222) : null;
                this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset22222) : null;
                this.userBytes = str3.getBytes(charset22222);
            }
            this.ntResp = new byte[0];
            this.lmResp = cipherGen.getLMResponse();
            ...
            Charset charset222222 = NTLMEngineImpl.getCharset(i2);
            this.hostBytes = convertHost != null ? convertHost.getBytes(charset222222) : null;
            this.domainBytes = convertDomain != null ? convertDomain.toUpperCase(Locale.ROOT).getBytes(charset222222) : null;
            this.userBytes = str3.getBytes(charset222222);
        }
        ...
        protected void buildMessage() {
            ...
            if (this.computeMic) {
                ...
                this.currentOutputPosition = i8 + 16;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static Charset getCharset(int i2) {
        if ((i2 & 1) == 0) {
    ...
    static String getType3Message(String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2) {
        return new Type3Message(str4, str3, str, str2, bArr, i2, str5, bArr2).getResponse();
    }

    static String getType3Message(String str, String str2, String str3, String str4, byte[] bArr, int i2, String str5, byte[] bArr2, Certificate certificate, byte[] bArr3, byte[] bArr4) {
