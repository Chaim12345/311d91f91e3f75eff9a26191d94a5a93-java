...
public class PoolingHttpClientConnectionManager implements HttpClientConnectionManager, ConnPoolControl<HttpRoute>, Closeable {
    ...
    protected HttpClientConnection leaseConnection(Future<CPoolEntry> future, long j2, TimeUnit timeUnit) {
        try {
                        ...
                        if (connection != null) {
                            try {
                                ...
                                if (PoolingHttpClientConnectionManager.this.log.isDebugEnabled()) {
                                    PoolingHttpClientConnectionManager.this.log.debug("I/O exception shutting down connection", e2);
                                }
                            }
                        }
                    }
