...
public class DiscoverEndomorphisms {
    ...
    private static void printGLVTypeAParameters(X9ECParameters x9ECParameters) {
        ...
        BigInteger[] solveQuadraticEquation = solveQuadraticEquation(n2, bigInteger, ECConstants.ZERO, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        BigInteger n2 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] solveQuadraticEquation = solveQuadraticEquation(n2, bigInteger, bigInteger, bigInteger);
