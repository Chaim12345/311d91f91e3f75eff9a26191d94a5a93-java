...
public class SecP160R1Field {
    ...
    static final int[] f14163a = {Integer.MAX_VALUE, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f14163a))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f14163a))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f14163a, iArr2));
        }
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f14163a, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(5, iArr, f14163a) == 0);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j7 = (iArr[0] & 4294967295L) + j2 + (j2 << 31) + 0;
        iArr2[0] = (int) j7;
        long j8 = (j7 >>> 32) + (iArr[1] & 4294967295L) + j3 + (j3 << 31);
        iArr2[1] = (int) j8;
        long j9 = (j8 >>> 32) + (iArr[2] & 4294967295L) + j4 + (j4 << 31);
        iArr2[2] = (int) j9;
        long j10 = (j9 >>> 32) + (iArr[3] & 4294967295L) + j5 + (j5 << 31);
        iArr2[3] = (int) j10;
        long j11 = (j10 >>> 32) + (4294967295L & iArr[4]) + j6 + (j6 << 31);
        iArr2[4] = (int) j11;
        reduce32((int) (j11 >>> 32), iArr2);
    }

    public static void reduce32(int i2, int[] iArr) {
        if ((i2 == 0 || Nat160.mulWordsAdd(PInv, i2, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f14163a))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f14163a))) {
            Nat.addWordTo(5, PInv, iArr2);
        }
    }
}
