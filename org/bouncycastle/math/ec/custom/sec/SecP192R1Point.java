...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f14096b;
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f14097c;
        ...
        SecP192R1FieldElement secP192R1FieldElement5 = (SecP192R1FieldElement) this.f14098d[0];
        ...
        if (isOne) {
            iArr = secP192R1FieldElement3.f14185a;
            iArr2 = secP192R1FieldElement4.f14185a;
        } else {
            SecP192R1Field.square(secP192R1FieldElement5.f14185a, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement3.f14185a, create);
            SecP192R1Field.multiply(create2, secP192R1FieldElement5.f14185a, create2);
            SecP192R1Field.multiply(create2, secP192R1FieldElement4.f14185a, create2);
            iArr = create;
            iArr2 = create2;
        }
        boolean isOne2 = secP192R1FieldElement6.isOne();
        if (isOne2) {
            iArr3 = secP192R1FieldElement.f14185a;
            iArr4 = secP192R1FieldElement2.f14185a;
        } else {
            SecP192R1Field.square(secP192R1FieldElement6.f14185a, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement.f14185a, createExt);
            SecP192R1Field.multiply(create3, secP192R1FieldElement6.f14185a, create3);
            SecP192R1Field.multiply(create3, secP192R1FieldElement2.f14185a, create3);
            iArr3 = createExt;
            iArr4 = create3;
        }
        ...
        SecP192R1Field.square(create, secP192R1FieldElement7.f14185a);
        int[] iArr5 = secP192R1FieldElement7.f14185a;
        ...
        SecP192R1Field.subtract(create2, secP192R1FieldElement7.f14185a, secP192R1FieldElement8.f14185a);
        SecP192R1Field.multiplyAddToExt(secP192R1FieldElement8.f14185a, create, createExt);
        SecP192R1Field.reduce(createExt, secP192R1FieldElement8.f14185a);
        SecP192R1FieldElement secP192R1FieldElement9 = new SecP192R1FieldElement(create4);
        if (!isOne) {
            int[] iArr6 = secP192R1FieldElement9.f14185a;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement5.f14185a, iArr6);
        }
        if (!isOne2) {
            int[] iArr7 = secP192R1FieldElement9.f14185a;
            SecP192R1Field.multiply(iArr7, secP192R1FieldElement6.f14185a, iArr7);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP192R1Point(this.f14095a, this.f14096b, this.f14097c.negate(), this.f14098d);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP192R1FieldElement secP192R1FieldElement = (SecP192R1FieldElement) this.f14097c;
        if (secP192R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP192R1FieldElement secP192R1FieldElement2 = (SecP192R1FieldElement) this.f14096b;
        SecP192R1FieldElement secP192R1FieldElement3 = (SecP192R1FieldElement) this.f14098d[0];
        int[] create = Nat192.create();
        int[] create2 = Nat192.create();
        int[] create3 = Nat192.create();
        SecP192R1Field.square(secP192R1FieldElement.f14185a, create3);
        int[] create4 = Nat192.create();
        SecP192R1Field.square(create3, create4);
        boolean isOne = secP192R1FieldElement3.isOne();
        int[] iArr = secP192R1FieldElement3.f14185a;
        if (!isOne) {
            SecP192R1Field.square(iArr, create2);
            iArr = create2;
        }
        SecP192R1Field.subtract(secP192R1FieldElement2.f14185a, iArr, create);
        SecP192R1Field.add(secP192R1FieldElement2.f14185a, iArr, create2);
        ...
        SecP192R1Field.square(create2, secP192R1FieldElement4.f14185a);
        int[] iArr2 = secP192R1FieldElement4.f14185a;
        SecP192R1Field.subtract(iArr2, create3, iArr2);
        int[] iArr3 = secP192R1FieldElement4.f14185a;
        ...
        SecP192R1Field.subtract(create3, secP192R1FieldElement4.f14185a, secP192R1FieldElement5.f14185a);
        int[] iArr4 = secP192R1FieldElement5.f14185a;
        SecP192R1Field.multiply(iArr4, create2, iArr4);
        int[] iArr5 = secP192R1FieldElement5.f14185a;
        SecP192R1Field.subtract(iArr5, create, iArr5);
        SecP192R1FieldElement secP192R1FieldElement6 = new SecP192R1FieldElement(create2);
        SecP192R1Field.twice(secP192R1FieldElement.f14185a, secP192R1FieldElement6.f14185a);
        if (!isOne) {
            int[] iArr6 = secP192R1FieldElement6.f14185a;
            SecP192R1Field.multiply(iArr6, secP192R1FieldElement3.f14185a, iArr6);
        }
