...
public class SecT239K1Curve extends ECCurve.AbstractF2m {
    ...
    protected SecT239K1Point f14278i;

    public SecT239K1Curve() {
        super(239, CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, 0, 0);
        this.f14278i = new SecT239K1Point(this, null, null);
        this.f14065b = fromBigInteger(BigInteger.valueOf(0L));
        this.f14066c = fromBigInteger(BigInteger.valueOf(1L));
        this.f14067d = new BigInteger(1, Hex.decodeStrict("2000000000000000000000000000005A79FEC67CB6E91F1C1DA800E478A5"));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawXCoord()).f14277a, 0, jArr, i4);
            int i6 = i4 + 4;
            Nat256.copy64(((SecT239FieldElement) eCPoint.getRawYCoord()).f14277a, 0, jArr, i6);
            i4 = i6 + 4;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT239K1Curve.1
            private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                return SecT239K1Curve.this.f(new SecT239FieldElement(jArr2), new SecT239FieldElement(jArr3), SecT239K1Curve.SECT239K1_AFFINE_ZS);
            }
