...
public class SecT233R1Curve extends ECCurve.AbstractF2m {
    ...
    protected SecT233R1Point f14273i;

    public SecT233R1Curve() {
        super(233, 74, 0, 0);
        this.f14273i = new SecT233R1Point(this, null, null);
        this.f14065b = fromBigInteger(BigInteger.valueOf(1L));
        this.f14066c = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD")));
        this.f14067d = new BigInteger(1, Hex.decodeStrict("01000000000000000000000000000013E974E72F8A6922031D2603CFE0D7"));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT233R1Curve.1
            private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                return SecT233R1Curve.this.f(new SecT233FieldElement(jArr2), new SecT233FieldElement(jArr3), SecT233R1Curve.SECT233R1_AFFINE_ZS);
            }
