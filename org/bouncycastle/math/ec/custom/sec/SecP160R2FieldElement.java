...
public class SecP160R2FieldElement extends ECFieldElement.AbstractFp {
    ...
    public SecP160R2FieldElement(BigInteger bigInteger) {
        ...
        this.f14171a = SecP160R2Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP160R2Field.add(this.f14171a, ((SecP160R2FieldElement) eCFieldElement).f14171a, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat160.create();
        SecP160R2Field.addOne(this.f14171a, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.inv(((SecP160R2FieldElement) eCFieldElement).f14171a, create);
        SecP160R2Field.multiply(create, this.f14171a, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP160R2FieldElement) {
            return Nat160.eq(this.f14171a, ((SecP160R2FieldElement) obj).f14171a);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f14171a, 0, 5);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat160.create();
        SecP160R2Field.inv(this.f14171a, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat160.isOne(this.f14171a);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat160.isZero(this.f14171a);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.multiply(this.f14171a, ((SecP160R2FieldElement) eCFieldElement).f14171a, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat160.create();
        SecP160R2Field.negate(this.f14171a, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f14171a;
    ...
    public ECFieldElement square() {
        int[] create = Nat160.create();
        SecP160R2Field.square(this.f14171a, create);
        return new SecP160R2FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat160.create();
        SecP160R2Field.subtract(this.f14171a, ((SecP160R2FieldElement) eCFieldElement).f14171a, create);
        return new SecP160R2FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat160.getBit(this.f14171a, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat160.toBigInteger(this.f14171a);
    }
}
