...
public class SecT163R2Curve extends ECCurve.AbstractF2m {
    ...
    protected SecT163R2Point f14255i;

    public SecT163R2Curve() {
        super(CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7);
        this.f14255i = new SecT163R2Point(this, null, null);
        this.f14065b = fromBigInteger(BigInteger.valueOf(1L));
        this.f14066c = fromBigInteger(new BigInteger(1, Hex.decodeStrict("020A601907B8C953CA1481EB10512F78744A3205FD")));
        this.f14067d = new BigInteger(1, Hex.decodeStrict("040000000000000000000292FE77E70C12A4234C33"));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT163R2Curve.1
            private ECPoint createPoint(long[] jArr2, long[] jArr3) {
                return SecT163R2Curve.this.f(new SecT163FieldElement(jArr2), new SecT163FieldElement(jArr3), SecT163R2Curve.SECT163R2_AFFINE_ZS);
            }
