...
public class SecT283K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElement8 = this.f14097c;
        ECFieldElement eCFieldElement9 = this.f14098d[0];
    ...
    public ECPoint negate() {
        ...
        ECFieldElement eCFieldElement2 = this.f14097c;
        ECFieldElement eCFieldElement3 = this.f14098d[0];
        return new SecT283K1Point(this.f14095a, eCFieldElement, eCFieldElement2.add(eCFieldElement3), new ECFieldElement[]{eCFieldElement3});
    }
