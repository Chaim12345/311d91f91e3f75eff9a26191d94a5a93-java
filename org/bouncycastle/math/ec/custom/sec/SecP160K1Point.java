...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.f14095a, this.f14096b, this.f14097c.negate(), this.f14098d);
    }
    ...
    public ECPoint twice() {
        ...
        int[] create = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f14171a, create);
        int[] create2 = Nat160.create();
        SecP160R2Field.square(create, create2);
        int[] create3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f14171a, create3);
        SecP160R2Field.reduce32(Nat160.addBothTo(create3, create3, create3), create3);
        SecP160R2Field.multiply(create, secP160R2FieldElement2.f14171a, create);
        ...
        SecP160R2Field.square(create3, secP160R2FieldElement4.f14171a);
        int[] iArr = secP160R2FieldElement4.f14171a;
        ...
        SecP160R2Field.subtract(create, secP160R2FieldElement4.f14171a, secP160R2FieldElement5.f14171a);
        int[] iArr3 = secP160R2FieldElement5.f14171a;
        ...
        if (!secP160R2FieldElement3.isOne()) {
            int[] iArr5 = secP160R2FieldElement6.f14171a;
            SecP160R2Field.multiply(iArr5, secP160R2FieldElement3.f14171a, iArr5);
        }
