...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    protected SecP224K1Point f14187i;

    /* renamed from: q  reason: collision with root package name */
    public static final BigInteger f14186q = SecP224K1FieldElement.Q;
    private static final ECFieldElement[] SECP224K1_AFFINE_ZS = {new SecP224K1FieldElement(ECConstants.ONE)};

    public SecP224K1Curve() {
        super(f14186q);
        this.f14187i = new SecP224K1Point(this, null, null);
        this.f14065b = fromBigInteger(ECConstants.ZERO);
        this.f14066c = fromBigInteger(BigInteger.valueOf(5L));
        this.f14067d = new BigInteger(1, Hex.decodeStrict("010000000000000000000000000001DCE8D2EC6184CAF0A971769FB1F7"));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        for (int i5 = 0; i5 < i3; i5++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawXCoord()).f14192a, 0, iArr, i4);
            int i6 = i4 + 7;
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawYCoord()).f14192a, 0, iArr, i6);
            i4 = i6 + 7;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP224K1Curve.1
            private ECPoint createPoint(int[] iArr2, int[] iArr3) {
                return SecP224K1Curve.this.f(new SecP224K1FieldElement(iArr2), new SecP224K1FieldElement(iArr3), SecP224K1Curve.SECP224K1_AFFINE_ZS);
            }
