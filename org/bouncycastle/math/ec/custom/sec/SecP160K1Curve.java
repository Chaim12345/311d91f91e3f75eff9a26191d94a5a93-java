...
public class SecP160K1Curve extends ECCurve.AbstractFp {
    ...
    protected SecP160K1Point f14154i;

    /* renamed from: q  reason: collision with root package name */
    public static final BigInteger f14153q = SecP160R2FieldElement.Q;
    private static final ECFieldElement[] SECP160K1_AFFINE_ZS = {new SecP160R2FieldElement(ECConstants.ONE)};

    public SecP160K1Curve() {
        super(f14153q);
        this.f14154i = new SecP160K1Point(this, null, null);
        this.f14065b = fromBigInteger(ECConstants.ZERO);
        this.f14066c = fromBigInteger(BigInteger.valueOf(7L));
        this.f14067d = new BigInteger(1, Hex.decodeStrict("0100000000000000000001B8FA16DFAB9ACA16B6B3"));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i2, final int i3) {
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP160K1Curve.1
            private ECPoint createPoint(int[] iArr2, int[] iArr3) {
                return SecP160K1Curve.this.f(new SecP160R2FieldElement(iArr2), new SecP160R2FieldElement(iArr3), SecP160K1Curve.SECP160K1_AFFINE_ZS);
            }
