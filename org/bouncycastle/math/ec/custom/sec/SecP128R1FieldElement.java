...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    protected int[] f14152a;

    public SecP128R1FieldElement() {
        this.f14152a = Nat128.create();
    }
    ...
    public SecP128R1FieldElement(BigInteger bigInteger) {
        ...
        this.f14152a = SecP128R1Field.fromBigInteger(bigInteger);
    }
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        ...
        SecP128R1Field.add(this.f14152a, ((SecP128R1FieldElement) eCFieldElement).f14152a, create);
    ...
    public ECFieldElement addOne() {
        int[] create = Nat128.create();
        SecP128R1Field.addOne(this.f14152a, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.inv(((SecP128R1FieldElement) eCFieldElement).f14152a, create);
        SecP128R1Field.multiply(create, this.f14152a, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP128R1FieldElement) {
            return Nat128.eq(this.f14152a, ((SecP128R1FieldElement) obj).f14152a);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f14152a, 0, 4);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] create = Nat128.create();
        SecP128R1Field.inv(this.f14152a, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat128.isOne(this.f14152a);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat128.isZero(this.f14152a);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.multiply(this.f14152a, ((SecP128R1FieldElement) eCFieldElement).f14152a, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement negate() {
        int[] create = Nat128.create();
        SecP128R1Field.negate(this.f14152a, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement square() {
        int[] create = Nat128.create();
        SecP128R1Field.square(this.f14152a, create);
        return new SecP128R1FieldElement(create);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat128.create();
        SecP128R1Field.subtract(this.f14152a, ((SecP128R1FieldElement) eCFieldElement).f14152a, create);
        return new SecP128R1FieldElement(create);
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat128.getBit(this.f14152a, 0) == 1;
    }

    @Override // org.bouncycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat128.toBigInteger(this.f14152a);
    }
}
