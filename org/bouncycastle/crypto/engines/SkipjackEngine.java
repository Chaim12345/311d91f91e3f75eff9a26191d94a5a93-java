...
public class SkipjackEngine implements BlockCipher {
    ...
    private int g(int i2, int i3) {
        int i4 = i3 & 255;
        short[] sArr = f13398a;
        int i5 = ((i3 >> 8) & 255) ^ sArr[this.key0[i2] ^ i4];
        int i6 = i4 ^ sArr[this.key1[i2] ^ i5];
        int i7 = i5 ^ sArr[this.key2[i2] ^ i6];
        return (i7 << 8) + (sArr[this.key3[i2] ^ i7] ^ i6);
    }
