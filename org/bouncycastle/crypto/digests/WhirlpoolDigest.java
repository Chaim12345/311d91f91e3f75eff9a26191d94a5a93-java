    ...
    protected void a() {
        ...
        while (i3 <= 10) {
            ...
            while (i4 < 8) {
                ...
                long[] jArr5 = C0;
                long[] jArr6 = this._K;
                jArr4[i4] = jArr5[((int) (jArr6[(i4 + 0) & 7] >>> 56)) & 255] ^ j4;
                jArr4[i4] = jArr4[i4] ^ C1[((int) (jArr6[(i4 - 1) & 7] >>> 48)) & 255];
                jArr4[i4] = jArr4[i4] ^ C2[((int) (jArr6[(i4 - 2) & 7] >>> 40)) & 255];
                jArr4[i4] = jArr4[i4] ^ C3[((int) (jArr6[(i4 - 3) & 7] >>> 32)) & 255];
                jArr4[i4] = jArr4[i4] ^ C4[((int) (jArr6[(i4 - 4) & 7] >>> 24)) & 255];
                jArr4[i4] = jArr4[i4] ^ C5[((int) (jArr6[(i4 - 5) & 7] >>> 16)) & 255];
                jArr4[i4] = jArr4[i4] ^ C6[((int) (jArr6[(i4 - 6) & 7] >>> 8)) & 255];
                jArr4[i4] = jArr4[i4] ^ C7[((int) jArr6[(i4 - 7) & 7]) & 255];
                i4++;
                i3 = i3;
            }
            int i5 = i3;
            ...
            while (true) {
                ...
                if (i6 < 8) {
                    ...
                    jArr[i6] = j5 ^ jArr10[((int) (jArr11[(i6 + 0) & 7] >>> 56)) & 255];
                    jArr[i6] = jArr[i6] ^ C1[((int) (jArr11[(i6 - 1) & 7] >>> 48)) & 255];
                    jArr[i6] = jArr[i6] ^ C2[((int) (jArr11[(i6 - 2) & 7] >>> 40)) & 255];
                    jArr[i6] = jArr[i6] ^ C3[((int) (jArr11[(i6 - 3) & 7] >>> 32)) & 255];
                    jArr[i6] = jArr[i6] ^ C4[((int) (jArr11[(i6 - 4) & 7] >>> 24)) & 255];
                    jArr[i6] = jArr[i6] ^ C5[((int) (jArr11[(i6 - 5) & 7] >>> 16)) & 255];
                    jArr[i6] = jArr[i6] ^ C6[((int) (jArr11[(i6 - 6) & 7] >>> 8)) & 255];
                    jArr[i6] = jArr[i6] ^ C7[((int) jArr11[(i6 - 7) & 7]) & 255];
                    i6++;
                }
            }
