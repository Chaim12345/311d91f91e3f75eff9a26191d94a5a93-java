...
public class RIPEMD128Digest extends GeneralDigest {
    ...
    protected void c() {
        ...
        int FF4 = FF4(i2, i3, i4, i5, this.X[5], 8);
        int FF42 = FF4(i5, FF4, i3, i4, this.X[14], 9);
        int FF43 = FF4(i4, FF42, FF4, i3, this.X[7], 9);
        int FF44 = FF4(i3, FF43, FF42, FF4, this.X[0], 11);
