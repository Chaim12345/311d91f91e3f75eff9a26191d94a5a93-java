...
public class SkeinEngine implements Memoable {
    ...
    public class UBI {
        ...
        private void processBlock(long[] jArr) {
            ...
            skeinEngine.f13317a.init(true, skeinEngine.f13318b, this.tweak.getWords());
            int i2 = 0;
            while (true) {
                jArr2 = this.message;
                if (i2 >= jArr2.length) {
            ...
            SkeinEngine.this.f13317a.processBlock(jArr2, jArr);
    ...
    private void copyIn(SkeinEngine skeinEngine) {
        ...
        this.f13318b = Arrays.clone(skeinEngine.f13318b, this.f13318b);
    ...
    private void createInitialState() {
        ...
        if (this.key != null || jArr == null) {
            this.f13318b = new long[getBlockSize() / 8];
            byte[] bArr = this.key;
            if (bArr != null) {
                ubiComplete(0, bArr);
            }
            ...
            this.f13318b = Arrays.clone(jArr);
        }
        ...
        this.initialState = Arrays.clone(this.f13318b);
    }
    ...
    private void output(long j2, byte[] bArr, int i2, int i3) {
        ...
        long[] jArr = new long[this.f13318b.length];
        ubiInit(63);
    ...
    private void ubiComplete(int i2, byte[] bArr) {
        ubiInit(i2);
        this.ubi.update(bArr, 0, bArr.length, this.f13318b);
        ubiFinal();
    }

    private void ubiFinal() {
        this.ubi.doFinal(this.f13318b);
    }
    ...
    private static Integer variantIdentifier(int i2, int i3) {
        return Integers.valueOf(i2 | (i3 << 16));
    }
    ...
    public int getBlockSize() {
        return this.f13317a.getBlockSize();
    }
    ...
    public void update(byte[] bArr, int i2, int i3) {
        checkInitialised();
        this.ubi.update(bArr, i2, i3, this.f13318b);
    }
}
