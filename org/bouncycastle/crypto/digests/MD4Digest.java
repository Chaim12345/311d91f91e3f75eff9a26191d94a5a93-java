...
public class MD4Digest extends GeneralDigest {
    ...
    protected void c() {
        ...
        int i4 = this.H3;
        int i5 = this.H4;
        int rotateLeft = rotateLeft(i2 + F(i3, i4, i5) + this.X[0], 3);
        int rotateLeft2 = rotateLeft(i5 + F(rotateLeft, i3, i4) + this.X[1], 7);
        int rotateLeft3 = rotateLeft(i4 + F(rotateLeft2, rotateLeft, i3) + this.X[2], 11);
        int rotateLeft4 = rotateLeft(i3 + F(rotateLeft3, rotateLeft2, rotateLeft) + this.X[3], 19);
