...
public class RIPEMD256Digest extends GeneralDigest {
    ...
    protected void c() {
        ...
        int i8 = this.H6;
        int i9 = this.H7;
        int F1 = F1(i2, i3, i4, i5, this.X[0], 11);
        int F12 = F1(i5, F1, i3, i4, this.X[1], 14);
        int F13 = F1(i4, F12, F1, i3, this.X[2], 15);
        int F14 = F1(i3, F13, F12, F1, this.X[3], 12);
        ...
        int FF4 = FF4(i6, i7, i8, i9, this.X[5], 8);
        int FF42 = FF4(i9, FF4, i7, i8, this.X[14], 9);
        int FF43 = FF4(i8, FF42, FF4, i7, this.X[7], 9);
        int FF44 = FF4(i7, FF43, FF42, FF4, this.X[0], 11);
