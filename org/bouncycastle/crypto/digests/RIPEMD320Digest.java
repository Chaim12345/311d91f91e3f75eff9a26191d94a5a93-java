...
public class RIPEMD320Digest extends GeneralDigest {
    ...
    protected void c() {
        ...
        int i10 = this.H8;
        int i11 = this.H9;
        int RL = RL(i2 + f1(i3, i4, i5) + this.X[0], 11) + i6;
        int RL2 = RL(i4, 10);
        int RL3 = RL(i6 + f1(RL, i3, RL2) + this.X[1], 14) + i5;
        int RL4 = RL(i3, 10);
        int RL5 = RL(i5 + f1(RL3, RL, RL4) + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i7 + f5(i8, i9, i10) + this.X[5] + 1352829926, 8) + i11;
        int RL34 = RL(i9, 10);
        int RL35 = RL(i11 + f5(RL33, i8, RL34) + this.X[14] + 1352829926, 9) + i10;
        int RL36 = RL(i8, 10);
        int RL37 = RL(i10 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
