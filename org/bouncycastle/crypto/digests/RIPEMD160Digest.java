...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    protected void c() {
        ...
        int i5 = this.H3;
        int i6 = this.H4;
        int RL = RL(f1(i3, i4, i5) + i2 + this.X[0], 11) + i6;
        int RL2 = RL(i4, 10);
        int RL3 = RL(f1(RL, i3, RL2) + i6 + this.X[1], 14) + i5;
        int RL4 = RL(i3, 10);
        int RL5 = RL(f1(RL3, RL, RL4) + i5 + this.X[2], 15) + RL2;
        int RL6 = RL(RL, 10);
        ...
        int RL32 = RL(RL27, 10);
        int RL33 = RL(i2 + f5(i3, i4, i5) + this.X[5] + 1352829926, 8) + i6;
        int RL34 = RL(i4, 10);
        int RL35 = RL(i6 + f5(RL33, i3, RL34) + this.X[14] + 1352829926, 9) + i5;
        int RL36 = RL(i3, 10);
        int RL37 = RL(i5 + f5(RL35, RL33, RL36) + this.X[7] + 1352829926, 9) + RL34;
        int RL38 = RL(RL33, 10);
