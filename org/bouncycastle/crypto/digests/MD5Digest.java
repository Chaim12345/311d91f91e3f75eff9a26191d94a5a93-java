...
public class MD5Digest extends GeneralDigest implements EncodableDigest {
    ...
    protected void c() {
        ...
        int i4 = this.H3;
        int i5 = this.H4;
        int rotateLeft = rotateLeft(((i2 + F(i3, i4, i5)) + this.X[0]) - 680876936, 7) + i3;
        int rotateLeft2 = rotateLeft(((i5 + F(rotateLeft, i3, i4)) + this.X[1]) - 389564586, 12) + rotateLeft;
        int rotateLeft3 = rotateLeft(i4 + F(rotateLeft2, rotateLeft, i3) + this.X[2] + 606105819, 17) + rotateLeft2;
        int rotateLeft4 = rotateLeft(((i3 + F(rotateLeft3, rotateLeft2, rotateLeft)) + this.X[3]) - 1044525330, 22) + rotateLeft3;
