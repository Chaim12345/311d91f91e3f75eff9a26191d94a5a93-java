...
public class ECGOST3410Signer implements DSAExt {
    ...
    ECKeyParameters f13512a;

    /* renamed from: b  reason: collision with root package name */
    SecureRandom f13513b;
    ...
    public BigInteger[] generateSignature(byte[] bArr) {
        ...
        ECDomainParameters parameters = this.f13512a.getParameters();
        BigInteger n2 = parameters.getN();
        BigInteger d2 = ((ECPrivateKeyParameters) this.f13512a).getD();
        ECMultiplier a2 = a();
        while (true) {
            BigInteger createRandomBigInteger = BigIntegers.createRandomBigInteger(n2.bitLength(), this.f13513b);
    ...
    public BigInteger getOrder() {
        return this.f13512a.getParameters().getN();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            this.f13513b = parametersWithRandom.getRandom();
            this.f13512a = (ECPrivateKeyParameters) parametersWithRandom.getParameters();
            return;
        } else {
            this.f13513b = CryptoServicesRegistrar.getSecureRandom();
            eCKeyParameters = (ECPrivateKeyParameters) cipherParameters;
        }
        this.f13512a = eCKeyParameters;
    }

    @Override // org.bouncycastle.crypto.DSA
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = new BigInteger(1, Arrays.reverse(bArr));
        BigInteger n2 = this.f13512a.getParameters().getN();
        ...
        ECPoint normalize = ECAlgorithms.sumOfTwoMultiplies(this.f13512a.getParameters().getG(), bigInteger2.multiply(modOddInverseVar).mod(n2), ((ECPublicKeyParameters) this.f13512a).getQ(), n2.subtract(bigInteger).multiply(modOddInverseVar).mod(n2)).normalize();
