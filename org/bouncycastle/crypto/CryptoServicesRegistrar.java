...
public final class CryptoServicesRegistrar {
    ...
    private static int chooseLowerBound(int i2) {
        if (i2 > 1024) {
            if (i2 <= 2048) {
    ...
    public static <T> T getSizedProperty(Property property, int i2) {
        Object[] lookupProperty = lookupProperty(property);
        if (lookupProperty == null) {
            return null;
        }
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (i3 != lookupProperty.length) {
                ?? r4 = (T) ((DHParameters) lookupProperty[i3]);
            ...
            while (i3 != lookupProperty.length) {
                ?? r42 = (T) ((DSAParameters) lookupProperty[i3]);
