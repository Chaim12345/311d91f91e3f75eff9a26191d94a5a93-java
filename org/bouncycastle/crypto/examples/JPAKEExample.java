...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) {
        ...
        printStream2.println("q (" + q2.bitLength() + " bits): " + q2.toString(16));
        PrintStream printStream3 = System.out;
        printStream3.println("g (" + p2.bitLength() + " bits): " + g2.toString(16));
        ...
        printStream5.println("g^{q} mod p = " + g2.modPow(q2, p2).toString(16));
        System.out.println("");
