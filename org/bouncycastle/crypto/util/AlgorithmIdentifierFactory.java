...
public class AlgorithmIdentifierFactory {
    ...
    static final ASN1ObjectIdentifier f13520a = new ASN1ObjectIdentifier(CMSEnvelopedGenerator.IDEA_CBC).intern();

    /* renamed from: b  reason: collision with root package name */
    static final ASN1ObjectIdentifier f13521b = new ASN1ObjectIdentifier(CMSEnvelopedGenerator.CAST5_CBC).intern();
    ...
    public static AlgorithmIdentifier generateEncryptionAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i2, SecureRandom secureRandom) {
        ...
        } else if (aSN1ObjectIdentifier.equals((ASN1Primitive) PKCSObjectIdentifiers.des_EDE3_CBC) || aSN1ObjectIdentifier.equals((ASN1Primitive) f13520a) || aSN1ObjectIdentifier.equals((ASN1Primitive) OIWObjectIdentifiers.desCBC)) {
            byte[] bArr4 = new byte[8];
            secureRandom.nextBytes(bArr4);
            return new AlgorithmIdentifier(aSN1ObjectIdentifier, new DEROctetString(bArr4));
        } else if (aSN1ObjectIdentifier.equals((ASN1Primitive) f13521b)) {
