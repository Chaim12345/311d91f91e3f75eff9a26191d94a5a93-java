...
public class ECNewRandomnessTransform implements ECPairFactorTransform {
    ...
    public ECPair transform(ECPair eCPair) {
        ...
        if (eCPublicKeyParameters != null) {
            ...
            ECPoint[] eCPointArr = {a2.multiply(parameters.getG(), a3).add(ECAlgorithms.cleanPoint(parameters.getCurve(), eCPair.getX())), this.key.getQ().multiply(a3).add(ECAlgorithms.cleanPoint(parameters.getCurve(), eCPair.getY()))};
