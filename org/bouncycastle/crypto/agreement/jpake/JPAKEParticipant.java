...
public class JPAKEParticipant {
    ...
    private BigInteger f13251b;
    private final Digest digest;

    /* renamed from: g  reason: collision with root package name */
    private final BigInteger f13252g;
    ...
    private final BigInteger f13253p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q  reason: collision with root package name */
    private final BigInteger f13254q;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f13253p = jPAKEPrimeOrderGroup.getP();
        this.f13254q = jPAKEPrimeOrderGroup.getQ();
        this.f13252g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i2 >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f13253p, this.f13254q, this.gx4, this.x2, calculateS, this.f13251b);
            this.x1 = null;
            this.x2 = null;
            this.f13251b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.x1 = JPAKEUtil.generateX1(this.f13254q, this.random);
        this.x2 = JPAKEUtil.generateX2(this.f13254q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f13253p, this.f13252g, this.x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f13253p, this.f13252g, this.x2);
        BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f13253p, this.f13254q, this.f13252g, this.gx1, this.x1, this.participantId, this.digest, this.random);
        BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f13253p, this.f13254q, this.f13252g, this.gx2, this.x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i2 >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f13253p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f13254q, this.x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f13253p, this.f13254q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f13253p, this.f13254q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f13253p, this.f13254q, this.f13252g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f13253p, this.f13254q, this.f13252g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) {
        ...
        if (i2 >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f13253p, this.gx3, this.gx1, this.gx2);
            this.f13251b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f13253p, this.f13254q, calculateGA, this.f13251b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        }
    }
