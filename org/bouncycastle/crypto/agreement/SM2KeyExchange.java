...
public class SM2KeyExchange {
    ...
    private byte[] kdf(ECPoint eCPoint, byte[] bArr, byte[] bArr2, int i2) {
        ...
        while (i4 < i3) {
            ...
            i5++;
            Pack.intToBigEndian(i5, bArr3, 0);
    ...
    public byte[] calculateKey(int i2, CipherParameters cipherParameters) {
        ...
        return this.initiator ? kdf(calculateU, z, z2, i2) : kdf(calculateU, z2, z, i2);
    }
    ...
    public byte[][] calculateKeyWithConfirmation(int i2, byte[] bArr, CipherParameters cipherParameters) {
        ...
        ECPoint calculateU = calculateU(sM2KeyExchangePublicParameters);
        if (!this.initiator) {
            byte[] kdf = kdf(calculateU, z2, z, i2);
        ...
        byte[] kdf2 = kdf(calculateU, z, z2, i2);
