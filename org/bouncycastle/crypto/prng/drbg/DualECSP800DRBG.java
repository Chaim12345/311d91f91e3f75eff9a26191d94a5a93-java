...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0078, code lost:
        r3 = org.bouncycastle.crypto.prng.drbg.Utils.c(r2._digest, r6, r2._seedlen);
        r2._s = r3;
    ...
    */
    public DualECSP800DRBG(DualECPoints[] dualECPointsArr, Digest digest, int i2, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        ...
        if (entropySource.entropySize() < i2 || entropySource.entropySize() > 4096) {
            throw new IllegalArgumentException("EntropySource must provide between " + i2 + " and 4096 bits");
        }
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        BigInteger bigInteger = bArr2 != null ? new BigInteger(1, xor(this._s, Utils.c(this._digest, bArr2, this._seedlen))) : new BigInteger(1, this._s);
        int i2 = 0;
        ...
        if (i3 < bArr.length) {
            ...
            if (length5 > i6) {
                ...
                i3 += i6 - byteArray2.length;
            }
            System.arraycopy(byteArray2, i2, bArr, i3, length4);
            this._reseedCounter++;
        }
    ...
    public void reseed(byte[] bArr) {
        ...
        this._s = Utils.c(this._digest, Arrays.concatenate(pad8(this._s, this._seedlen), getEntropy(), bArr), this._seedlen);
