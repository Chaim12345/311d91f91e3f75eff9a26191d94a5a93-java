...
public class JceCMSMacCalculatorBuilder {
    ...
    private class CMSMacCalculator implements MacCalculator {
        ...
        CMSMacCalculator(JceCMSMacCalculatorBuilder jceCMSMacCalculatorBuilder, ASN1ObjectIdentifier aSN1ObjectIdentifier, int i2, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) {
            KeyGenerator createKeyGenerator = jceCMSMacCalculatorBuilder.helper.createKeyGenerator(aSN1ObjectIdentifier);
            ...
            this.algorithmIdentifier = jceCMSMacCalculatorBuilder.helper.l(aSN1ObjectIdentifier, algorithmParameters == null ? jceCMSMacCalculatorBuilder.helper.k(aSN1ObjectIdentifier, this.encKey, secureRandom) : algorithmParameters);
            this.mac = jceCMSMacCalculatorBuilder.helper.e(this.encKey, this.algorithmIdentifier);
        }
    ...
    public MacCalculator build() {
        return new CMSMacCalculator(this, this.macOID, this.keySize, this.algorithmParameters, this.random);
    }
