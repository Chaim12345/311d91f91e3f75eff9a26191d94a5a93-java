...
public class CMSUtils {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static ASN1Encodable d(AlgorithmParameters algorithmParameters) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static IssuerAndSerialNumber e(X509Certificate x509Certificate) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void k(AlgorithmParameters algorithmParameters, ASN1Encodable aSN1Encodable) {
        try {
