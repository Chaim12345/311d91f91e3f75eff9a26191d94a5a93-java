...
public class CMSSignedHelper {
    ...
    static final CMSSignedHelper f13148a = new CMSSignedHelper();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AlgorithmIdentifier a(AlgorithmIdentifier algorithmIdentifier, DigestAlgorithmIdentifierFinder digestAlgorithmIdentifierFinder) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public Store f(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Set aSN1Set) {
        if (aSN1Set != null) {
            ArrayList arrayList = new ArrayList(aSN1Set.size());
            Enumeration objects = aSN1Set.getObjects();
            while (objects.hasMoreElements()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void g(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
