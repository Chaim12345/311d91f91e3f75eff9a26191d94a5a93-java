    ...
    public InputDecryptorProvider build(final char[] cArr) {
        return new InputDecryptorProvider() { // from class: org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8DecryptorProviderBuilder.1
            ...
            public InputDecryptor get(final AlgorithmIdentifier algorithmIdentifier) {
                ...
                try {
                    if (PEMUtilities.f(algorithmIdentifier.getAlgorithm())) {
                        ...
                        if (PEMUtilities.isPKCS12(algorithmIdentifier.getAlgorithm())) {
                        ...
                        } else if (!PEMUtilities.e(algorithmIdentifier.getAlgorithm())) {
                            ...
                            createCipher = JceOpenSSLPKCS8DecryptorProviderBuilder.this.helper.createCipher(algorithmIdentifier.getAlgorithm().getId());
                            pBKDF1KeyWithParameters = new PBKDF1KeyWithParameters(cArr, new CharToByteConverter(this) { // from class: org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8DecryptorProviderBuilder.1.1
                    ...
                    return new InputDecryptor(this) { // from class: org.bouncycastle.openssl.jcajce.JceOpenSSLPKCS8DecryptorProviderBuilder.1.2
