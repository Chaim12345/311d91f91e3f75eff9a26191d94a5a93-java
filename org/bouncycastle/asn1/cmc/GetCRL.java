...
public class GetCRL extends ASN1Object {
    ...
    private GetCRL(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() <= i2 || !(aSN1Sequence.getObjectAt(i2).toASN1Primitive() instanceof ASN1BitString)) {
            return;
        }
        this.reasons = new ReasonFlags(ASN1BitString.getInstance(aSN1Sequence.getObjectAt(i2)));
    }
