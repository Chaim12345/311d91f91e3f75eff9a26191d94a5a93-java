...
public class IssuerSerial extends ASN1Object {
    ...
    GeneralNames f12962a;

    /* renamed from: b  reason: collision with root package name */
    ASN1Integer f12963b;

    /* renamed from: c  reason: collision with root package name */
    ASN1BitString f12964c;

    private IssuerSerial(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 2 && aSN1Sequence.size() != 3) {
            throw new IllegalArgumentException("Bad sequence size: " + aSN1Sequence.size());
        }
        this.f12962a = GeneralNames.getInstance(aSN1Sequence.getObjectAt(0));
        this.f12963b = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1));
        if (aSN1Sequence.size() == 3) {
            this.f12964c = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(2));
        }
    }
    ...
    public IssuerSerial(GeneralNames generalNames, ASN1Integer aSN1Integer) {
        this.f12962a = generalNames;
        this.f12963b = aSN1Integer;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f12962a);
        aSN1EncodableVector.add(this.f12963b);
        ASN1BitString aSN1BitString = this.f12964c;
