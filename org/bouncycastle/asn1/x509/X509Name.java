...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = new ASN1ObjectIdentifier(ObjectIdentifiers.organizationalUnitName);
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier5 = new ASN1ObjectIdentifier(ObjectIdentifiers.commonName);
                ...
                while (i2 != i4) {
                    ...
                    while (true) {
                        if (i5 >= size) {
                            z = false;
                            break;
                        } else if (!zArr[i5] && aSN1ObjectIdentifier.equals((ASN1Primitive) ((ASN1ObjectIdentifier) x509Name.ordering.elementAt(i5))) && equivalentStrings(str, (String) x509Name.values.elementAt(i5))) {
                            zArr[i5] = true;
                            z = true;
                            break;
                        } else {
            ...
            if ((obj instanceof X509Name) || (obj instanceof ASN1Sequence)) {
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        if (!((ASN1ObjectIdentifier) this.ordering.elementAt(i2)).equals((ASN1Primitive) ((ASN1ObjectIdentifier) x509Name.ordering.elementAt(i2))) || !equivalentStrings((String) this.values.elementAt(i2), (String) x509Name.values.elementAt(i2))) {
                            return false;
                        }
                    }
                    return true;
