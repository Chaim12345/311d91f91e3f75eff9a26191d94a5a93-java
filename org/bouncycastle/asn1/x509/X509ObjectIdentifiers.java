...
public interface X509ObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier commonName = new ASN1ObjectIdentifier(ObjectIdentifiers.commonName).intern();
    ...
    public static final ASN1ObjectIdentifier organizationalUnitName = new ASN1ObjectIdentifier(ObjectIdentifiers.organizationalUnitName).intern();
