...
public class Extension extends ASN1Object {
    ...
    public static final ASN1ObjectIdentifier subjectAlternativeName = new ASN1ObjectIdentifier(ObjectIdentifiers.subjectAlternativeName).intern();
    public static final ASN1ObjectIdentifier issuerAlternativeName = new ASN1ObjectIdentifier("2.5.29.18").intern();
    public static final ASN1ObjectIdentifier basicConstraints = new ASN1ObjectIdentifier(ObjectIdentifiers.basicConstraints).intern();
