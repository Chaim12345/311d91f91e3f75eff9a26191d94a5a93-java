    ...
    */
    ...
    private byte[][] minMaxIPs(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            bArr6[i2] = (byte) ((bArr[i2] & bArr2[i2]) | (~bArr2[i2]));
            bArr7[i2] = (byte) (bArr3[i2] & bArr4[i2]);
            bArr8[i2] = (byte) ((bArr3[i2] & bArr4[i2]) | (~bArr4[i2]));
        }
    ...
    */
        ...
        if (aSN1Sequence2.size() >= 1 && aSN1Sequence2.size() <= aSN1Sequence.size()) {
            ...
            while (true) {
                if (i2 >= aSN1Sequence.size()) {
                    i2 = i3;
                    break;
                } else if (IETFUtils.rDNAreEqual(rdn, RDN.getInstance(aSN1Sequence.getObjectAt(i2)))) {
                    break;
                } else {
                    i3 = i2;
                    i2++;
            ...
            for (int i4 = 0; i4 < aSN1Sequence2.size(); i4++) {
                RDN rdn2 = RDN.getInstance(aSN1Sequence2.getObjectAt(i4));
                RDN rdn3 = RDN.getInstance(aSN1Sequence.getObjectAt(i2 + i4));
    ...
    public void intersectEmptyPermittedSubtree(int i2) {
        if (i2 == 0) {
            ...
            throw new IllegalStateException("Unknown tag encountered: " + i2);
        }
    }
