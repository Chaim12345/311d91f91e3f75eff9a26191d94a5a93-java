...
public class DSTU4145NamedCurves {
    ...
    static final ECDomainParameters[] f12911a;

    /* renamed from: b  reason: collision with root package name */
    static final ASN1ObjectIdentifier[] f12912b;

    /* renamed from: c  reason: collision with root package name */
    static final String f12913c;
    ...
    static {
        ...
        ONE = valueOf2;
        f12911a = new ECDomainParameters[10];
        f12912b = new ASN1ObjectIdentifier[10];
        f12913c = UAObjectIdentifiers.dstu4145le.getId() + ".2.";
        int i2 = 0;
        ...
        int i3 = 0;
        while (true) {
            ECDomainParameters[] eCDomainParametersArr = f12911a;
        ...
        while (true) {
            ASN1ObjectIdentifier[] aSN1ObjectIdentifierArr = f12912b;
            if (i2 >= aSN1ObjectIdentifierArr.length) {
                return;
            }
            aSN1ObjectIdentifierArr[i2] = new ASN1ObjectIdentifier(f12913c + i2);
            i2++;
        }
    }
    ...
    public static ECDomainParameters getByOID(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (!id.startsWith(f12913c) || (parseInt = Integer.parseInt(id.substring(id.lastIndexOf(46) + 1))) < 0) {
            return null;
        }
        ECDomainParameters[] eCDomainParametersArr = f12911a;
