...
public class ArchiveTimeStampSequence extends ASN1Object {
    ...
    public ArchiveTimeStampSequence append(ArchiveTimeStampChain archiveTimeStampChain) {
        ...
        for (int i2 = 0; i2 != this.archiveTimeStampChains.size(); i2++) {
            aSN1EncodableVector.add(this.archiveTimeStampChains.getObjectAt(i2));
        }
    ...
    public ArchiveTimeStampChain[] getArchiveTimeStampChains() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            archiveTimeStampChainArr[i2] = ArchiveTimeStampChain.getInstance(this.archiveTimeStampChains.getObjectAt(i2));
        }
