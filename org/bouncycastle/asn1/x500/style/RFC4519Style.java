...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f12916c;
    ...
    public static final ASN1ObjectIdentifier f12917l;
    public static final ASN1ObjectIdentifier member;
    public static final ASN1ObjectIdentifier name;

    /* renamed from: o  reason: collision with root package name */
    public static final ASN1ObjectIdentifier f12918o;
    ...
    protected final Hashtable f12920b = AbstractX500NameStyle.copyHashTable(DefaultSymbols);

    /* renamed from: a  reason: collision with root package name */
    protected final Hashtable f12919a = AbstractX500NameStyle.copyHashTable(DefaultLookUp);
    ...
    static {
        ...
        f12916c = intern2;
        ASN1ObjectIdentifier intern3 = new ASN1ObjectIdentifier(ObjectIdentifiers.commonName).intern();
        cn = intern3;
        ...
        f12918o = intern19;
        ASN1ObjectIdentifier intern20 = new ASN1ObjectIdentifier(ObjectIdentifiers.organizationalUnitName).intern();
        ou = intern20;
    ...
    public ASN1Encodable a(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        return aSN1ObjectIdentifier.equals((ASN1Primitive) dc) ? new DERIA5String(str) : (aSN1ObjectIdentifier.equals((ASN1Primitive) f12916c) || aSN1ObjectIdentifier.equals((ASN1Primitive) serialNumber) || aSN1ObjectIdentifier.equals((ASN1Primitive) dnQualifier) || aSN1ObjectIdentifier.equals((ASN1Primitive) telephoneNumber)) ? new DERPrintableString(str) : super.a(aSN1ObjectIdentifier, str);
    }

    @Override // org.bouncycastle.asn1.x500.X500NameStyle
    public ASN1ObjectIdentifier attrNameToOID(String str) {
        return IETFUtils.decodeAttrName(str, this.f12919a);
    }
    ...
    public RDN[] fromString(String str) {
        ...
        for (int i2 = 0; i2 != rDNsFromString.length; i2++) {
            rdnArr[(length - i2) - 1] = rDNsFromString[i2];
        }
        return rdnArr;
    }
    ...
    public String[] oidToAttrNames(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return IETFUtils.findAttrNamesForOID(aSN1ObjectIdentifier, this.f12919a);
    }
    ...
    public String toString(X500Name x500Name) {
        ...
        for (int length = rDNs.length - 1; length >= 0; length--) {
            ...
            IETFUtils.appendRDN(stringBuffer, rDNs[length], this.f12920b);
        }
