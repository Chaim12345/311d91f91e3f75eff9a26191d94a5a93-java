...
public class BCStyle extends AbstractX500NameStyle {
    ...
    protected final Hashtable f12915b = AbstractX500NameStyle.copyHashTable(DefaultSymbols);

    /* renamed from: a  reason: collision with root package name */
    protected final Hashtable f12914a = AbstractX500NameStyle.copyHashTable(DefaultLookUp);
    ...
    static {
        ...
        O = intern2;
        ASN1ObjectIdentifier intern3 = new ASN1ObjectIdentifier(ObjectIdentifiers.organizationalUnitName).intern();
        OU = intern3;
        ASN1ObjectIdentifier intern4 = new ASN1ObjectIdentifier("2.5.4.12").intern();
        T = intern4;
        ASN1ObjectIdentifier intern5 = new ASN1ObjectIdentifier(ObjectIdentifiers.commonName).intern();
        CN = intern5;
    ...
    public String[] oidToAttrNames(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return IETFUtils.findAttrNamesForOID(aSN1ObjectIdentifier, this.f12914a);
    }
    ...
    public String toString(X500Name x500Name) {
        ...
        for (RDN rdn : x500Name.getRDNs()) {
            ...
            IETFUtils.appendRDN(stringBuffer, rdn, this.f12915b);
        }
