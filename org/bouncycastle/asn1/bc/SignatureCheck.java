...
public class SignatureCheck extends ASN1Object {
    ...
    private SignatureCheck(ASN1Sequence aSN1Sequence) {
        ...
        this.signatureValue = DERBitString.getInstance((Object) aSN1Sequence.getObjectAt(i2));
    }
    ...
    public Certificate[] getCertificates() {
        ...
        for (int i2 = 0; i2 != size; i2++) {
            certificateArr[i2] = Certificate.getInstance(this.certificates.getObjectAt(i2));
        }
