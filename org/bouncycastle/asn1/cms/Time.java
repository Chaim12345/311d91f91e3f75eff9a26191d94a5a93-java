...
public class Time extends ASN1Object implements ASN1Choice {
    ...
    public Time(Date date) {
        ...
        this.f12759a = (parseInt < 1950 || parseInt > 2049) ? new DERGeneralizedTime(str) : new DERUTCTime(str.substring(2));
    }
    ...
    public Date getDate() {
        try {
            ASN1Primitive aSN1Primitive = this.f12759a;
