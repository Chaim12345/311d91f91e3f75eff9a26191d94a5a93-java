...
public class NISTNamedCurves {
    ...
    static final Hashtable f12805a = new Hashtable();

    /* renamed from: b  reason: collision with root package name */
    static final Hashtable f12806b = new Hashtable();
    ...
    static void a(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        f12805a.put(str, aSN1ObjectIdentifier);
        f12806b.put(aSN1ObjectIdentifier, str);
    }

    public static X9ECParameters getByName(String str) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = (ASN1ObjectIdentifier) f12805a.get(Strings.toUpperCase(str));
    ...
    public static String getName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return (String) f12806b.get(aSN1ObjectIdentifier);
    }
    ...
    public static ASN1ObjectIdentifier getOID(String str) {
        return (ASN1ObjectIdentifier) f12805a.get(Strings.toUpperCase(str));
    }
}
