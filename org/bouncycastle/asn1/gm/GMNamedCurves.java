...
public class GMNamedCurves {
    ...
    static X9ECParametersHolder f12792a = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.gm.GMNamedCurves.1
    ...
    static X9ECParametersHolder f12793b = new X9ECParametersHolder() { // from class: org.bouncycastle.asn1.gm.GMNamedCurves.2
        @Override // org.bouncycastle.asn1.x9.X9ECParametersHolder
        protected X9ECParameters a() {
    ...
    static final Hashtable f12794c = new Hashtable();

    /* renamed from: d  reason: collision with root package name */
    static final Hashtable f12795d = new Hashtable();

    /* renamed from: e  reason: collision with root package name */
    static final Hashtable f12796e = new Hashtable();

    static {
        d("wapip192v1", GMObjectIdentifiers.wapip192v1, f12793b);
        d("sm2p256v1", GMObjectIdentifiers.sm2p256v1, f12792a);
    }
    ...
    static void d(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, X9ECParametersHolder x9ECParametersHolder) {
        f12794c.put(Strings.toLowerCase(str), aSN1ObjectIdentifier);
        f12796e.put(aSN1ObjectIdentifier, str);
        f12795d.put(aSN1ObjectIdentifier, x9ECParametersHolder);
    }
    ...
    public static X9ECParameters getByOID(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        X9ECParametersHolder x9ECParametersHolder = (X9ECParametersHolder) f12795d.get(aSN1ObjectIdentifier);
    ...
    public static String getName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return (String) f12796e.get(aSN1ObjectIdentifier);
    }

    public static Enumeration getNames() {
        return f12796e.elements();
    }

    public static ASN1ObjectIdentifier getOID(String str) {
        return (ASN1ObjectIdentifier) f12794c.get(Strings.toLowerCase(str));
    }
}
