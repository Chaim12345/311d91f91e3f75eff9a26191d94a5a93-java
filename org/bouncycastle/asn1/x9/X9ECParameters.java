...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f13061g;

    /* renamed from: h  reason: collision with root package name */
    private BigInteger f13062h;

    /* renamed from: n  reason: collision with root package name */
    private BigInteger f13063n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f13063n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        if (aSN1Sequence.size() == 6) {
            this.f13062h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.f13063n, this.f13062h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f13061g = (X9ECPoint) objectAt;
        } else {
            this.f13061g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f13061g = x9ECPoint;
        this.f13063n = bigInteger;
        this.f13062h = bigInteger2;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f13061g);
        aSN1EncodableVector.add(new ASN1Integer(this.f13063n));
        if (this.f13062h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f13062h));
        }
