...
public class GMSSPrivateKey extends ASN1Object {
    ...
    private GMSSPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        for (int i5 = 0; i5 < size3; i5++) {
            ...
            for (int i6 = 0; i6 < bArr3[i5].length; i6++) {
                bArr3[i5][i6] = ((DEROctetString) aSN1Sequence6.getObjectAt(i6)).getOctets();
            }
        }
        ...
        for (int i7 = 0; i7 < size4; i7++) {
            ...
            bArr4[i7] = new byte[aSN1Sequence8.size()];
            for (int i8 = 0; i8 < bArr4[i7].length; i8++) {
                bArr4[i7][i8] = ((DEROctetString) aSN1Sequence8.getObjectAt(i8)).getOctets();
            }
        }
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        int i7 = 0;
        while (i7 < treehashArr3.length) {
            int i8 = 0;
            while (i8 < treehashArr3[i7].length) {
                aSN1EncodableVector11.add(new DERSequence(algorithmIdentifierArr[0]));
                int i9 = treehashArr3[i7][i8].getStatInt()[1];
                aSN1EncodableVector12.add(new DEROctetString(treehashArr3[i7][i8].getStatByte()[0]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr3[i7][i8].getStatByte()[1]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr3[i7][i8].getStatByte()[2]));
                for (int i10 = 0; i10 < i9; i10++) {
                    aSN1EncodableVector12.add(new DEROctetString(treehashArr3[i7][i8].getStatByte()[i10 + 3]));
                }
                aSN1EncodableVector11.add(new DERSequence(aSN1EncodableVector12));
                aSN1EncodableVector12 = new ASN1EncodableVector();
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[0]));
                aSN1EncodableVector13.add(new ASN1Integer(i9));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[2]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[3]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[4]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[5]));
                int i11 = 0;
                while (i11 < i9) {
                    aSN1EncodableVector13.add(new ASN1Integer(treehashArr3[i7][i8].getStatInt()[i11 + 6]));
                    i11++;
        ...
        for (int i32 : iArr2) {
            aSN1EncodableVector44.add(new ASN1Integer(i32));
        }
        ...
        while (i33 < gMSSRootCalcArr.length) {
            ...
            aSN1EncodableVector48.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[0]));
            int i36 = 0;
            while (i36 < i34) {
                i36++;
                aSN1EncodableVector48.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[i36]));
            }
            for (int i37 = 0; i37 < i35; i37++) {
                aSN1EncodableVector48.add(new DEROctetString(gMSSRootCalcArr[i33].getStatByte()[i34 + 1 + i37]));
            }
            ...
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[1]));
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[2]));
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[3]));
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[4]));
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[5]));
            aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[6]));
            aSN1EncodableVector49.add(new ASN1Integer(i35));
            for (int i38 = 0; i38 < i34; i38++) {
                aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[i38 + 8]));
            }
            for (int i39 = 0; i39 < i35; i39++) {
                aSN1EncodableVector49.add(new ASN1Integer(gMSSRootCalcArr[i33].getStatInt()[i34 + 8 + i39]));
            }
            ...
            if (gMSSRootCalcArr[i33].getTreehash() != null) {
                ...
                while (i40 < gMSSRootCalcArr[i33].getTreehash().length) {
                    ...
                    aSN1EncodableVector55.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[0]));
                    aSN1EncodableVector55.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[1]));
                    aSN1EncodableVector55.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[2]));
                    int i42 = 0;
                    while (i42 < i41) {
                        aSN1EncodableVector55.add(new DEROctetString(gMSSRootCalcArr[i33].getTreehash()[i40].getStatByte()[i42 + 3]));
                        i42++;
                    ...
                    aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[0]));
                    aSN1EncodableVector56.add(new ASN1Integer(i41));
                    aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[2]));
                    aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[3]));
                    aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[4]));
                    aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[5]));
                    int i43 = 0;
                    while (i43 < i41) {
                        aSN1EncodableVector56.add(new ASN1Integer(gMSSRootCalcArr[i33].getTreehash()[i40].getStatInt()[i43 + 6]));
                        i43++;
                        i41 = i41;
            ...
            if (gMSSRootCalcArr[i33].getRetain() != null) {
                for (int i44 = 0; i44 < gMSSRootCalcArr[i33].getRetain().length; i44++) {
                    for (int i45 = 0; i45 < gMSSRootCalcArr[i33].getRetain()[i44].size(); i45++) {
                        aSN1EncodableVector63.add(new DEROctetString((byte[]) gMSSRootCalcArr[i33].getRetain()[i44].elementAt(i45)));
                    }
        ...
        for (int i46 = 0; i46 < gMSSRootSigArr.length; i46++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector68.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[0]));
            aSN1EncodableVector68.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[1]));
            aSN1EncodableVector68.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[2]));
            aSN1EncodableVector68.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[3]));
            aSN1EncodableVector68.add(new DEROctetString(gMSSRootSigArr[i46].getStatByte()[4]));
            aSN1EncodableVector67.add(new DERSequence(aSN1EncodableVector68));
            aSN1EncodableVector68 = new ASN1EncodableVector();
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[0]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[1]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[2]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[3]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[4]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[5]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[6]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[7]));
            aSN1EncodableVector69.add(new ASN1Integer(gMSSRootSigArr[i46].getStatInt()[8]));
        ...
        for (int i47 = 0; i47 < gMSSParameters.getHeightOfTrees().length; i47++) {
            aSN1EncodableVector71.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i47]));
            aSN1EncodableVector72.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i47]));
            aSN1EncodableVector73.add(new ASN1Integer(gMSSParameters.getK()[i47]));
        }
