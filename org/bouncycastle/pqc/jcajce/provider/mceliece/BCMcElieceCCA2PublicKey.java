...
public class BCMcElieceCCA2PublicKey implements CipherParameters, PublicKey {
    ...
    public byte[] getEncoded() {
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.mcElieceCca2), new McElieceCCA2PublicKey(this.params.getN(), this.params.getT(), this.params.getG(), Utils.a(this.params.getDigest()))).getEncoded();
