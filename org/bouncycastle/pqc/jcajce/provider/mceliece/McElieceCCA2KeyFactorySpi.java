        ...
        try {
            ...
            try {
                if (PQCObjectIdentifiers.mcElieceCca2.equals((ASN1Primitive) privateKeyInfo.getPrivateKeyAlgorithm().getAlgorithm())) {
                    ...
                    return new BCMcElieceCCA2PrivateKey(new McElieceCCA2PrivateKeyParameters(mcElieceCCA2PrivateKey.getN(), mcElieceCCA2PrivateKey.getK(), mcElieceCCA2PrivateKey.getField(), mcElieceCCA2PrivateKey.getGoppaPoly(), mcElieceCCA2PrivateKey.getP(), Utils.b(mcElieceCCA2PrivateKey.getDigest()).getAlgorithmName()));
                }
        ...
        try {
            ...
            try {
                if (PQCObjectIdentifiers.mcElieceCca2.equals((ASN1Primitive) subjectPublicKeyInfo.getAlgorithm().getAlgorithm())) {
                    ...
                    return new BCMcElieceCCA2PublicKey(new McElieceCCA2PublicKeyParameters(mcElieceCCA2PublicKey.getN(), mcElieceCCA2PublicKey.getT(), mcElieceCCA2PublicKey.getG(), Utils.b(mcElieceCCA2PublicKey.getDigest()).getAlgorithmName()));
                }
