...
class NTT {
        ...
        for (int i2 = 0; i2 < 10; i2 += 2) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                while (i6 < 1023) {
                    ...
                    short s2 = sArr2[i5];
                    sArr[i6] = (short) (i7 + i9);
                    sArr[i8] = Reduce.b(s2 * ((i7 + 36867) - i9));
                    i6 += i3 * 2;
                    i5 = i10;
                }
            }
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                ...
                while (i14 < 1023) {
                    ...
                    int i18 = i13 + 1;
                    short s3 = sArr2[i13];
                    sArr[i14] = Reduce.a((short) (i15 + i17));
                    sArr[i16] = Reduce.b(s3 * ((i15 + 36867) - i17));
                    i14 += i11 * 2;
                    i13 = i18;
                }
            }
    ...
    public static void c(short[] sArr, short[] sArr2) {
        for (int i2 = 0; i2 < 1024; i2++) {
            sArr[i2] = Reduce.b((sArr[i2] & UShort.MAX_VALUE) * (65535 & sArr2[i2]));
        }
    }
}
