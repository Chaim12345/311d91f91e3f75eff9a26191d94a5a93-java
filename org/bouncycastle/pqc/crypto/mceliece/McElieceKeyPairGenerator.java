...
public class McElieceKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair() {
        ...
        GF2mField gF2mField = new GF2mField(this.f14533m, this.fieldPoly);
        PolynomialGF2mSmallM polynomialGF2mSmallM = new PolynomialGF2mSmallM(gF2mField, this.f14535t, 'I', this.random);
        ...
        Permutation permutation2 = new Permutation(this.f14534n, this.random);
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new McEliecePublicKeyParameters(this.f14534n, this.f14535t, (GF2Matrix) ((GF2Matrix) createRandomRegularMatrixAndItsInverse[0].rightMultiply(extendLeftCompactForm)).rightMultiply(permutation2)), (AsymmetricKeyParameter) new McEliecePrivateKeyParameters(this.f14534n, numRows, gF2mField, polynomialGF2mSmallM, permutation, permutation2, createRandomRegularMatrixAndItsInverse[1]));
    }

    private void initialize(KeyGenerationParameters keyGenerationParameters) {
        this.mcElieceParams = (McElieceKeyGenerationParameters) keyGenerationParameters;
        this.random = keyGenerationParameters.getRandom();
        this.f14533m = this.mcElieceParams.getParameters().getM();
        this.f14534n = this.mcElieceParams.getParameters().getN();
        this.f14535t = this.mcElieceParams.getParameters().getT();
