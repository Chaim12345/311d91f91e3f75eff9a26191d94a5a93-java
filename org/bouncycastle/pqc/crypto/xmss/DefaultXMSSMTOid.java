...
public final class DefaultXMSSMTOid implements XMSSOid {
    ...
    private static String createKey(String str, int i2, int i3, int i4, int i5, int i6) {
        ...
        return str + HelpFormatter.DEFAULT_OPT_PREFIX + i2 + HelpFormatter.DEFAULT_OPT_PREFIX + i3 + HelpFormatter.DEFAULT_OPT_PREFIX + i4 + HelpFormatter.DEFAULT_OPT_PREFIX + i5 + HelpFormatter.DEFAULT_OPT_PREFIX + i6;
    }
