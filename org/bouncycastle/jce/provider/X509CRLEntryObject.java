...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f13834c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f13834c.equals(((X509CRLEntryObject) obj).f13834c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() {
        try {
            return this.f13834c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f13834c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f13834c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f13834c.getExtensions() != null;
    }
