...
public class IEEE1609dot2 {
    ...
    static {
        ...
        OERDefinition.Builder seq9 = OERDefinition.seq(builder5.label("hashId"), mutableBuilder.label("tbsData"), choice5.label("signer"), builder7.label("signature"));
        SignedData = seq9;
        ...
        Countersignature = OERDefinition.seq(builder6.label("protocolVersion"), choice6.label(FirebaseAnalytics.Param.CONTENT));
        OERDefinition.Builder seq10 = OERDefinition.seq(builder6.label("protocolVersion"), choice6.label(FirebaseAnalytics.Param.CONTENT));
        Ieee1609Dot2Data = seq10;
        OERDefinition.Builder seq11 = OERDefinition.seq(OERDefinition.optional(seq10.label(Constants.ScionAnalytics.MessageType.DATA_MESSAGE), choice.label("extDataHash")), OERDefinition.extension());
