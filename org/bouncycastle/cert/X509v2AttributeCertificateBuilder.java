...
public class X509v2AttributeCertificateBuilder {
    ...
    public X509v2AttributeCertificateBuilder(AttributeCertificateHolder attributeCertificateHolder, AttributeCertificateIssuer attributeCertificateIssuer, BigInteger bigInteger, Date date, Date date2) {
        ...
        this.acInfoGen.setHolder(attributeCertificateHolder.f13067a);
        this.acInfoGen.setIssuer(AttCertIssuer.getInstance(attributeCertificateIssuer.f13068a));
    ...
    public X509v2AttributeCertificateBuilder(X509AttributeCertificateHolder x509AttributeCertificateHolder) {
        ...
        this.acInfoGen.setIssuer(AttCertIssuer.getInstance(x509AttributeCertificateHolder.getIssuer().f13068a));
        ...
        this.acInfoGen.setHolder(x509AttributeCertificateHolder.getHolder().f13067a);
        boolean[] issuerUniqueID = x509AttributeCertificateHolder.getIssuerUniqueID();
        if (issuerUniqueID != null) {
            this.acInfoGen.setIssuerUniqueID(CertUtils.c(issuerUniqueID));
        }
        Attribute[] attributes = x509AttributeCertificateHolder.getAttributes();
        for (int i2 = 0; i2 != attributes.length; i2++) {
            this.acInfoGen.addAttribute(attributes[i2]);
        }
        this.extGenerator = new ExtensionsGenerator();
    ...
    public X509v2AttributeCertificateBuilder addExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z, ASN1Encodable aSN1Encodable) {
        CertUtils.a(this.extGenerator, aSN1ObjectIdentifier, z, aSN1Encodable);
        return this;
    }
    ...
    public X509AttributeCertificateHolder build(ContentSigner contentSigner) {
        ...
        return CertUtils.f(contentSigner, this.acInfoGen.generateAttributeCertificateInfo());
    }
    ...
    public X509v2AttributeCertificateBuilder removeExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.extGenerator = CertUtils.d(this.extGenerator, aSN1ObjectIdentifier);
        return this;
    }

    public X509v2AttributeCertificateBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z, ASN1Encodable aSN1Encodable) {
        try {
            this.extGenerator = CertUtils.e(this.extGenerator, new Extension(aSN1ObjectIdentifier, z, aSN1Encodable.toASN1Primitive().getEncoded(ASN1Encoding.DER)));
            return this;
    ...
    public X509v2AttributeCertificateBuilder replaceExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z, byte[] bArr) {
        this.extGenerator = CertUtils.e(this.extGenerator, new Extension(aSN1ObjectIdentifier, z, bArr));
        return this;
    }

    public X509v2AttributeCertificateBuilder replaceExtension(Extension extension) {
        this.extGenerator = CertUtils.e(this.extGenerator, extension);
        return this;
    }

    public void setIssuerUniqueId(boolean[] zArr) {
        this.acInfoGen.setIssuerUniqueID(CertUtils.c(zArr));
    }
}
