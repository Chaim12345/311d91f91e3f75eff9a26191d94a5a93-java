...
public class CertPath {
    ...
    public CertPathValidationResult evaluate(CertPathValidation[] certPathValidationArr) {
        CertPathValidationContext certPathValidationContext = new CertPathValidationContext(CertPathUtils.a(this.certificates));
        ...
        for (int i2 = 0; i2 != certPathValidationArr.length; i2++) {
            ...
            while (length >= 0) {
                try {
                    ...
                    certPathValidationResultBuilder.addException(length, i2, e2);
                }
                length--;
            }
        }
