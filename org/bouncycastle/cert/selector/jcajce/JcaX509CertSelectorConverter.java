...
public class JcaX509CertSelectorConverter {
    ...
    public X509CertSelector a(X500Name x500Name, BigInteger bigInteger, byte[] bArr) {
    ...
    public X509CertSelector getCertSelector(X509CertificateHolderSelector x509CertificateHolderSelector) {
        return a(x509CertificateHolderSelector.getIssuer(), x509CertificateHolderSelector.getSerialNumber(), x509CertificateHolderSelector.getSubjectKeyIdentifier());
    }
}
