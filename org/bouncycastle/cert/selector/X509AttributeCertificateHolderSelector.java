                                            ...
                                            for (Targets targets : targetsObjects) {
                                                ...
                                                while (true) {
                                                    if (i2 >= targets2.length) {
                                                        break;
                                                    } else if (this.targetNames.contains(GeneralName.getInstance(targets2[i2].getTargetName()))) {
                                                        z = true;
                                                        break;
                                                    } else {
                                                        i2++;
                                        ...
                                        for (Targets targets3 : targetsObjects) {
                                            ...
                                            while (true) {
                                                if (i3 >= targets4.length) {
                                                    break;
                                                } else if (this.targetGroups.contains(GeneralName.getInstance(targets4[i3].getTargetGroup()))) {
                                                    z2 = true;
                                                    break;
                                                } else {
                                                    i3++;
