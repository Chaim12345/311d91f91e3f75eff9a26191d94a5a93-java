...
public class DefaultDigestAlgorithmIdentifierFinder implements DigestAlgorithmIdentifierFinder {
    ...
    static {
        ...
        digestNameToOids.put("SHA-1", aSN1ObjectIdentifier2);
        digestNameToOids.put("SHA-224", aSN1ObjectIdentifier6);
        digestNameToOids.put("SHA-256", aSN1ObjectIdentifier8);
        digestNameToOids.put("SHA-384", aSN1ObjectIdentifier10);
        ...
        digestNameToOids.put(MessageDigestAlgorithms.SHA3_224, aSN1ObjectIdentifier22);
        digestNameToOids.put("SHA3-256", aSN1ObjectIdentifier24);
        digestNameToOids.put(MessageDigestAlgorithms.SHA3_384, aSN1ObjectIdentifier26);
        digestNameToOids.put(MessageDigestAlgorithms.SHA3_512, aSN1ObjectIdentifier28);
        ...
        digestNameToOids.put(MessageDigestAlgorithms.MD2, aSN1ObjectIdentifier18);
        digestNameToOids.put("MD4", aSN1ObjectIdentifier4);
        digestNameToOids.put(MessageDigestAlgorithms.MD5, aSN1ObjectIdentifier20);
