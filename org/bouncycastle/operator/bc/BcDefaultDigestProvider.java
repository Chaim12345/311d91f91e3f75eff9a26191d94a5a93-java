...
public class BcDefaultDigestProvider implements BcDigestProvider {
    ...
    private static class AdjustedXof implements Xof {
        ...
        public int doFinal(byte[] bArr, int i2, int i3) {
            return this.xof.doFinal(bArr, i2, i3);
        }

        @Override // org.bouncycastle.crypto.Xof
        public int doOutput(byte[] bArr, int i2, int i3) {
            return this.xof.doOutput(bArr, i2, i3);
        }

        @Override // org.bouncycastle.crypto.Digest
        public String getAlgorithmName() {
            return this.xof.getAlgorithmName() + HelpFormatter.DEFAULT_OPT_PREFIX + this.length;
        }
