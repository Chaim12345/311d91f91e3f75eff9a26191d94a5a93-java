...
public class ClientHello {
    ...
    public ClientHello(ProtocolVersion protocolVersion, byte[] bArr, byte[] bArr2, byte[] bArr3, int[] iArr, Hashtable hashtable, int i2) {
    ...
    private static ClientHello implParse(ByteArrayInputStream byteArrayInputStream, OutputStream outputStream) {
        ...
        if (Arrays.contains(TlsUtils.readUint8ArrayWithUint8Length(teeInputStream, 1), (short) 0)) {
            if (byteArrayInputStream.available() > 0) {
                ...
                hashtable = TlsProtocol.L(readOpaque16);
            } else {
                hashtable = null;
            }
    ...
    public static ClientHello parse(ByteArrayInputStream byteArrayInputStream, OutputStream outputStream) {
        try {
            ...
            throw new TlsFatalAlert((short) 50, (Throwable) e3);
        }
    }
    ...
    public void encode(TlsContext tlsContext, OutputStream outputStream) {
        ...
        TlsProtocol.d0(outputStream, this.extensions, this.bindersSize);
    }
