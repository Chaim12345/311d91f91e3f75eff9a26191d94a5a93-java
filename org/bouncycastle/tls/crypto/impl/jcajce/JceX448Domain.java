...
public class JceX448Domain implements TlsECDomain {
    ...
    protected final JcaTlsCrypto f15047a;

    public JceX448Domain(JcaTlsCrypto jcaTlsCrypto) {
        this.f15047a = jcaTlsCrypto;
    }

    public JceTlsSecret calculateECDHAgreement(PrivateKey privateKey, PublicKey publicKey) {
        try {
            byte[] calculateKeyAgreement = this.f15047a.calculateKeyAgreement(XDHParameterSpec.X448, privateKey, publicKey, "TlsPremasterSecret");
            ...
            return this.f15047a.a(calculateKeyAgreement);
    ...
    public PublicKey decodePublicKey(byte[] bArr) {
        return XDHUtil.a(this.f15047a, XDHParameterSpec.X448, EdECObjectIdentifiers.id_X448, bArr);
    }
    ...
    public KeyPair generateKeyPair() {
        try {
            KeyPairGenerator createKeyPairGenerator = this.f15047a.getHelper().createKeyPairGenerator(XDHParameterSpec.X448);
            createKeyPairGenerator.initialize(448, this.f15047a.getSecureRandom());
