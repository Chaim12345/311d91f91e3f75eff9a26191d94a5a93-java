...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    ECKeyPairGenerator f13663b;

    /* renamed from: c  reason: collision with root package name */
    String f13664c;

    /* renamed from: d  reason: collision with root package name */
    ECKeyGenerationParameters f13665d;
    ...
    public KeyPairGeneratorSpi() {
        super("ECGOST3410");
        this.f13662a = null;
        this.f13663b = new ECKeyPairGenerator();
        this.f13664c = "ECGOST3410";
        this.f13666e = false;
    }
    ...
    private void init(GOST3410ParameterSpec gOST3410ParameterSpec, SecureRandom secureRandom) {
        ...
        this.f13662a = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(publicKeyParamSet), byOIDX9.getCurve(), byOIDX9.getG(), byOIDX9.getN(), byOIDX9.getH(), byOIDX9.getSeed());
        ...
        this.f13665d = eCKeyGenerationParameters;
        this.f13663b.init(eCKeyGenerationParameters);
        this.f13666e = true;
    }
    ...
    public KeyPair generateKeyPair() {
        if (this.f13666e) {
            AsymmetricCipherKeyPair generateKeyPair = this.f13663b.generateKeyPair();
            ECPublicKeyParameters eCPublicKeyParameters = (ECPublicKeyParameters) generateKeyPair.getPublic();
            ECPrivateKeyParameters eCPrivateKeyParameters = (ECPrivateKeyParameters) generateKeyPair.getPrivate();
            Object obj = this.f13662a;
            if (obj instanceof ECParameterSpec) {
                ECParameterSpec eCParameterSpec = (ECParameterSpec) obj;
                BCECGOST3410PublicKey bCECGOST3410PublicKey = new BCECGOST3410PublicKey(this.f13664c, eCPublicKeyParameters, eCParameterSpec);
                return new KeyPair(bCECGOST3410PublicKey, new BCECGOST3410PrivateKey(this.f13664c, eCPrivateKeyParameters, bCECGOST3410PublicKey, eCParameterSpec));
            } else if (obj == null) {
                return new KeyPair(new BCECGOST3410PublicKey(this.f13664c, eCPublicKeyParameters), new BCECGOST3410PrivateKey(this.f13664c, eCPrivateKeyParameters));
            } else {
                java.security.spec.ECParameterSpec eCParameterSpec2 = (java.security.spec.ECParameterSpec) obj;
                BCECGOST3410PublicKey bCECGOST3410PublicKey2 = new BCECGOST3410PublicKey(this.f13664c, eCPublicKeyParameters, eCParameterSpec2);
                return new KeyPair(bCECGOST3410PublicKey2, new BCECGOST3410PrivateKey(this.f13664c, eCPrivateKeyParameters, bCECGOST3410PublicKey2, eCParameterSpec2));
            }
        }
    ...
    public void initialize(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) {
        ...
        if (!(algorithmParameterSpec instanceof ECParameterSpec)) {
            if (algorithmParameterSpec instanceof java.security.spec.ECParameterSpec) {
                ...
                this.f13662a = algorithmParameterSpec;
                ...
                this.f13665d = eCKeyGenerationParameters2;
                this.f13663b.init(eCKeyGenerationParameters2);
                this.f13666e = true;
            }
