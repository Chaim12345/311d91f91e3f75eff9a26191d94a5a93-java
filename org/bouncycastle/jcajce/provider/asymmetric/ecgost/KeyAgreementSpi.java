...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    static AsymmetricKeyParameter e(PublicKey publicKey) {
        return publicKey instanceof BCECPublicKey ? ((BCECGOST3410PublicKey) publicKey).a() : ECUtil.generatePublicKeyParameter(publicKey);
    }
    ...
    protected Key engineDoPhase(Key key, boolean z) {
        if (this.parameters == null) {
            ...
            try {
                ...
                throw new InvalidKeyException(this, "calculation failed: " + e2.getMessage()) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi.1
