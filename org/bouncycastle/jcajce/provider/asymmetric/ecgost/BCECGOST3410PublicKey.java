...
public class BCECGOST3410PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCECGOST3410PublicKey) {
            ...
            return this.ecPublicKey.getQ().equals(bCECGOST3410PublicKey.ecPublicKey.getQ()) && b().equals(bCECGOST3410PublicKey.b());
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        ...
        try {
            return KeyUtil.getEncodedSubjectPublicKeyInfo(new SubjectPublicKeyInfo(new AlgorithmIdentifier(CryptoProObjectIdentifiers.gostR3410_2001, c2), new DEROctetString(bArr)));
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public String toString() {
        return ECUtil.publicKeyToString(this.algorithm, this.ecPublicKey.getQ(), b());
    }
}
