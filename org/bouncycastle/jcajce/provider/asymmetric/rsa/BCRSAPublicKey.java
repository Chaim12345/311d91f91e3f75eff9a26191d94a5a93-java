...
public class BCRSAPublicKey implements RSAPublicKey {
    ...
    static final AlgorithmIdentifier f13707a = new AlgorithmIdentifier(PKCSObjectIdentifiers.rsaEncryption, DERNull.INSTANCE);
    ...
    public BCRSAPublicKey(RSAPublicKey rSAPublicKey) {
        this.algorithmIdentifier = f13707a;
    ...
    private void writeObject(ObjectOutputStream objectOutputStream) {
        ...
        if (this.algorithmIdentifier.equals(f13707a)) {
            return;
        }
