...
public class EdEC {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            d(configurableProvider, aSN1ObjectIdentifier3, "XDH", new KeyFactorySpi.X448());
            d(configurableProvider, aSN1ObjectIdentifier4, "XDH", new KeyFactorySpi.X25519());
            d(configurableProvider, aSN1ObjectIdentifier, "EDDSA", new KeyFactorySpi.Ed448());
            d(configurableProvider, aSN1ObjectIdentifier2, "EDDSA", new KeyFactorySpi.Ed25519());
        }
    }
