...
public class ECUtils {
    ...
    public static AsymmetricKeyParameter a(PublicKey publicKey) {
        return publicKey instanceof BCECPublicKey ? ((BCECPublicKey) publicKey).a() : ECUtil.generatePublicKeyParameter(publicKey);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static X9ECParameters b(ECGenParameterSpec eCGenParameterSpec, ProviderConfiguration providerConfiguration) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static X9ECParameters d(String str, ProviderConfiguration providerConfiguration) {
