        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (z) {
                ...
                if (mQVPrivateKey.getEphemeralPublicKey() != null) {
                    eCPublicKeyParameters = (ECPublicKeyParameters) ECUtils.a(mQVPrivateKey.getEphemeralPublicKey());
                }
            } else {
                ...
                eCPublicKeyParameters = mQVParameterSpec.getEphemeralPublicKey() != null ? (ECPublicKeyParameters) ECUtils.a(mQVParameterSpec.getEphemeralPublicKey()) : null;
                this.mqvParameters = mQVParameterSpec;
                this.f13714c = mQVParameterSpec.getUserKeyingMaterial();
            ...
            if (!(key instanceof PrivateKey)) {
            ...
            } else if (this.f13713b == null && (algorithmParameterSpec instanceof UserKeyingMaterialSpec)) {
                ...
                this.f13714c = algorithmParameterSpec instanceof UserKeyingMaterialSpec ? ((UserKeyingMaterialSpec) algorithmParameterSpec).getUserKeyingMaterial() : null;
            ...
            ECPublicKeyParameters eCPublicKeyParameters2 = dHUParameterSpec.getEphemeralPublicKey() != null ? (ECPublicKeyParameters) ECUtils.a(dHUParameterSpec.getEphemeralPublicKey()) : null;
        ...
        if (this.parameters == null) {
            ...
            if (obj instanceof ECMQVBasicAgreement) {
                if (key instanceof MQVPublicKey) {
                    ...
                    a2 = new MQVPublicParameters((ECPublicKeyParameters) ECUtils.a(mQVPublicKey.getStaticKey()), (ECPublicKeyParameters) ECUtils.a(mQVPublicKey.getEphemeralKey()));
                } else {
                    a2 = new MQVPublicParameters((ECPublicKeyParameters) ECUtils.a((PublicKey) key), (ECPublicKeyParameters) ECUtils.a(this.mqvParameters.getOtherPartyEphemeralKey()));
                }
            } else if (obj instanceof ECDHCUnifiedAgreement) {
                a2 = new ECDHUPublicParameters((ECPublicKeyParameters) ECUtils.a((PublicKey) key), (ECPublicKeyParameters) ECUtils.a(this.dheParameters.getOtherPartyEphemeralKey()));
            ...
            try {
                ...
                if (obj2 instanceof BasicAgreement) {
                    this.result = e(((BasicAgreement) obj2).calculateAgreement(a2));
                    return null;
                }
                this.result = ((ECDHCUnifiedAgreement) obj2).calculateAgreement(a2);
                return null;
            } catch (Exception e2) {
                throw new InvalidKeyException(this, "calculation failed: " + e2.getMessage()) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
