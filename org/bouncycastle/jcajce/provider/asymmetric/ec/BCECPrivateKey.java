...
public class BCECPrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f13648d;
    ...
    public BCECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.algorithm = str;
        this.f13648d = eCPrivateKeySpec.getS();
    ...
    public BCECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECPublicKey bCECPublicKey, ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f13648d = eCPrivateKeyParameters.getD();
        this.configuration = providerConfiguration;
    ...
    public BCECPrivateKey(String str, BCECPrivateKey bCECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f13648d = bCECPrivateKey.f13648d;
    ...
    public BCECPrivateKey(String str, org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f13648d = eCPrivateKeySpec.getD();
    ...
    public BCECPrivateKey(ECPrivateKey eCPrivateKey, ProviderConfiguration providerConfiguration) {
        this.algorithm = "EC";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f13648d = eCPrivateKey.getS();
    ...
    public byte[] getEncoded() {
        X962Parameters c2 = ECUtils.c(this.ecSpec, this.withCompression);
        ECParameterSpec eCParameterSpec = this.ecSpec;
        ...
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, c2), this.publicKey != null ? new org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), this.publicKey, c2) : new org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, getS(), c2)).getEncoded(ASN1Encoding.DER);
        } catch (IOException unused) {
            return null;
        }
    }
    ...
    public String toString() {
        return ECUtil.privateKeyToString("EC", this.f13648d, a());
    }
}
