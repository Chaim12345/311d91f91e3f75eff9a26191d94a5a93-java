...
public class BCECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCECPublicKey) {
            ...
            return this.ecPublicKey.getQ().equals(bCECPublicKey.ecPublicKey.getQ()) && b().equals(bCECPublicKey.b());
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ECUtils.c(this.ecSpec, z)), this.ecPublicKey.getQ().getEncoded(z));
    }
    ...
    public ECPoint getQ() {
        ECPoint q2 = this.ecPublicKey.getQ();
    ...
    public int hashCode() {
        return this.ecPublicKey.getQ().hashCode() ^ b().hashCode();
    }
    ...
    public String toString() {
        return ECUtil.publicKeyToString("EC", this.ecPublicKey.getQ(), b());
    }
}
