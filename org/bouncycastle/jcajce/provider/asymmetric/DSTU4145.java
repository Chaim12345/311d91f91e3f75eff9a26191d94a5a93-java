...
public class DSTU4145 {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            d(configurableProvider, aSN1ObjectIdentifier, "DSTU4145", new KeyFactorySpi());
            f(configurableProvider, aSN1ObjectIdentifier, "DSTU4145");
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = UAObjectIdentifiers.dstu4145be;
            d(configurableProvider, aSN1ObjectIdentifier2, "DSTU4145", new KeyFactorySpi());
            f(configurableProvider, aSN1ObjectIdentifier2, "DSTU4145");
            ...
            b(configurableProvider, "GOST3411", "DSTU4145LE", "org.bouncycastle.jcajce.provider.asymmetric.dstu.SignatureSpiLe", aSN1ObjectIdentifier);
            b(configurableProvider, "GOST3411", "DSTU4145", "org.bouncycastle.jcajce.provider.asymmetric.dstu.SignatureSpi", aSN1ObjectIdentifier2);
        }
    }
}
