...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private TBSCertList.CRLEntry f13723c;
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f13723c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            ...
            return this.f13723c.equals(x509CRLEntryObject.f13723c);
        }
    ...
    public byte[] getEncoded() {
        try {
            return this.f13723c.getEncoded(ASN1Encoding.DER);
    ...
    public Date getRevocationDate() {
        return this.f13723c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f13723c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f13723c.getExtensions() != null;
    }
