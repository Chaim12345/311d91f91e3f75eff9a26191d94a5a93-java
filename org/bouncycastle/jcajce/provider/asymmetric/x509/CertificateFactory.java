...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private Certificate doGenerateCertificate(InputStream inputStream, boolean z) {
        ...
        try {
            ...
            throw new ExCertificateException(this, "parsing issue: " + e2.getMessage(), e2);
        }
    }
    ...
    private CRL getCRL() {
        ...
        return a(CertificateList.getInstance(aSN1Set2.getObjectAt(i2)));
    }
    ...
    private CRL getCRL(ASN1Sequence aSN1Sequence) {
        ...
        return a(CertificateList.getInstance(aSN1Sequence));
    }
    ...
    private CRL readPEMCRL(InputStream inputStream, boolean z) {
        return getCRL(PEM_CRL_PARSER.a(inputStream, z));
    }

    private Certificate readPEMCertificate(InputStream inputStream, boolean z) {
        return getCertificate(PEM_CERT_PARSER.a(inputStream, z));
    }
    ...
    public Iterator engineGetCertPathEncodings() {
        return PKIXCertPath.f13722a.iterator();
    }
}
