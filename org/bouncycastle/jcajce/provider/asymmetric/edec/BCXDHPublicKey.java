...
public class BCXDHPublicKey implements XDHPublicKey {
    ...
    transient AsymmetricKeyParameter f13677a;
    ...
    public BCXDHPublicKey(AsymmetricKeyParameter asymmetricKeyParameter) {
        this.f13677a = asymmetricKeyParameter;
    }
    ...
    public BCXDHPublicKey(byte[] bArr, byte[] bArr2) {
        ...
        this.f13677a = x25519PublicKeyParameters;
    }

    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        byte[] octets = subjectPublicKeyInfo.getPublicKeyData().getOctets();
        this.f13677a = EdECObjectIdentifiers.id_X448.equals((ASN1Primitive) subjectPublicKeyInfo.getAlgorithm().getAlgorithm()) ? new X448PublicKeyParameters(octets) : new X25519PublicKeyParameters(octets);
    }
    ...
    public String getAlgorithm() {
        return this.f13677a instanceof X448PublicKeyParameters ? XDHParameterSpec.X448 : XDHParameterSpec.X25519;
    }

    @Override // java.security.Key
    public byte[] getEncoded() {
        if (this.f13677a instanceof X448PublicKeyParameters) {
            byte[] bArr = KeyFactorySpi.f13678a;
            byte[] bArr2 = new byte[bArr.length + 56];
            System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
            ((X448PublicKeyParameters) this.f13677a).encode(bArr2, bArr.length);
            return bArr2;
        }
        byte[] bArr3 = KeyFactorySpi.f13679b;
        byte[] bArr4 = new byte[bArr3.length + 32];
        System.arraycopy(bArr3, 0, bArr4, 0, bArr3.length);
        ((X25519PublicKeyParameters) this.f13677a).encode(bArr4, bArr3.length);
        return bArr4;
    }
    ...
    public byte[] getUEncoding() {
        AsymmetricKeyParameter asymmetricKeyParameter = this.f13677a;
    ...
    public String toString() {
        return Utils.b("Public Key", getAlgorithm(), this.f13677a);
    }
}
