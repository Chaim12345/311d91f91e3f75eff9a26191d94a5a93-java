...
public class BCECGOST3410_2012PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            int i2 = algorithm.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
            int i3 = i2 * 2;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCECGOST3410_2012PublicKey) {
            ...
            return this.ecPublicKey.getQ().equals(bCECGOST3410_2012PublicKey.ecPublicKey.getQ()) && b().equals(bCECGOST3410_2012PublicKey.b());
        }
        return false;
    }
