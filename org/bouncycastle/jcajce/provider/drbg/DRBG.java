...
public class DRBG {
        ...
        private class SignallingEntropySource implements EntropySource {
            ...
            private class EntropyGatherer implements Runnable {
                ...
                public void run() {
                    ...
                    for (int i3 = 0; i3 < SignallingEntropySource.this.byteLength / 8; i3++) {
                        sleep(j2);
                    ...
                    int i4 = SignallingEntropySource.this.byteLength - ((SignallingEntropySource.this.byteLength / 8) * 8);
                    if (i4 != 0) {
                        sleep(j2);
                        byte[] generateSeed2 = HybridSecureRandom.this.baseRandom.generateSeed(i4);
            ...
            SignallingEntropySource(int i2) {
        ...
        HybridSecureRandom() {
            ...
            this.drbg = new SP800SecureRandomBuilder(new EntropySourceProvider() { // from class: org.bouncycastle.jcajce.provider.drbg.DRBG.HybridSecureRandom.1
                ...
                public EntropySource get(int i2) {
                    return new SignallingEntropySource(i2);
                }
    ...
    public static class URLSeededSecureRandom extends SecureRandom {
        ...
        URLSeededSecureRandom(final URL url) {
            super(null, new HybridRandomProvider());
            this.seedStream = (InputStream) AccessController.doPrivileged(new PrivilegedAction<InputStream>(this) { // from class: org.bouncycastle.jcajce.provider.drbg.DRBG.URLSeededSecureRandom.1
        ...
        private int privilegedRead(final byte[] bArr, final int i2, final int i3) {
            return ((Integer) AccessController.doPrivileged(new PrivilegedAction<Integer>() { // from class: org.bouncycastle.jcajce.provider.drbg.DRBG.URLSeededSecureRandom.2
                ...
                public Integer run() {
                    try {
                        return Integer.valueOf(URLSeededSecureRandom.this.seedStream.read(bArr, i2, i3));
                    } catch (IOException unused) {
        ...
        public byte[] generateSeed(int i2) {
            ...
            synchronized (this) {
                ...
                int i3 = 0;
                while (i3 != i2) {
                    int privilegedRead = privilegedRead(bArr, i3, i2 - i3);
                    if (privilegedRead <= -1) {
                        break;
                    }
                    i3 += privilegedRead;
