...
public final class AES {
    ...
    public static class AlgParamGenCCM extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() {
            ...
            if (this.f13780a == null) {
                this.f13780a = new SecureRandom();
            }
            this.f13780a.nextBytes(bArr);
            try {
                AlgorithmParameters a2 = a("CCM");
                a2.init(new CCMParameters(bArr, 12).getEncoded());
                return a2;
            } catch (Exception e2) {
                throw new RuntimeException(e2.getMessage());
            }
    ...
    public static class AlgParamGenGCM extends BaseAlgorithmParameterGenerator {
        ...
        protected AlgorithmParameters engineGenerateParameters() {
            ...
            try {
                ...
                a2.init(new GCMParameters(bArr, 16).getEncoded());
                return a2;
            } catch (Exception e2) {
                throw new RuntimeException(e2.getMessage());
            }
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            b(configurableProvider, "AES", str + "$AESGMAC", str + "$KeyGen128");
            c(configurableProvider, "AES", str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }
