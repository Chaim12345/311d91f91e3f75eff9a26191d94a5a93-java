...
public class PBEPBKDF2 {
    ...
    public static class AlgParams extends BaseAlgorithmParameters {
        ...
        PBKDF2Params f13770a;

        @Override // org.bouncycastle.jcajce.provider.symmetric.util.BaseAlgorithmParameters
        protected AlgorithmParameterSpec b(Class cls) {
            if (cls == PBEParameterSpec.class || cls == AlgorithmParameterSpec.class) {
                return new PBEParameterSpec(this.f13770a.getSalt(), this.f13770a.getIterationCount().intValue());
            }
        ...
        protected byte[] engineGetEncoded() {
            try {
                return this.f13770a.getEncoded(ASN1Encoding.DER);
        ...
        protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) {
            ...
            this.f13770a = new PBKDF2Params(pBEParameterSpec.getSalt(), pBEParameterSpec.getIterationCount());
        }

        @Override // java.security.AlgorithmParametersSpi
        protected void engineInit(byte[] bArr) {
            this.f13770a = PBKDF2Params.getInstance(ASN1Primitive.fromByteArray(bArr));
        }
            ...
            if (keySpec instanceof PBEKeySpec) {
                ...
                if (pBEKeySpec.getSalt() == null) {
                    ...
                    if (pBEKeySpec instanceof PBKDF2KeySpec) {
                        ...
                        return new BCPBEKey(this.f13785a, this.f13786b, this.scheme, digestCode, keyLength, -1, pBEKeySpec, PBE.Util.makePBEMacParameters(pBEKeySpec, this.scheme, digestCode, keyLength));
                    }
                    int i2 = this.defaultDigest;
                    int keyLength2 = pBEKeySpec.getKeyLength();
                    return new BCPBEKey(this.f13785a, this.f13786b, this.scheme, i2, keyLength2, -1, pBEKeySpec, PBE.Util.makePBEMacParameters(pBEKeySpec, this.scheme, i2, keyLength2));
                } else {
