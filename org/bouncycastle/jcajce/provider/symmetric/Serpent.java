...
public final class Serpent {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            b(configurableProvider, "SERPENT", str + "$SerpentGMAC", str + "$KeyGen");
            b(configurableProvider, "TNEPRES", str + "$TSerpentGMAC", str + "$TKeyGen");
            c(configurableProvider, "SERPENT", str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }
