...
public final class SEED {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "SEED", str + "$CMAC", str + "$KeyGen");
            b(configurableProvider, "SEED", str + "$GMAC", str + "$KeyGen");
            c(configurableProvider, "SEED", str + "$Poly1305", str + "$Poly1305KeyGen");
        }
    }
