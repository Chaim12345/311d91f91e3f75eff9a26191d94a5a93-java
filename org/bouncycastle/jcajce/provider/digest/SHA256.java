...
public class SHA256 {
    ...
    public static class Digest extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest.f13742a = new SHA256Digest((SHA256Digest) this.f13742a);
            return digest;
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "SHA256", str + "$HashMac", str + "$KeyGenerator");
            b(configurableProvider, "SHA256", PKCSObjectIdentifiers.id_hmacWithSHA256);
            b(configurableProvider, "SHA256", aSN1ObjectIdentifier);
        }
    }
