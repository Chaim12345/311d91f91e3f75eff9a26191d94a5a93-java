...
public class Blake2b {
    ...
    public static class Blake2b160 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            blake2b160.f13742a = new Blake2bDigest((Blake2bDigest) this.f13742a);
            return blake2b160;
        }
    }
    ...
    public static class Blake2b256 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            blake2b256.f13742a = new Blake2bDigest((Blake2bDigest) this.f13742a);
            return blake2b256;
        }
    }
    ...
    public static class Blake2b384 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            blake2b384.f13742a = new Blake2bDigest((Blake2bDigest) this.f13742a);
            return blake2b384;
        }
    }
    ...
    public static class Blake2b512 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            blake2b512.f13742a = new Blake2bDigest((Blake2bDigest) this.f13742a);
            return blake2b512;
        }
    }
