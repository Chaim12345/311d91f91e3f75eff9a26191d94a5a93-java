...
public class GOST3411 {
    ...
    public static class Digest extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest.f13742a = new GOST3411Digest((GOST3411Digest) this.f13742a);
            return digest;
        }
    }
    ...
    public static class Digest2012_256 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest2012_256.f13742a = new GOST3411_2012_256Digest((GOST3411_2012_256Digest) this.f13742a);
    ...
    public static class Digest2012_512 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest2012_512.f13742a = new GOST3411_2012_512Digest((GOST3411_2012_512Digest) this.f13742a);
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "GOST3411", str + "$HashMac", str + "$KeyGenerator");
            b(configurableProvider, "GOST3411", aSN1ObjectIdentifier);
            ...
            a(configurableProvider, "GOST3411-2012-256", str + "$HashMac2012_256", str + "$KeyGenerator2012_256");
            b(configurableProvider, "GOST3411-2012-256", RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_256);
            ...
            a(configurableProvider, "GOST3411-2012-512", str + "$HashMac2012_512", str + "$KeyGenerator2012_512");
            b(configurableProvider, "GOST3411-2012-512", RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_512);
