...
public class DSTU7564 {
    ...
    public static class DigestDSTU7564 extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            bCMessageDigest.f13742a = new DSTU7564Digest((DSTU7564Digest) this.f13742a);
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "DSTU7564-256", str + "$HashMac256", str + "$KeyGenerator256");
            a(configurableProvider, "DSTU7564-384", str + "$HashMac384", str + "$KeyGenerator384");
            a(configurableProvider, "DSTU7564-512", str + "$HashMac512", str + "$KeyGenerator512");
            b(configurableProvider, "DSTU7564-256", UAObjectIdentifiers.dstu7564mac_256);
            b(configurableProvider, "DSTU7564-384", UAObjectIdentifiers.dstu7564mac_384);
            b(configurableProvider, "DSTU7564-512", UAObjectIdentifiers.dstu7564mac_512);
        }
    }
