...
public class SHA512 {
    ...
    public static class Digest extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest.f13742a = new SHA512Digest((SHA512Digest) this.f13742a);
            return digest;
        }
    }
    ...
    public static class DigestT extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digestT.f13742a = new SHA512tDigest((SHA512tDigest) this.f13742a);
            return digestT;
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "SHA512", str + "$HashMac", str + "$KeyGenerator");
            b(configurableProvider, "SHA512", PKCSObjectIdentifiers.id_hmacWithSHA512);
            a(configurableProvider, "SHA512/224", str + "$HashMacT224", str + "$KeyGeneratorT224");
            a(configurableProvider, "SHA512/256", str + "$HashMacT256", str + "$KeyGeneratorT256");
        }
    }
