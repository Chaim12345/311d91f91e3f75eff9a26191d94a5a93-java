...
public class SHA384 {
    ...
    public static class Digest extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest.f13742a = new SHA384Digest((SHA384Digest) this.f13742a);
            return digest;
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "SHA384", str + "$HashMac", str + "$KeyGenerator");
            b(configurableProvider, "SHA384", PKCSObjectIdentifiers.id_hmacWithSHA384);
        }
    }
