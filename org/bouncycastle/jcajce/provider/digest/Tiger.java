...
public class Tiger {
    ...
    public static class Digest extends BCMessageDigest implements Cloneable {
        ...
        public Object clone() {
            ...
            digest.f13742a = new TigerDigest((TigerDigest) this.f13742a);
            return digest;
        }
    }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            a(configurableProvider, "TIGER", str + "$HashMac", str + "$KeyGenerator");
            b(configurableProvider, "TIGER", IANAObjectIdentifiers.hmacTIGER);
