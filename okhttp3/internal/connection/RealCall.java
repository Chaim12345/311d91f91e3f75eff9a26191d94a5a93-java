...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        final /* synthetic */ RealCall f12541a;
        @NotNull
        ...
        public final void executeOn(@NotNull ExecutorService executorService) {
            ...
            Dispatcher dispatcher = this.f12541a.getClient().dispatcher();
            ...
            try {
                try {
                    ...
                    this.f12541a.noMoreExchanges$okhttp(interruptedIOException);
                    this.responseCallback.onFailure(this.f12541a, interruptedIOException);
                    this.f12541a.getClient().dispatcher().finished$okhttp(this);
                }
            } catch (Throwable th) {
                this.f12541a.getClient().dispatcher().finished$okhttp(this);
                throw th;
        ...
        public final String getHost() {
            return this.f12541a.getOriginalRequest().url().host();
        }

        @NotNull
        public final Request getRequest() {
            return this.f12541a.getOriginalRequest();
        }
        ...
        public void run() {
            ...
            String stringPlus = Intrinsics.stringPlus("OkHttp ", this.f12541a.redactedUrl$okhttp());
            RealCall realCall = this.f12541a;
