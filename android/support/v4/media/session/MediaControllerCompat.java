...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            public void onPlaybackStateChanged(Object obj) {
                Callback callback = this.mCallback.get();
                if (callback == null || callback.f78c != null) {
                    return;
                }
            ...
            public void onSessionEvent(String str, Bundle bundle) {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    if (callback.f78c == null || Build.VERSION.SDK_INT >= 23) {
        ...
        void a(int i2, Object obj, Bundle bundle) {
            MessageHandler messageHandler = this.f77b;
        ...
        void b(Handler handler) {
            if (handler != null) {
                ...
                this.f77b = messageHandler;
                messageHandler.f79a = true;
                return;
            }
            MessageHandler messageHandler2 = this.f77b;
            if (messageHandler2 != null) {
                messageHandler2.f79a = false;
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        /* renamed from: a  reason: collision with root package name */
        protected final Object f81a;

        /* renamed from: c  reason: collision with root package name */
        final MediaSessionCompat.Token f83c;
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            protected void onReceiveResult(int i2, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.f82b) {
                    mediaControllerImplApi21.f83c.setExtraBinder(IMediaSession.Stub.asInterface(BundleCompat.getBinder(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.f83c.setSessionToken2Bundle(bundle.getBundle(MediaSessionCompat.KEY_SESSION_TOKEN2_BUNDLE));
        ...
        @GuardedBy("mLock")
        void a() {
            if (this.f83c.getExtraBinder() == null) {
                return;
            }
            for (Callback callback : this.mPendingCallbacks) {
                ExtraCallback extraCallback = new ExtraCallback(callback);
                this.mCallbackMap.put(callback, extraCallback);
                callback.f78c = extraCallback;
                try {
                    this.f83c.getExtraBinder().registerCallbackListener(extraCallback);
                    callback.a(13, null, null);
        ...
        public void adjustVolume(int i2, int i3) {
            MediaControllerCompatApi21.adjustVolume(this.f81a, i2, i3);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public boolean dispatchMediaButtonEvent(KeyEvent keyEvent) {
            return MediaControllerCompatApi21.dispatchMediaButtonEvent(this.f81a, keyEvent);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public Bundle getExtras() {
            return MediaControllerCompatApi21.getExtras(this.f81a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public long getFlags() {
            return MediaControllerCompatApi21.getFlags(this.f81a);
        }
        ...
        public MediaMetadataCompat getMetadata() {
            Object metadata = MediaControllerCompatApi21.getMetadata(this.f81a);
            if (metadata != null) {
        ...
        public String getPackageName() {
            return MediaControllerCompatApi21.getPackageName(this.f81a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public PlaybackInfo getPlaybackInfo() {
            Object playbackInfo = MediaControllerCompatApi21.getPlaybackInfo(this.f81a);
        ...
        public PlaybackStateCompat getPlaybackState() {
            if (this.f83c.getExtraBinder() != null) {
                try {
                    return this.f83c.getExtraBinder().getPlaybackState();
                } catch (RemoteException e2) {
                    Log.e("MediaControllerCompat", "Dead object in getPlaybackState.", e2);
                }
            }
            Object playbackState = MediaControllerCompatApi21.getPlaybackState(this.f81a);
        ...
        public List<MediaSessionCompat.QueueItem> getQueue() {
            List<Object> queue = MediaControllerCompatApi21.getQueue(this.f81a);
            if (queue != null) {
        ...
        public CharSequence getQueueTitle() {
            return MediaControllerCompatApi21.getQueueTitle(this.f81a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public int getRatingType() {
            if (Build.VERSION.SDK_INT < 22 && this.f83c.getExtraBinder() != null) {
                try {
                    return this.f83c.getExtraBinder().getRatingType();
                } catch (RemoteException e2) {
                    Log.e("MediaControllerCompat", "Dead object in getRatingType.", e2);
                }
            }
            return MediaControllerCompatApi21.getRatingType(this.f81a);
        }
        ...
        public int getRepeatMode() {
            if (this.f83c.getExtraBinder() != null) {
                try {
                    return this.f83c.getExtraBinder().getRepeatMode();
                } catch (RemoteException e2) {
        ...
        public PendingIntent getSessionActivity() {
            return MediaControllerCompatApi21.getSessionActivity(this.f81a);
        }
        ...
        public int getShuffleMode() {
            if (this.f83c.getExtraBinder() != null) {
                try {
                    return this.f83c.getExtraBinder().getShuffleMode();
                } catch (RemoteException e2) {
        ...
        public TransportControls getTransportControls() {
            Object transportControls = MediaControllerCompatApi21.getTransportControls(this.f81a);
        ...
        public boolean isCaptioningEnabled() {
            if (this.f83c.getExtraBinder() != null) {
                try {
                    return this.f83c.getExtraBinder().isCaptioningEnabled();
                } catch (RemoteException e2) {
        ...
        public boolean isSessionReady() {
            return this.f83c.getExtraBinder() != null;
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public final void registerCallback(Callback callback, Handler handler) {
            MediaControllerCompatApi21.registerCallback(this.f81a, callback.f76a, handler);
        ...
        public void sendCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
            MediaControllerCompatApi21.sendCommand(this.f81a, str, bundle, resultReceiver);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int i2, int i3) {
            MediaControllerCompatApi21.setVolumeTo(this.f81a, i2, i3);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public final void unregisterCallback(Callback callback) {
            MediaControllerCompatApi21.unregisterCallback(this.f81a, callback.f76a);
            synchronized (this.f82b) {
                if (this.f83c.getExtraBinder() != null) {
                    try {
                        ...
                        if (remove != null) {
                            callback.f78c = null;
                            this.f83c.getExtraBinder().unregisterCallbackListener(remove);
                        }
                    } catch (RemoteException e2) {
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public void registerCallback(Callback callback, Handler handler) {
            ...
            try {
                ...
                this.mBinder.registerCallbackListener((IMediaControllerCallback) callback.f76a);
                callback.a(13, null, null);
            } catch (RemoteException e2) {
                Log.e("MediaControllerCompat", "Dead object in registerCallback.", e2);
                callback.a(8, null, null);
        ...
        public void unregisterCallback(Callback callback) {
            ...
            try {
                this.mBinder.unregisterCallbackListener((IMediaControllerCallback) callback.f76a);
    ...
    static class TransportControlsApi21 extends TransportControls {
        ...
        public void fastForward() {
            MediaControllerCompatApi21.TransportControls.fastForward(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void pause() {
            MediaControllerCompatApi21.TransportControls.pause(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void play() {
            MediaControllerCompatApi21.TransportControls.play(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void playFromMediaId(String str, Bundle bundle) {
            MediaControllerCompatApi21.TransportControls.playFromMediaId(this.f84a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void playFromSearch(String str, Bundle bundle) {
            MediaControllerCompatApi21.TransportControls.playFromSearch(this.f84a, str, bundle);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void rewind() {
            MediaControllerCompatApi21.TransportControls.rewind(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void seekTo(long j2) {
            MediaControllerCompatApi21.TransportControls.seekTo(this.f84a, j2);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void sendCustomAction(PlaybackStateCompat.CustomAction customAction, Bundle bundle) {
            MediaControllerCompat.a(customAction.getAction(), bundle);
            MediaControllerCompatApi21.TransportControls.sendCustomAction(this.f84a, customAction.getAction(), bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void sendCustomAction(String str, Bundle bundle) {
            MediaControllerCompat.a(str, bundle);
            MediaControllerCompatApi21.TransportControls.sendCustomAction(this.f84a, str, bundle);
        }
        ...
        public void setRating(RatingCompat ratingCompat) {
            MediaControllerCompatApi21.TransportControls.setRating(this.f84a, ratingCompat != null ? ratingCompat.getRating() : null);
        }
        ...
        public void skipToNext() {
            MediaControllerCompatApi21.TransportControls.skipToNext(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToPrevious() {
            MediaControllerCompatApi21.TransportControls.skipToPrevious(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void skipToQueueItem(long j2) {
            MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.f84a, j2);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void stop() {
            MediaControllerCompatApi21.TransportControls.stop(this.f84a);
        }
    }
    ...
    static class TransportControlsApi23 extends TransportControlsApi21 {
        ...
        public void playFromUri(Uri uri, Bundle bundle) {
            MediaControllerCompatApi23.TransportControls.playFromUri(this.f84a, uri, bundle);
        }
    }
    ...
    static class TransportControlsApi24 extends TransportControlsApi23 {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepare() {
            MediaControllerCompatApi24.TransportControls.prepare(this.f84a);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromMediaId(String str, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromMediaId(this.f84a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromSearch(String str, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromSearch(this.f84a, str, bundle);
        }

        @Override // android.support.v4.media.session.MediaControllerCompat.TransportControlsApi21, android.support.v4.media.session.MediaControllerCompat.TransportControls
        public void prepareFromUri(Uri uri, Bundle bundle) {
            MediaControllerCompatApi24.TransportControls.prepareFromUri(this.f84a, uri, bundle);
        }
    }
